...
INTEGRATION_TEST_PACKAGES = {
    ...
    "github.com/khulnasoft/codeinfra/pkg/v3/graph/dotconv",
...
PERFORMANCE_TEST_PACKAGES = {
    "github.com/khulnasoft/codeinfra/tests/performance",
}

def is_unit_test(pkg: str) -> bool:
    """Checks if the package is a unit test"""
    return not (
        pkg.startswith("github.com/khulnasoft/codeinfra/pkg/v3/cmd/codeinfra")
        or pkg.startswith("github.com/khulnasoft/codeinfra/tests")
...
CODEGEN_TEST_PACKAGES = {
    "github.com/khulnasoft/codeinfra/pkg/v3/codegen/docs",
    "github.com/khulnasoft/codeinfra/pkg/v3/codegen/dotnet",
    "github.com/khulnasoft/codeinfra/pkg/v3/codegen/go",
    "github.com/khulnasoft/codeinfra/pkg/v3/codegen/nodejs",
    "github.com/khulnasoft/codeinfra/pkg/v3/codegen/python",
}
...
# versions in the the codeinfra-docker-containers repo by updating the file
# https://github.com/khulnasoft/codeinfra-docker-containers/blob/main/.github/scripts/matrix/versions.py
...
def run_list_tests(pkg_dir: str, tags: List[str]) -> List[str]:
    ...
    # ok      github.com/khulnasoft/codeinfra/tests/integration      0.093s
    # ```
    #
    ...
    #
    # ```sh
    # $ go test -tags all --list github.com/khulnasoft/codeinfra/tests/integration
    # no Go files in /home/friel/c/github.com/khulnasoft/codeinfra
    #
