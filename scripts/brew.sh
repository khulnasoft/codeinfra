...
# Rebuild and install codeinfra CLI binaries into $GOPATH/bin
(cd pkg && go install \
              -ldflags "-X github.com/khulnasoft/codeinfra/sdk/v3/go/common/version.Version=${BREW_VERSION}" \
              ${PROJECT})
...
# goreleaser in codeinfra/codeinfra renames amd64 to x64
