...
type ConfigFetcher struct {
	...
	Config codeinfra.StringOutput `codeinfra:"config"`
}

// NewConfigFetcher registers a new resource with the given unique name, arguments, and options.
func NewConfigFetcher(ctx *codeinfra.Context,
	name string, args *ConfigFetcherArgs, opts ...codeinfra.ResourceOption) (*ConfigFetcher, error) {
	if args == nil {
...
func GetConfigFetcher(ctx *codeinfra.Context,
	name string, id codeinfra.IDInput, state *ConfigFetcherState, opts ...codeinfra.ResourceOption) (*ConfigFetcher, error) {
	var resource ConfigFetcher
...
func (i *ConfigFetcher) ToConfigFetcherOutputWithContext(ctx context.Context) ConfigFetcherOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ConfigFetcherOutput)
}

type ConfigFetcherOutput struct{ *codeinfra.OutputState }
...
func (o ConfigFetcherOutput) Config() codeinfra.StringOutput {
	return o.ApplyT(func(v *ConfigFetcher) codeinfra.StringOutput { return v.Config }).(codeinfra.StringOutput)
}

func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*ConfigFetcherInput)(nil)).Elem(), &ConfigFetcher{})
	codeinfra.RegisterOutputType(ConfigFetcherOutput{})
}
