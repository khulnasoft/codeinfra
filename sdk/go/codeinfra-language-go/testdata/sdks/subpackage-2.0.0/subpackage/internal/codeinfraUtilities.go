...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^.*/codeinfra-subpackage/sdk(/v\\d+)?")
...
func PkgGetPackageRef(ctx *codeinfra.Context) (string, error) {
	if packageRef == nil {
		...
		parameter, err := base64.StdEncoding.DecodeString("SGVsbG9Xb3JsZA==")
		if err != nil {
			return "", err
		}
...
// PkgResourceDefaultOpts provides package level defaults to codeinfra.OptionResource.
func PkgResourceDefaultOpts(opts []codeinfra.ResourceOption) []codeinfra.ResourceOption {
	defaults := []codeinfra.ResourceOption{}
...
// PkgInvokeDefaultOpts provides package level defaults to codeinfra.OptionInvoke.
func PkgInvokeDefaultOpts(opts []codeinfra.InvokeOption) []codeinfra.InvokeOption {
	defaults := []codeinfra.InvokeOption{}
