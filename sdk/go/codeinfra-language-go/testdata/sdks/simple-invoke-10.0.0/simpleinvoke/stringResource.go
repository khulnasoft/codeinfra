...
func NewStringResource(ctx *codeinfra.Context,
	name string, args *StringResourceArgs, opts ...codeinfra.ResourceOption) (*StringResource, error) {
	if args == nil {
...
func GetStringResource(ctx *codeinfra.Context,
	name string, id codeinfra.IDInput, state *StringResourceState, opts ...codeinfra.ResourceOption) (*StringResource, error) {
	var resource StringResource
...
func (i *StringResource) ToStringResourceOutputWithContext(ctx context.Context) StringResourceOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(StringResourceOutput)
}

type StringResourceOutput struct{ *codeinfra.OutputState }
...
func (o StringResourceOutput) Text() codeinfra.StringOutput {
	return o.ApplyT(func(v *StringResource) codeinfra.StringOutput { return v.Text }).(codeinfra.StringOutput)
}

func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*StringResourceInput)(nil)).Elem(), &StringResource{})
	codeinfra.RegisterOutputType(StringResourceOutput{})
}
