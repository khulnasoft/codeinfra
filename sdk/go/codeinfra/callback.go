...
func newCallbackServer() (*callbackServer, error) {
	...
	handle, err := rpcutil.ServeWithOptions(rpcutil.ServeOptions{
		...
		Init: func(srv *grpc.Server) error {
			codeinfrarpc.RegisterCallbacksServer(srv, callbackServer)
			return nil
		},
...
func (s *callbackServer) RegisterCallback(function callbackFunction) (*codeinfrarpc.Callback, error) {
...
func (s *callbackServer) Invoke(
	ctx context.Context, req *codeinfrarpc.CallbackInvokeRequest,
) (*codeinfrarpc.CallbackInvokeResponse, error) {
	...
	return &codeinfrarpc.CallbackInvokeResponse{
