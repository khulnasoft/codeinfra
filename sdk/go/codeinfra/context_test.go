...
// The test is extracted from a panic using codeinfra-docker and minified
...
// captured `*codeinfra.Context` from `ApplyT`. The user program passes a
...
func TestCollapseAliases(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			totalAliasUrns: 1,
			results:        []URN{"urn:codeinfra:stack::project::test:resource:type$test:resource:child2::myres-child"},
		},
		{
			parentAliases:  []Alias{},
			childAliases:   []Alias{{Name: String("child2")}},
			totalAliasUrns: 1,
			results:        []URN{"urn:codeinfra:stack::project::test:resource:type$test:resource:child::child2"},
		},
		{
			...
			totalAliasUrns: 3,
			results: []URN{
				"urn:codeinfra:stack::project::test:resource:type$test:resource:child::myres-child2",
				"urn:codeinfra:stack::project::test:resource:type3$test:resource:child::myres-child",
				"urn:codeinfra:stack::project::test:resource:type3$test:resource:child::myres-child2",
			},
		},
		{
			...
			results: []URN{
				"urn:codeinfra:stack::project::test:resource:type$test:resource:child::myres-child2",
				"urn:codeinfra:stack::project::test:resource:type$test:resource:child::myres2-child",
				"urn:codeinfra:stack::project::test:resource:type$test:resource:child::myres2-child2",
			},
		},
		{
			...
			results: []URN{
				"urn:codeinfra:stack::project::test:resource:type$test:resource:child::myres-child2",
				"urn:codeinfra:stack::project::test:resource:type$test:resource:child2::myres-child",
				"urn:codeinfra:stack::project::test:resource:type$test:resource:child::myres2-child",
				"urn:codeinfra:stack::project::test:resource:type$test:resource:child::myres2-child2",
				"urn:codeinfra:stack::project::test:resource:type$test:resource:child2::myres2-child",
				"urn:codeinfra:stack::project::test:resource:type3$test:resource:child::myres-child",
				"urn:codeinfra:stack::project::test:resource:type3$test:resource:child::myres-child2",
				"urn:codeinfra:stack::project::test:resource:type3$test:resource:child2::myres-child",
				"urn:codeinfra:stack::project::test:resource:type$test:resource:child::myres3-child",
				"urn:codeinfra:stack::project::test:resource:type$test:resource:child::myres3-child2",
				"urn:codeinfra:stack::project::test:resource:type$test:resource:child2::myres3-child",
			},
		},
	}
...
func (pr *Prov) i(ctx *Context, t *testing.T) ProviderResource {
	...
	err := ctx.RegisterResource("codeinfra:providers:"+pr.t, pr.name, nil, p)
	assert.NoError(t, err)
	return p
}
		...
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			err := RunErr(func(ctx *Context) error {
				...
				for k, p := range provMap {
					...
					result = append(result, strings.TrimPrefix(p.getName(), "codeinfra:providers:"))
				}
...
func TestRegisterResource_aliasesSpecs(t *testing.T) {
	...
	tests := []struct {
		...
		wantAliases   []*codeinfrarpc.Alias
	...
	}{
		{
			...
			wantAliasURNs: []string{
				"urn:codeinfra:stack::project::test:resource:type::resA",
				"urn:codeinfra:stack::project::test:resource:type::resB",
			},
		},
		{
			...
			wantAliases: []*codeinfrarpc.Alias{
				{
					Alias: &codeinfrarpc.Alias_Spec_{
						Spec: &codeinfrarpc.Alias_Spec{
							Name:   "resA",
							Parent: &codeinfrarpc.Alias_Spec_NoParent{NoParent: true},
						},
					},
				},
				{
		...
		},
		{
			...
			wantAliasURNs: []string{
				"urn:codeinfra:stack::project::test:resource:parentType$test:resource:type::child",
			},
		},
		{
					...
					Alias: &codeinfrarpc.Alias_Spec_{
						Spec: &codeinfrarpc.Alias_Spec{
							...
							Parent: &codeinfrarpc.Alias_Spec_ParentUrn{
								ParentUrn: "urn:codeinfra:stack::project::test:resource:parentType::parent",
							},
						},
					},
				},
		...
		t.Run(tt.desc, func(t *testing.T) {
			...
			if !tt.supportsAliasSpecs {
				opts = append(opts, WrapResourceMonitorClient(
					func(rmc codeinfrarpc.ResourceMonitorClient) codeinfrarpc.ResourceMonitorClient {
...
type resmonClientWithFeatures struct {
	codeinfrarpc.ResourceMonitorClient
...
func resourceMonitorClientWithoutFeatures(
	cl codeinfrarpc.ResourceMonitorClient,
	features ...string,
) codeinfrarpc.ResourceMonitorClient {
...
func TestSourcePosition(t *testing.T) {
	...
	mocks := &testMonitor{
		NewResourceF: func(args MockResourceArgs) (string, resource.PropertyMap, error) {
			var sourcePosition *codeinfrarpc.SourcePosition
			switch {
