...
func WrapResourceMonitorClient(
	wrap func(codeinfrarpc.ResourceMonitorClient) codeinfrarpc.ResourceMonitorClient,
) RunOption {
...
type testResource2 struct {
	...
	Foo StringOutput `codeinfra:"foo"`
}
...
type testMyCustomResource struct {
	...
	Instance testInstanceResourceOutput `codeinfra:"instance"`
}

type testMyCustomResourceArgs struct {
	Instance testInstanceResource `codeinfra:"instance"`
}
...
type testMyRemoteComponentArgs struct {
	Inprop string `codeinfra:"inprop"`
}
...
type testMyRemoteComponent struct {
	...
	Outprop StringOutput `codeinfra:"outprop"`
}
...
type testResource4Args struct {
	Inprop *testResource2 `codeinfra:"inprop"`
}
