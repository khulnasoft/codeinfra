...
type BoolEnumInputArgs struct {
	Value BoolEnumInput `codeinfra:"value"`
}
...
type IntEnumInputArgs struct {
	Value IntEnumInput `codeinfra:"value"`
}
...
type FloatEnumInputArgs struct {
	Value FloatEnumInput `codeinfra:"value"`
}
...
type StringEnumInputArgs struct {
	Value StringEnumInput `codeinfra:"value"`
}

type StringInputArgs struct {
	Value StringInput `codeinfra:"value"`
}

type StringPtrInputArgs struct {
	Value StringPtrInput `codeinfra:"value"`
}

type StringArrayInputArgs struct {
	Value StringArrayInput `codeinfra:"value"`
}

type StringMapInputArgs struct {
	Value StringMapInput `codeinfra:"value"`
}

type BoolInputArgs struct {
	Value BoolInput `codeinfra:"value"`
}

type BoolPtrInputArgs struct {
	Value BoolPtrInput `codeinfra:"value"`
}

type NestedOutputArgs struct {
	Value NestedOutput `codeinfra:"value"`
}

type NestedPtrOutputArgs struct {
	Value NestedPtrOutput `codeinfra:"value"`
}

type NestedArrayOutputArgs struct {
	Value NestedArrayOutput `codeinfra:"value"`
}

type NestedMapOutputArgs struct {
	Value NestedMapOutput `codeinfra:"value"`
}

type Nested struct {
	Foo string `codeinfra:"foo"`
	Bar int    `codeinfra:"bar,optional"`
}
...
type StringMapArgs struct {
	Value map[string]string `codeinfra:"value"`
}

type IntArgs struct {
	Value int `codeinfra:"value"`
}

type NestedArgs struct {
	Value Nested `codeinfra:"value"`
}
...
type NestedMapArgs struct {
	Value map[string]Nested `codeinfra:"value"`
}
...
type PlainMapArgs struct {
	Value map[string]StringInput `codeinfra:"value"`
}

type AssetArgs struct {
	Value Asset `codeinfra:"value"`
}

type AssetInputArgs struct {
	Value AssetInput `codeinfra:"value"`
}

type ArchiveArgs struct {
	Value Archive `codeinfra:"value"`
}

type ArchiveInputArgs struct {
	Value ArchiveInput `codeinfra:"value"`
}

type AssetOrArchiveArgs struct {
	Value AssetOrArchive `codeinfra:"value"`
}

type AssetOrArchiveInputArgs struct {
	Value AssetOrArchiveInput `codeinfra:"value"`
}
...
type NestedInputtyInputArgs struct {
	Something StringPtrInput `codeinfra:"something"`
}
...
type PlainOptionalNestedInputtyInputArgs struct {
	Value *NestedInputtyInputArgs `codeinfra:"value"`
}
...
type PlainOptionalNestedInputtyArgs struct {
	Value *NestedInputtyArgs `codeinfra:"value"`
}

type LaunchTemplateOptions struct {
	TagSpecifications []LaunchTemplateTagSpecification `codeinfra:"tagSpecifications"`
}
...
type LaunchTemplateOptionsArgs struct {
	TagSpecifications LaunchTemplateTagSpecificationArrayInput `codeinfra:"tagSpecifications"`
}
...
type LaunchTemplateArgs struct {
	Value LaunchTemplateOptionsPtrInput `codeinfra:"value"`
}
...
func TestConstructInputsCopyTo(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args:          &StringArgs{},
			expectedError: "expected destination type to implement codeinfra.Input or codeinfra.Output, got string",
		},
		{
		...
		},
		{
			...
			args:  &StringArgs{},
			expectedError: "codeinfra.StringArgs.Value is typed as string but must be a type that implements " +
				"codeinfra.Input or codeinfra.Output for input with dependencies",
		},
		...
		},
		{
			...
			args:          &NestedArgs{},
			expectedError: "expected destination type to implement codeinfra.Input or codeinfra.Output, got codeinfra.Nested",
		},
		{
			...
			deps: urnSet{"fakeURN": struct{}{}},
			args: &NestedArgs{},
			expectedError: "codeinfra.NestedArgs.Value is typed as codeinfra.Nested but must be a type that implements " +
				"codeinfra.Input or codeinfra.Output for input with dependencies",
		},
...
type MyComponent struct {
	...
	Foo        string       `codeinfra:"foo"`
	SomeValue  StringOutput `codeinfra:"someValue"`
	Nope       StringOutput
	unexported StringOutput `codeinfra:"unexported"`
}
...
type MyComponentWithResource struct {
	...
	Component Resource `codeinfra:"component"`
}
...
func TestConstruct_resourceOptionsSnapshot(t *testing.T) {
	...
	snapshotFromRequest := func(t *testing.T, req *codeinfrarpc.ConstructRequest) *ResourceOptions {
	...
	t.Run("Aliases", func(t *testing.T) {
		...
		snap := snapshotFromRequest(t, &codeinfrarpc.ConstructRequest{
			Aliases: []string{"test"},
		})
	...
	t.Run("Providers", func(t *testing.T) {
		...
		urn := resource.NewURN("mystack", "myproject", "", "codeinfra:providers:foo", "bar")
		snap := snapshotFromRequest(t, &codeinfrarpc.ConstructRequest{
	...
	t.Run("CustomTimeouts", func(t *testing.T) {
		...
		tests := []struct {
			name string
			give *codeinfrarpc.ConstructRequest_CustomTimeouts
			want *CustomTimeouts
		}{
			{
				name: "Create",
				give: &codeinfrarpc.ConstructRequest_CustomTimeouts{Create: "1m"},
				want: &CustomTimeouts{Create: "1m"},
			},
			{
				name: "Update",
				give: &codeinfrarpc.ConstructRequest_CustomTimeouts{Update: "2m"},
				want: &CustomTimeouts{Update: "2m"},
			},
			{
				name: "Delete",
				give: &codeinfrarpc.ConstructRequest_CustomTimeouts{Delete: "3m"},
...
func TestConstruct_await(t *testing.T) {
	...
	// Note: a given output may or may not be associated with the Codeinfra context, depending on how it's made,
	// meaning that it may or may not be tracked by the context's waitgroup.
	constructWithState := func(t *testing.T, req *codeinfrarpc.ConstructRequest, stateF func(ctx *Context, state Map)) error {
		// Keep test cases simple:
		req.Stack = "mystack"
		req.Project = "myproject"
	...
	t.Run("outstanding rpc", func(t *testing.T) {
		...
		err := constructWithState(t, &codeinfrarpc.ConstructRequest{}, func(ctx *Context, state Map) {
...
func TestCall_await(t *testing.T) {
	...
	// Note: a given result may or may not be associated with the Codeinfra context, depending on how it's made,
	// meaning that it may or may not be tracked by the context's waitgroup.
	callWithResult := func(t *testing.T, req *codeinfrarpc.CallRequest, resultF func(ctx *Context, state Map)) error {
		// Keep test cases simple:
		req.Stack = "mystack"
		req.Project = "myproject"
	...
	t.Run("outstanding rpc", func(t *testing.T) {
		...
		err := callWithResult(t, &codeinfrarpc.CallRequest{}, func(ctx *Context, result Map) {
