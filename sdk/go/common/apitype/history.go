...
const (
	// UpdateUpdate is the prototypical Codeinfra program update.
	...
	// RenameUpdate is an update that changes the stack name or project name of a Codeinfra program.
	// NOTE: Do not remove this type - it is used by Codeinfra Cloud code.
...
// OpType describes the type of operation performed to a resource managed by Codeinfra.
//
...
// GetHistoryResponse is the response from the Codeinfra Service when requesting
// a stack's history.
