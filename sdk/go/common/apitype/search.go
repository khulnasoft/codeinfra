...
type CodeinfraQueryResponse struct {
	Query string `json:"query"`
}

type CodeinfraQueryRequest struct {
	Query string `url:"query"`
}

// ParseQueryParams takes a list of parameters passed into the CLI
// Search commands (in the form of a Codeinfra query)
// and returns a CodeinfraQueryRequest struct that can be used to make a request
// to the Codeinfra API.
//
// See https://www.codeinfra.com/docs/codeinfra-cloud/insights/search/#query-syntax for reference
func ParseQueryParams(rawParams []string) *CodeinfraQueryRequest {
	return &CodeinfraQueryRequest{Query: strings.Join(rawParams, " ")}
}
