...
type UpdatePolicyGroupRequest struct {
	...
	AddStack    *CodeinfraStackReference `json:"addStack,omitempty"`
	RemoveStack *CodeinfraStackReference `json:"removeStack,omitempty"`
...
// CodeinfraStackReference contains the StackName and ProjectName of the stack.
type CodeinfraStackReference struct {
	Name           string `json:"name"`
