...
config:
  ...
  codeinfra:disable-default-providers: ["*"]
  instanceSize: t3.micro`
...
config:
  test:instanceSize: t4.large`
	...
	assert.Equal(t, "[\"*\"]", getConfigValue(t, stack.Config, "codeinfra:disable-default-providers"))
	assert.Equal(t, []interface{}{"*"}, getConfigValueUnmarshalled(t, stack.Config, "codeinfra:disable-default-providers"))
}
