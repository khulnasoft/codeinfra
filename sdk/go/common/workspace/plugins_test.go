...
import (
	...
	"github.com/khulnasoft/codeinfra/sdk/v3/go/common/testing/diagtest"
	"github.com/khulnasoft/codeinfra/sdk/v3/go/common/testing/iotest"
...
func TestPluginDownload(t *testing.T) {
	...
	t.Run("Codeinfra GitHub Releases", func(t *testing.T) {
		...
		getHTTPResponse := func(req *http.Request) (io.ReadCloser, int64, error) {
			if req.URL.String() == "https://api.github.com/repos/codeinfra/codeinfra-mockdl/releases/tags/v4.30.0" {
				...
				return newMockReadCloserString(`{
					"assets": [
					  {
						"url": "https://api.github.com/repos/codeinfra/codeinfra-mockdl/releases/assets/654321",
						"name": "codeinfra-mockdl_4.30.0_checksums.txt"
					  },
					  {
						"url": "https://api.github.com/repos/codeinfra/codeinfra-mockdl/releases/assets/123456",
						"name": "codeinfra-resource-mockdl-v4.30.0-darwin-amd64.tar.gz"
					  }
					]
				  }
				`)
			...
			assert.Equal(t, "https://api.github.com/repos/codeinfra/codeinfra-mockdl/releases/assets/123456", req.URL.String())
	...
	t.Run("get.codeinfra.com", func(t *testing.T) {
		...
		getHTTPResponse := func(req *http.Request) (io.ReadCloser, int64, error) {
			...
			if req.URL.String() == "https://api.github.com/repos/codeinfra/codeinfra-otherdl/releases/tags/v4.32.0" {
				return nil, -1, errors.New("404 not found")
			}
			assert.Equal(t,
				"https://get.codeinfra.com/releases/plugins/codeinfra-resource-otherdl-v4.32.0-darwin-amd64.tar.gz",
				req.URL.String())
			return newMockReadCloser(expectedBytes)
		}
		r, l, err := source.Download(context.Background(), *spec.Version, "darwin", "amd64", getHTTPResponse)
	...
	t.Run("Custom http URL", func(t *testing.T) {
		version := semver.MustParse("4.32.0")
		spec := PluginSpec{
			PluginDownloadURL: "http://customurl.jfrog.io/artifactory/codeinfra-packages/package-name/v${VERSION}/${OS}/${ARCH}",
			Name:              "mockdl",
			Version:           &version,
			Kind:              apitype.PluginKind("resource"),
		}
		...
		getHTTPResponse := func(req *http.Request) (io.ReadCloser, int64, error) {
			assert.Equal(t,
				"http://customurl.jfrog.io/artifactory/codeinfra-packages/"+
					"package-name/v4.32.0/darwin/amd64/codeinfra-resource-mockdl-v4.32.0-darwin-amd64.tar.gz",
				req.URL.String())
			return newMockReadCloser(expectedBytes)
		}
		r, l, err := source.Download(context.Background(), *spec.Version, "darwin", "amd64", getHTTPResponse)
	...
	t.Run("Custom https URL", func(t *testing.T) {
		version := semver.MustParse("4.32.0")
		spec := PluginSpec{
			PluginDownloadURL: "https://customurl.jfrog.io/artifactory/codeinfra-packages/" +
		...
		getHTTPResponse := func(req *http.Request) (io.ReadCloser, int64, error) {
			assert.Equal(t,
				"https://customurl.jfrog.io/artifactory/codeinfra-packages/"+
					"package-name/mockdl/v4.32.0/darwin/amd64/codeinfra-resource-mockdl-v4.32.0-darwin-amd64.tar.gz",
				req.URL.String())
			return newMockReadCloser(expectedBytes)
		}
		r, l, err := source.Download(context.Background(), *spec.Version, "darwin", "amd64", getHTTPResponse)
	...
	t.Run("Private Codeinfra GitHub Releases", func(t *testing.T) {
		...
		require.NoError(t, err)
		getHTTPResponse := func(req *http.Request) (io.ReadCloser, int64, error) {
			if req.URL.String() == "https://api.github.com/repos/codeinfra/codeinfra-mockdl/releases/tags/v4.32.0" {
				...
				return newMockReadCloserString(`{
					"assets": [
					  {
						"url": "https://api.github.com/repos/codeinfra/codeinfra-mockdl/releases/assets/654321",
						"name": "codeinfra-mockdl_4.32.0_checksums.txt"
					  },
					  {
						"url": "https://api.github.com/repos/codeinfra/codeinfra-mockdl/releases/assets/123456",
						"name": "codeinfra-resource-mockdl-v4.32.0-darwin-amd64.tar.gz"
					  }
					]
				  }
				`)
	...
	t.Run("Codeinfra GitHub Releases With Checksum", func(t *testing.T) {
		t.Setenv("GITHUB_TOKEN", "")
		version := semver.MustParse("4.30.0")
		getHTTPResponse := func(req *http.Request) (io.ReadCloser, int64, error) {
			if req.URL.String() == "https://api.github.com/repos/codeinfra/codeinfra-mockdl/releases/tags/v4.30.0" {
		...
		getHTTPResponse := func(req *http.Request) (io.ReadCloser, int64, error) {
			assert.Equal(t,
				"https://gitlab.com/api/v4/projects/278964/releases/v1.23.4/downloads/"+
					"codeinfra-resource-mock-gitlab-v1.23.4-windows-arm64.tar.gz", req.URL.String())
	...
	t.Run("GitHub Releases with disallowed", func(t *testing.T) {
		...
		getHTTPResponse := func(req *http.Request) (io.ReadCloser, int64, error) {
			...
			if req.URL.String() == "https://api.github.com/repos/codeinfra/codeinfra-mockdl/releases/tags/v5.32.0" {
				assert.Equal(t, "", req.Header.Get("Authorization"))
				assert.Equal(t, "application/json", req.Header.Get("Accept"))
				// Minimal JSON from the releases API to get the test to pass
				return newMockReadCloserString(`{
					"assets": [
					  {
						"url": "https://api.github.com/repos/codeinfra/codeinfra-mockdl/releases/assets/654321",
						"name": "codeinfra-mockdl_5.32.0_checksums.txt"
					  },
					  {
						"url": "https://api.github.com/repos/codeinfra/codeinfra-mockdl/releases/assets/123456",
						"name": "codeinfra-resource-mockdl-v5.32.0-darwin-amd64.tar.gz"
					  }
					]
				  }
				`)
...
func TestPluginGetLatestVersion(t *testing.T) {
	...
	t.Run("Codeinfra GitHub Releases", func(t *testing.T) {
		...
		getHTTPResponse := func(req *http.Request) (io.ReadCloser, int64, error) {
			assert.Equal(t,
				"https://api.github.com/repos/codeinfra/codeinfra-mock-latest/releases/latest",
				req.URL.String())
			// Minimal JSON from the releases API to get the test to pass
			return newMockReadCloserString(`{
				"tag_name": "v4.37.5"
	...
	t.Run("Custom http URL", func(t *testing.T) {
		spec := PluginSpec{
			PluginDownloadURL: "http://customurl.jfrog.io/artifactory/codeinfra-packages/package-name",
			Name:              "mock-latest",
			Kind:              apitype.PluginKind("resource"),
		}
		source, err := spec.GetSource()
	...
	t.Run("Custom https URL", func(t *testing.T) {
		spec := PluginSpec{
			PluginDownloadURL: "https://customurl.jfrog.io/artifactory/codeinfra-packages/package-name",
			Name:              "mock-latest",
			Kind:              apitype.PluginKind("resource"),
		}
		source, err := spec.GetSource()
	...
	t.Run("Private Codeinfra GitHub Releases", func(t *testing.T) {
		...
		require.NoError(t, err)
		getHTTPResponse := func(req *http.Request) (io.ReadCloser, int64, error) {
			if req.URL.String() == "https://api.github.com/repos/codeinfra/codeinfra-mock-private/releases/latest" {
				assert.Equal(t, "token "+token, req.Header.Get("Authorization"))
				assert.Equal(t, "application/json", req.Header.Get("Accept"))
				// Minimal JSON from the releases API to get the test to pass
				return newMockReadCloserString(`{
	...
	t.Run("Hit GitHub ratelimit", func(t *testing.T) {
		...
		assert.ErrorContains(t, err, "https://api.github.com/repos/codeinfra/codeinfra-mock-latest/releases/latest")
	})
}
...
func TestDownloadToFile_retries(t *testing.T) {
	...
	//
	// Regression test for https://github.com/khulnasoft/codeinfra/issues/12456.

	var numRequests int
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		assert.Equal(t, http.MethodGet, r.Method, "expected GET request")
		assert.Regexp(t, `/codeinfra-language-myplugin-v1.0.0-\S+\.tar\.gz`, r.URL.Path,
			"unexpected URL path")
...
func TestUnmarshalProjectWithProviderList(t *testing.T) {
	t.Parallel()
	tempdir := t.TempDir()
	pyaml := filepath.Join(tempdir, "Codeinfra.yaml")

	// write to pyaml
	err := os.WriteFile(pyaml, []byte(`name: test-yaml
runtime: yaml
description: "Test Codeinfra YAML"
plugins:
  providers:
  - name: aws
    version: 1.0.0
...
func TestPluginSpec_GetSource(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedURL:        "github://api.github.com/khulnasoft/codeinfra-test-plugin",
		},
		{
...
func TestMissingErrorText(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			IncludeAmbient: true,
			ExpectedError: "no resource plugin 'codeinfra-resource-myplugin' found in the workspace at version v0.1.0 " +
				"or on your $PATH",
		},
		{
		...
		},
		{
			...
			IncludeAmbient: true,
			ExpectedError:  "no resource plugin 'codeinfra-resource-myplugin' found in the workspace or on your $PATH",
		},
		{
			...
			IncludeAmbient: false,
			ExpectedError:  "no resource plugin 'codeinfra-resource-myplugin' found in the workspace",
		},
		{
			...
			IncludeAmbient: true,
			ExpectedError:  "no language plugin 'codeinfra-language-dotnet' found in the workspace or on your $PATH",
		},
	}
...
func TestBundledPluginSearch(t *testing.T) {
	...
	bundledPath := filepath.Join(filepath.Dir(exe), "codeinfra-language-nodejs")
	...
	ambientPath := filepath.Join(pathDir, "codeinfra-language-nodejs")
	...
	t.Setenv("CODEINFRA_IGNORE_AMBIENT_PLUGINS", "false")
	...
	t.Setenv("CODEINFRA_IGNORE_AMBIENT_PLUGINS", "true")
	path, err = GetPluginPath(d, apitype.LanguagePlugin, "nodejs", nil, nil)
	require.NoError(t, err)
...
func TestAmbientPluginsWarn(t *testing.T) {
	...
	pathDir := t.TempDir()
	t.Setenv("PATH", pathDir)
	ambientPath := filepath.Join(pathDir, "codeinfra-resource-mock")
	err := os.WriteFile(ambientPath, []byte{}, 0o700) //nolint: gosec
	require.NoError(t, err)
	...
	expectedMessage := fmt.Sprintf("warning: using codeinfra-resource-mock from $PATH at %s\n", ambientPath)
...
// Regression test for https://github.com/khulnasoft/codeinfra/issues/13656
//
//nolint:paralleltest // modifies environment variables
...
func TestPluginInfoShimless(t *testing.T) {
	...
	pluginPath := filepath.Join(pathDir, "codeinfra-resource-mock")
	err := os.MkdirAll(pluginPath, 0o700) //nolint: gosec
	require.NoError(t, err)
	err = os.WriteFile(filepath.Join(pluginPath, "CodeinfraPlugin.yaml"), []byte(`runtime: nodejs`), 0o600)
	require.NoError(t, err)
...
func TestProjectPluginsWithUncleanPath(t *testing.T) {
	...
	err := os.WriteFile(filepath.Join(tempdir, "codeinfra-resource-aws"), []byte{}, 0o600)
	require.NoError(t, err)
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(tempdir, "codeinfra-resource-aws"), path)
}
...
func TestProjectPluginsWithSymlink(t *testing.T) {
	...
	require.NoError(t, err)
	err = os.WriteFile(filepath.Join(tempdir, "subdir", "codeinfra-resource-aws"), []byte{}, 0o600)
	require.NoError(t, err)
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(tempdir, "symlink", "codeinfra-resource-aws"), path)
}
...
func TestNewPluginSpec(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:   "regular plugin",
			source: "codeinfra-example",
			kind:   apitype.ResourcePlugin,
			ExpectedPluginSpec: PluginSpec{
				Name:              "codeinfra-example",
				Kind:              apitype.ResourcePlugin,
				Version:           nil,
				PluginDownloadURL: "",
				PluginDir:         "",
		...
		},
		{
			...
			source: "codeinfra-example@v1.0.0",
			kind:   apitype.ResourcePlugin,
			ExpectedPluginSpec: PluginSpec{
				Name:              "codeinfra-example",
				Kind:              apitype.ResourcePlugin,
		...
		},
		{
			...
			source: "codeinfra-example@v1.0.0.0",
			kind:   apitype.ResourcePlugin,
			Error:  errors.New("VERSION must be valid semver: Invalid character(s) found in patch number \"0.0\""),
		},
		{
			name:   "git plugin",
			source: "github.com/khulnasoft/codeinfra-example",
			kind:   apitype.ResourcePlugin,
			ExpectedPluginSpec: PluginSpec{
				Name:              "github.com_codeinfra_codeinfra-example",
				Kind:              apitype.ResourcePlugin,
				Version:           nil,
				PluginDownloadURL: "github.com/khulnasoft/codeinfra-example",
				PluginDir:         "",
				Checksums:         nil,
			},
		},
		{
			...
			source: "github.com/khulnasoft/codeinfra-example@v1.0.0",
			kind:   apitype.ResourcePlugin,
			ExpectedPluginSpec: PluginSpec{
				Name:              "github.com_codeinfra_codeinfra-example",
				Kind:              apitype.ResourcePlugin,
		...
		},
		{
			...
			source: "github.com/khulnasoft/codeinfra-example@deadbeefdeadbeefdeadbeefdeadbeefdeadbeef",
			kind:   apitype.ResourcePlugin,
			ExpectedPluginSpec: PluginSpec{
				Name:              "github.com_codeinfra_codeinfra-example",
				Kind:              apitype.ResourcePlugin,
		...
		},
		{
			...
			source: "github.com/khulnasoft/codeinfra-example@abcd",
			kind:   apitype.ResourcePlugin,
