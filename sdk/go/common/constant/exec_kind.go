...
// from automation API using a traditional Codeinfra project.
const ExecKindAutoLocal = "auto.local"

// ExecKindAutoInline is a flag used to identify a command as originating
// from automation API using an inline Codeinfra project.
const ExecKindAutoInline = "auto.inline"

// ExecKindCLI is a flag used to identify a command as originating
// from the CLI using a traditional Codeinfra project.
const ExecKindCLI = "cli"

// ExitStatusLoggedError is the exit status to indicate that a codeinfra program
