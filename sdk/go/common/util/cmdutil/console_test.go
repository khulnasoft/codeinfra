...
func TestColorTablePrinting(t *testing.T) {
	...
	rows := []TableRow{
		{Columns: []string{greenText("+"), "codeinfra:codeinfra:Stack", "aws-cs-webserver-test", greenText("create")}},
		...
		{Columns: []string{greenText("+"), "└─ codeinfra:providers:aws", "default_4_25_0", greenText("create")}},
	}
