...
// scenario, such as in continuous integration, or when using the Codeinfra CLI/SDK in a programmatic way.
...
func EndKeypadTransmitMode() {
	if runtime.GOOS != "windows" && Interactive() {
		...
		// Work around https://github.com/khulnasoft/codeinfra/issues/3480.
