...
//
// The `CODEINFRA_GITSSH_PASSPHRASE` environment variable can be provided if the
...
func gitCloneOrPull(
	...
	if cloneErr == git.ErrUnstagedChanges {
		// See https://github.com/khulnasoft/codeinfra/issues/11121. We seem to be getting intermittent unstaged
		...
		if err != nil {
			return fmt.Errorf(
				"GitCloneOrPull reported unstaged changes, but the repo couldn't be opened to check: %w\n"+
					"Please report this to https://github.com/khulnasoft/codeinfra/issues/11121.", err)
		}
		...
		return fmt.Errorf("GitCloneOrPull reported unstaged changes: %s\n"+
			"Please report this to https://github.com/khulnasoft/codeinfra/issues/11121.",
...
// For example, "https://github.com/codeinfra/platform-team/templates.git/templates/javascript"
// returns "https://github.com/codeinfra/platform-team/templates.git" and "templates/javascript"
//
