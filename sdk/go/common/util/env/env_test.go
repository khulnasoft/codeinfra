...
func init() {
	env.Global = env.MapStore{
		"CODEINFRA_FOO": "1",
		// "CODEINFRA_NOT_SET": explicitly not set
		"FOO":                "bar",
		"CODEINFRA_MY_INT":      "3",
		"CODEINFRA_SECRET":      "hidden",
		"CODEINFRA_SET":         "SET",
		"UNSET":              "SET",
		"CODEINFRA_ALTERNATIVE": "SET",
	}
}
...
var (
	...
	UnsetString = env.String("CODEINFRA_UNSET", "Should be unset", env.Needs(SomeFalse))
...
func TestInt(t *testing.T) {
	...
	assert.Equal(t, 6, env.NewEnv(
		env.MapStore{"CODEINFRA_MY_INT": "6"},
	).GetInt(AnInt))
}
