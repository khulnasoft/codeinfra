...
func MakeInstallDependenciesStreams(
	...
	return makeStreams(
		func(b []byte) error {
			return server.Send(&codeinfrarpc.InstallDependenciesResponse{Stdout: b})
		},
		func(b []byte) error {
			return server.Send(&codeinfrarpc.InstallDependenciesResponse{Stderr: b})
		},
		isTerminal)
}
...
func MakeRunPluginStreams(
	server codeinfrarpc.LanguageRuntime_RunPluginServer,
	isTerminal bool,
) (io.Closer, io.Writer, io.Writer, error) {
	return makeStreams(
		func(b []byte) error {
			return server.Send(&codeinfrarpc.RunPluginResponse{Output: &codeinfrarpc.RunPluginResponse_Stdout{Stdout: b}})
		},
		func(b []byte) error {
			return server.Send(&codeinfrarpc.RunPluginResponse{Output: &codeinfrarpc.RunPluginResponse_Stderr{Stderr: b}})
		},
		isTerminal)
}
