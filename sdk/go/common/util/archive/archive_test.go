...
func TestIgnoreSimple(t *testing.T) {
	...
	doArchiveTest(t, ".",
		fileContents{name: ".gitignore", contents: []byte("node_modules/codeinfra/"), shouldRetain: true},
		fileContents{name: "included.txt", shouldRetain: true},
		fileContents{name: "node_modules/included.txt", shouldRetain: true},
		fileContents{name: "node_modules/codeinfra/excluded.txt", shouldRetain: false},
		fileContents{name: "node_modules/codeinfra/excluded/excluded.txt", shouldRetain: false})
}
...
func TestIgnoreNegate(t *testing.T) {
	...
	if runtime.GOOS == "windows" {
		t.Skip("Skipped on Windows: TODO[codeinfra/codeinfra#8648] handle Windows paths in test logic")
	}
...
func TestNested(t *testing.T) {
	...
	doArchiveTest(t, ".",
		fileContents{name: ".gitignore", contents: []byte("node_modules/codeinfra/"), shouldRetain: true},
		fileContents{name: "node_modules/.gitignore", contents: []byte("@codeinfra/"), shouldRetain: true},
		fileContents{name: "included.txt", shouldRetain: true},
		fileContents{name: "node_modules/included.txt", shouldRetain: true},
		fileContents{name: "node_modules/codeinfra/excluded.txt", shouldRetain: false},
		fileContents{name: "node_modules/@codeinfra/codeinfra-cloud/excluded.txt", shouldRetain: false})
}
...
func TestTypicalPythonPolicyPackDir(t *testing.T) {
	...
	doArchiveTest(t, ".",
		...
		fileContents{name: "CodeinfraPolicy.yaml", shouldRetain: true},
...
func TestNestedPath(t *testing.T) {
	...
	doArchiveTest(t, "pkg/",
		fileContents{name: "excluded.txt", shouldRetain: false},
		fileContents{name: "pkg/.gitignore", contents: []byte("node_modules/codeinfra/"), shouldRetain: true},
		fileContents{name: "pkg/node_modules/included.txt", shouldRetain: true},
		fileContents{name: "pkg/node_modules/codeinfra/excluded.txt", shouldRetain: false},
		fileContents{name: "pkg/node_modules/codeinfra/excluded/excluded.txt", shouldRetain: false})
}
