...
func TestPropertyPath(t *testing.T) {
	...
	cases := []struct {
		...
		// The following two cases are regressions for https://github.com/khulnasoft/codeinfra/issues/14439. Ideally
...
func TestAddResizePropertyPath(t *testing.T) {
	...
	// Regression test for https://github.com/khulnasoft/codeinfra/issues/5871:
