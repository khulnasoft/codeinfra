...
func TestIsValid(t *testing.T) {
	...
	goodUrns := []string{
		"urn:codeinfra:test::test::codeinfra:codeinfra:Stack::test-test",
		"urn:codeinfra:stack-name::project-name::my:customtype$aws:s3/bucket:Bucket::bob",
		"urn:codeinfra:stack::project::type::",
		"urn:codeinfra:stack::project::type::some really ::^&\n*():: crazy name",
		"urn:codeinfra:stack::project with whitespace::type::some name",
	}
...
func TestComponentAccess(t *testing.T) {
	...
	t.Run("Stack component", func(t *testing.T) {
		...
		cases := []ComponentTestCase{
			{urn: "urn:codeinfra:stack::test::codeinfra:codeinfra:Stack::test-test", expected: "stack"},
			{urn: "urn:codeinfra:stack::::::", expected: "stack"},
			{urn: "urn:codeinfra:::test::codeinfra:codeinfra:Stack::test-test", expected: ""},
			{urn: "urn:codeinfra:::::::", expected: ""},
		}
	...
	t.Run("Project component", func(t *testing.T) {
		...
		cases := []ComponentTestCase{
			{urn: "urn:codeinfra:stack::proj::codeinfra:codeinfra:Stack::test-test", expected: "proj"},
			{urn: "urn:codeinfra:::proj::::", expected: "proj"},
			{urn: "urn:codeinfra:stack::::codeinfra:codeinfra:Stack::test-test", expected: ""},
			{urn: "urn:codeinfra:::::::", expected: ""},
		}
	...
	t.Run("QualifiedType component", func(t *testing.T) {
		...
		cases := []ComponentTestCase{
			{urn: "urn:codeinfra:stack::proj::qualified$type::test-test", expected: "qualified$type"},
			{urn: "urn:codeinfra:::::qualified$type::", expected: "qualified$type"},
			{urn: "urn:codeinfra:stack::proj::::test-test", expected: ""},
			{urn: "urn:codeinfra:::::::", expected: ""},
		}
	...
	t.Run("Type component", func(t *testing.T) {
		...
		cases := []ComponentTestCase{
			{urn: "urn:codeinfra:stack::proj::very$qualified$type::test-test", expected: "type"},
			{urn: "urn:codeinfra:::::very$qualified$type::", expected: "type"},
			{urn: "urn:codeinfra:stack::proj::qualified$type::test-test", expected: "type"},
			{urn: "urn:codeinfra:::::qualified$type::", expected: "type"},
			{urn: "urn:codeinfra:stack::proj::qualified-type::test-test", expected: "qualified-type"},
			{urn: "urn:codeinfra:::::qualified-type::", expected: "qualified-type"},
			{urn: "urn:codeinfra:stack::proj::::test-test", expected: ""},
			{urn: "urn:codeinfra:::::::", expected: ""},
	...
	t.Run("Name component", func(t *testing.T) {
		...
		cases := []ComponentTestCase{
			{urn: "urn:codeinfra:stack::proj::qualified$type::name", expected: "name"},
			{urn: "urn:codeinfra:::::::name", expected: "name"},
			{urn: "urn:codeinfra:stack::proj::qualified$type::", expected: ""},
			{urn: "urn:codeinfra:::::::", expected: ""},
			{
				urn:      "urn:codeinfra::stack::proj::type::a-longer-name",
				expected: "a-longer-name",
			},
			{
				urn:      "urn:codeinfra::stack::proj::type::a name with spaces",
				expected: "a name with spaces",
			},
			{
				urn:      "urn:codeinfra::stack::proj::type::a-name-with::a-name-separator",
				expected: "a-name-with::a-name-separator",
			},
			{
				urn:      "urn:codeinfra::stack::proj::type::a-name-with::many::name::separators",
...
func TestURNParse(t *testing.T) {
	...
	t.Run("Negative Tests", func(t *testing.T) {
		...
		t.Run("Invalid URNs", func(t *testing.T) {
			...
			invalidUrns := []string{
				"URN:CODEINFRA:TEST::TEST::CODEINFRA:CODEINFRA:STACK::TEST-TEST",
				"urn:not-codeinfra:stack-name::project-name::my:customtype$aws:s3/bucket:Bucket::bob",
				"The quick brown fox",
				"urn:codeinfra:stack::too-few-elements",
			}
...
func TestQuote(t *testing.T) {
	...
	urn, err := urn.Parse("urn:codeinfra:test::test::codeinfra:codeinfra:Stack::test-test")
	require.NoError(t, err)
	require.NotEmpty(t, urn)

	expected := "'urn:codeinfra:test::test::codeinfra:codeinfra:Stack::test-test'"
