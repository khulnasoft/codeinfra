...
import (
	...
	pTest "github.com/khulnasoft/codeinfra/sdk/v3/go/property/testing"
)

// Test that we can round trip through
// github.com/khulnasoft/codeinfra/sdk/v3/go/common/resource.PropertyValue without loosing
// information.
//
// Note: This is not possible in the other direction, since
// github.com/khulnasoft/codeinfra/sdk/v3/go/common/resource.PropertyValue can represent invalid
