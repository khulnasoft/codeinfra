...
// "github.com/khulnasoft/codeinfra/sdk/v3/go/common/resource/urn". This file exists to fulfill
...
// URN is a friendly, but unique, URN for a resource, most often auto-assigned by Codeinfra.  These are
...
//
//	urn:codeinfra:<Stack>::<Project>::<Qualified$Type$Name>::<Name>
//
