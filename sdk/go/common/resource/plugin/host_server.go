...
func (eng *hostServer) Log(ctx context.Context, req *codeinfrarpc.LogRequest) (*emptypb.Empty, error) {
...
func (eng *hostServer) GetRootResource(ctx context.Context,
	...
	var response codeinfrarpc.GetRootResourceResponse
...
func (eng *hostServer) SetRootResource(ctx context.Context,
	...
	var response codeinfrarpc.SetRootResourceResponse
