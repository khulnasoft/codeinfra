...
func TestConverterServer_State(t *testing.T) {
	...
	resp, err := server.ConvertState(context.Background(), &codeinfrarpc.ConvertStateRequest{
...
func TestConverterServer_Program(t *testing.T) {
	...
	resp, err := server.ConvertProgram(context.Background(), &codeinfrarpc.ConvertProgramRequest{
		MapperTarget:    "localhost:1234",
