...
import (
	...
	codegenrpc "github.com/khulnasoft/codeinfra/sdk/v3/proto/go/codegen"
...
func (c *testConverterClient) ConvertState(
	ctx context.Context, req *codeinfrarpc.ConvertStateRequest, opts ...grpc.CallOption,
) (*codeinfrarpc.ConvertStateResponse, error) {
	...
	return &codeinfrarpc.ConvertStateResponse{
		Resources: []*codeinfrarpc.ResourceImport{
			{
				Type:              "test:type",
				Name:              "test:name",
				Id:                "test:id",
...
func (c *testConverterClient) ConvertProgram(
	ctx context.Context, req *codeinfrarpc.ConvertProgramRequest, opts ...grpc.CallOption,
) (*codeinfrarpc.ConvertProgramResponse, error) {
	if req.MapperTarget != "localhost:1234" {
		return nil, fmt.Errorf("unexpected MapperTarget: %s", req.MapperTarget)
	}
	...
	return &codeinfrarpc.ConvertProgramResponse{
		Diagnostics: c.diagnostics,
	}, nil
}
...
func TestConverterPlugin_Program_EmptyDiagnosticsIsNil(t *testing.T) {
	// Regression test for https://github.com/khulnasoft/codeinfra-terraform-bridge/issues/1201 hcl.Diagnostics
