...
type converter struct {
	...
	clientRaw codeinfrarpc.ConverterClient // the raw provider client; usually unsafe to use directly.
}
...
func NewConverter(ctx *Context, name string, version *semver.Version) (Converter, error) {
	...
	c := &converter{
		name:      name,
		plug:      plug,
		clientRaw: codeinfrarpc.NewConverterClient(plug.Conn),
	}
...
func (c *converter) ConvertState(ctx context.Context, req *ConvertStateRequest) (*ConvertStateResponse, error) {
	...
	resp, err := c.clientRaw.ConvertState(ctx, &codeinfrarpc.ConvertStateRequest{
...
func (c *converter) ConvertProgram(ctx context.Context, req *ConvertProgramRequest) (*ConvertProgramResponse, error) {
	...
	resp, err := c.clientRaw.ConvertProgram(ctx, &codeinfrarpc.ConvertProgramRequest{
