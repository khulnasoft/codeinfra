...
type converterServer struct {
	codeinfrarpc.UnsafeConverterServer // opt out of forward compat
...
func (c *converterServer) ConvertState(ctx context.Context,
	req *codeinfrarpc.ConvertStateRequest,
	...
	resources := make([]*codeinfrarpc.ResourceImport, len(resp.Resources))
	for i, resource := range resp.Resources {
		resources[i] = &codeinfrarpc.ResourceImport{
			Type:              resource.Type,
			Name:              resource.Name,
			Id:                resource.ID,
	...
	rpcResp := &codeinfrarpc.ConvertStateResponse{
		Resources:   resources,
		Diagnostics: diags,
	}
	return rpcResp, nil
...
func (c *converterServer) ConvertProgram(ctx context.Context,
	req *codeinfrarpc.ConvertProgramRequest,
