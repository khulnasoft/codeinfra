...
func TestRepr(t *testing.T) {
	...
	isAccept := cmdutil.IsTruthy(os.Getenv("CODEINFRA_ACCEPT"))
	...
	// truth (if CODEINFRA_ACCEPT is truthy) or load the expected results and validate against the actual results.
