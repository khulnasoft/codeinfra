...
func TestArray(t *testing.T) {
	...
	arr := codeinfrax.Array[string]{
		codeinfrax.Val("foo"),
		codeinfra.String("bar"),
		codeinfrax.Ptr("baz").Elem(),
	}.ToOutput(ctx)
...
func TestGArrayOutput(t *testing.T) {
	...
	ctx := context.Background()
	o := codeinfrax.Cast[codeinfrax.GArrayOutput[string, codeinfra.StringOutput], []string](
		codeinfrax.Array[string]{
	...
	t.Run("index/match", func(t *testing.T) {
		...
		el := o.Index(codeinfrax.Val(0))
		assert.IsType(t, codeinfra.StringOutput{}, el)
