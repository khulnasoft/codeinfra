...
// Untyped converts a GPtrOutput[T] to a codeinfra.Output.
//
...
// For example,
//
//	var s codeinfra.StringOutput = ... // implements Input[string]
...
// Untyped converts a PtrOutput[T] to a codeinfra.Output.
//
// See [Output.Untyped] for more details.
