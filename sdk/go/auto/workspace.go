...
// Workspace is the execution context containing a single Codeinfra project, a program, and multiple stacks.
...
type Workspace interface {
	...
	WorkDir() string
	// CodeinfraCommand returns the CodeinfraCommand instance that is used to run CodeinfraCommand CLI commands.
...
// ConfigValue is a configuration value used by a Codeinfra program.
...
// ConfigOptions is a configuration option used by a Codeinfra program.
...
// GetAllConfigOptions is a configuration option used by a Codeinfra program.
...
// ConfigMap is a map of ConfigValue used by Codeinfra programs.
...
// WhoAmIResult contains detailed information about the currently logged-in Codeinfra identity.
