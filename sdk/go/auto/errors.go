...
// IsUnexpectedEngineError returns true if the codeinfra core engine encountered an error (most likely a bug).
func IsUnexpectedEngineError(e error) bool {
	...
	return strings.Contains(as.stdout, "The Codeinfra CLI encountered a fatal error. This is a bug!")
}
