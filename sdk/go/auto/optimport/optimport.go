...
// Protect configures whether to set imported resources as protected in the Codeinfra state.
...
type ImportResource struct {
	...
	// The type token of the Codeinfra resource
	Type string `json:"type,omitempty"`
	// The name of the resource
	Name string `json:"name,omitempty"`
	// The name of the resource used in the generated Codeinfra program from the import
