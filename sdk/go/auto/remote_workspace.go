...
// GitRepo. Codeinfra operations on the stack (Preview, Update, Refresh, and Destroy) are performed remotely.
...
// Codeinfra operations on the stack (Preview, Update, Refresh, and Destroy) are performed remotely.
...
// specified GitRepo. Codeinfra operations on the stack (Preview, Update, Refresh, and Destroy) are performed remotely.
...
type remoteWorkspaceOptions struct {
	...
	// AgentPoolID is the agent pool (also called deployment runner pool) to use for the remote Codeinfra operation.
	AgentPoolID string
}
...
// RemotePreRunCommands is an optional list of arbitrary commands to run before the remote Codeinfra operation is invoked.
