...
export abstract class Asset {
    ...
    public readonly __codeinfraAsset: boolean = true;

    /**
     * Returns true if the given object is an {@link Asset}. This is designed to
     * work even when multiple copies of the Codeinfra SDK have been loaded into
     * the same process.
     */
    public static isInstance(obj: any): obj is Asset {
        return utils.isInstance<Asset>(obj, "__codeinfraAsset");
    }
}
