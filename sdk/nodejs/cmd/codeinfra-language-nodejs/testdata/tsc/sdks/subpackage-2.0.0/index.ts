...
codeinfra.runtime.registerResourceModule("subpackage", "index", _module)
codeinfra.runtime.registerResourcePackage("subpackage", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): codeinfra.ProviderResource => {
        if (type !== "codeinfra:providers:subpackage") {
