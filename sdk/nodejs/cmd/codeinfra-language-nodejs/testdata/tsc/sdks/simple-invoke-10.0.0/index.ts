...
codeinfra.runtime.registerResourceModule("simple-invoke", "index", _module)
codeinfra.runtime.registerResourcePackage("simple-invoke", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): codeinfra.ProviderResource => {
        if (type !== "codeinfra:providers:simple-invoke") {
