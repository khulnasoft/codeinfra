...
codeinfra.runtime.registerResourceModule("config-grpc", "index", _module)
codeinfra.runtime.registerResourcePackage("config-grpc", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): codeinfra.ProviderResource => {
        if (type !== "codeinfra:providers:config-grpc") {
