...
codeinfra.runtime.registerResourceModule("component", "index", _module)
codeinfra.runtime.registerResourcePackage("component", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): codeinfra.ProviderResource => {
        if (type !== "codeinfra:providers:component") {
