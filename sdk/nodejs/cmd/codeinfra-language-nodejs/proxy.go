...
func createAndServePipes(ctx context.Context, target codeinfrarpc.ResourceMonitorClient) (pipes, chan error, error) {
...
func servePipes(ctx context.Context, pipes pipes, target codeinfrarpc.ResourceMonitorClient) chan error {
	...
	go func() {
		...
		err := func() error {
			...
			for {
				...
				var req codeinfrarpc.ResourceInvokeRequest
				...
				if err != nil {
					...
					if res == nil {
						res = &codeinfrarpc.InvokeResponse{}
					}

					res.Failures = append(res.Failures, &codeinfrarpc.CheckFailure{
						Property: "",
						Reason:   err.Error(),
					})
				}
...
type monitorProxy struct {
	...
	target codeinfrarpc.ResourceMonitorClient
}
...
func (p *monitorProxy) StreamInvoke(
	req *codeinfrarpc.ResourceInvokeRequest, server codeinfrarpc.ResourceMonitor_StreamInvokeServer,
) error {
...
func (p *monitorProxy) Call(
	ctx context.Context, req *codeinfrarpc.ResourceCallRequest,
) (*codeinfrarpc.CallResponse, error) {
	return p.target.Call(ctx, req)
}

func (p *monitorProxy) ReadResource(
	ctx context.Context, req *codeinfrarpc.ReadResourceRequest,
) (*codeinfrarpc.ReadResourceResponse, error) {
	return p.target.ReadResource(ctx, req)
}

func (p *monitorProxy) RegisterResource(
	ctx context.Context, req *codeinfrarpc.RegisterResourceRequest,
) (*codeinfrarpc.RegisterResourceResponse, error) {
	// Add the "codeinfra-runtime" header to the context so the engine can detect this request
	...
	ctx = metadata.AppendToOutgoingContext(ctx, "codeinfra-runtime", "nodejs")
	return p.target.RegisterResource(ctx, req)
}

func (p *monitorProxy) RegisterResourceOutputs(
	ctx context.Context, req *codeinfrarpc.RegisterResourceOutputsRequest,
) (*emptypb.Empty, error) {
	return p.target.RegisterResourceOutputs(ctx, req)
}

func (p *monitorProxy) SupportsFeature(
	ctx context.Context, req *codeinfrarpc.SupportsFeatureRequest,
...
func (p *monitorProxy) RegisterStackTransform(
	ctx context.Context, req *codeinfrarpc.Callback,
) (*emptypb.Empty, error) {
...
func (p *monitorProxy) RegisterPackage(
	ctx context.Context, req *codeinfrarpc.RegisterPackageRequest,
