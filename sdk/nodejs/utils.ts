...
export const disableResourceReferences: boolean =
    process.env.CODEINFRA_DISABLE_RESOURCE_REFERENCES === "1" ||
    (process.env.CODEINFRA_DISABLE_RESOURCE_REFERENCES ?? "").toUpperCase() === "TRUE";

/**
 * @internal
 */
export const errorOutputString: boolean =
    process.env.CODEINFRA_ERROR_OUTPUT_STRING === "1" || process.env.CODEINFRA_ERROR_OUTPUT_STRING?.toUpperCase() === "TRUE";
