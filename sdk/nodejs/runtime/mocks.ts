 ...
 * implemented by the Codeinfra engine with their own implementations. This can be
...
export class MockMonitor {
    ...
    private newUrn(parent: string, type: string, name: string): string {
        ...
        return "urn:codeinfra:" + [getStack(), getProject(), type, name].join("::");
    }
...
/**
 * Configures the Codeinfra runtime to use the given mocks for testing.
 *
 * @param mocks
 *  The mocks to use for calls to provider functions and resource construction.
 * @param project
 *  If provided, the name of the Codeinfra project. Defaults to "project".
 * @param stack
 *  If provided, the name of the Codeinfra stack. Defaults to "stack".
 * @param preview
 *  If provided, indicates whether or not the program is running a preview. Defaults to false.
 * @param organization
 *  If provided, the name of the Codeinfra organization. Defaults to nothing.
 */
