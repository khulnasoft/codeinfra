...
export function getOrganization(): string {
    ...
    throw new Error("Missing organization name; for test mode, please call `codeinfra.runtime.setMocks`");
}
 ...
 *
 * For CLI driven programs, `codeinfra-language-nodejs` sets environment variables
 ...
 * of `@codeinfra/codeinfra` and thus duplicate options objects that may not be synced
