...
import * as codeinfra from "../index";
...
class MyComponent extends codeinfra.ComponentResource {
    outprop: codeinfra.Output<string>;
    constructor(name: string, inprop: codeinfra.Input<string>, opts?: codeinfra.ComponentResourceOptions) {
        super("pkg:index:MyComponent", name, {}, opts);
        this.outprop = codeinfra.output(inprop).apply((x) => `output: ${x}`);
    }
}

class MyRemoteComponent extends codeinfra.ComponentResource {
    outprop!: codeinfra.Output<string>;
    constructor(name: string, inprop: codeinfra.Input<string>, opts?: codeinfra.ComponentResourceOptions) {
...
class Instance extends codeinfra.CustomResource {
    publicIP!: codeinfra.Output<string>;
...
class MyCustom extends codeinfra.CustomResource {
    instance!: codeinfra.Output<Instance>;
    static get(
        name: string,
        id: codeinfra.Input<codeinfra.ID>,
        state?: Record<string, any>,
        opts?: codeinfra.CustomResourceOptions,
    ): MyCustom {
...
async function invoke(): Promise<number> {
    const value = await codeinfra.runtime.invoke("test:index:MyFunction", { value: 41 });
...
setups.forEach(([test, isAsyncNewResource, isAsyncCall]) => {
    describe(test, function () {
        ...
        before(() => {
            ...
            codeinfra.runtime.registerResourceModule("aws", "ec2/instance", {
            ...
            invokeResult = invoke();
            remoteComponent = new MyRemoteComponent("myremotecomponent", codeinfra.interpolate`hello: ${instance.id}`);
        });
