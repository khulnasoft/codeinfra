...
Historically these packages were direct dependencies of `@codeinfra/codeinfra`. To decouple the node SDK from the precise version of TypeScript, the packages are now declared as optional peer pependencies of `@codeinfra/codeinfra` and customers can pick the versions they want.
