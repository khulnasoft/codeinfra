 ...
 * from the codeinfra CLI itself. Less common than {@link DiagnosticEvent}
 */
...
/**
 * {@link StepEventMetadata} describes a "step" within the Codeinfra engine, which
...
/**
 * A Codeinfra engine event, such as a change to a resource or diagnostic message.
...
export interface EngineEvent {
     ...
     * to the Codeinfra Service. Since events may be sent concurrently, and/or
