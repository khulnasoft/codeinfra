...
import { CodeinfraCommand } from "./cmd";
...
/**
 * {@link Workspace} is the execution context containing a single Codeinfra
...
export interface Workspace {
     ...
     */
    readonly codeinfraVersion: string;

    /**
     * The underlying Codeinfra CLI.
     */
    readonly codeinfraCommand: CodeinfraCommand;
     ...
     * supplied to every Codeinfra command.
     */
     ...
     * create/modify a `Codeinfra.stack.yaml`)
     */
     ...
     * {@link Workspace} as `Codeinfra.<stack>.yaml` files.
     *
     * @param opts
...
/**
 * A Codeinfra program as an inline function (in process).
 */
export type CodeinfraFn = () => Promise<Record<string, any> | void>;

/**
 * The currently logged-in Codeinfra access token.
 */
