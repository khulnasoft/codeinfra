...
/**
 * A Codeinfra project manifest. It describes metadata applying to all sub-stacks
...
/**
 * Supported Codeinfra program language runtimes.
 */
...
/**
 * Configuration for the project's Codeinfra state storage backend.
 */
