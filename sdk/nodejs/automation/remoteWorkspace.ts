...
export class RemoteWorkspace {
     ...
     * code from the specified Git repository. Codeinfra operations on the stack
     ...
     * with source code from the specified Git repository. Codeinfra operations on
     * the stack (preview, update, refresh, and destroy) are performed remotely.
     *
     * @param args
     *  A set of arguments to initialize a RemoteStack with a remote Codeinfra program from a Git repository.
     * @param opts
     *  Additional customizations to be applied to the Workspace.
     */
...
/**
 * Description of a stack backed by a remote Codeinfra program in a Git repository.
 */
export interface RemoteGitProgramArgs {
    ...
    /**
     * An optional path relative to the repo root specifying location of the Codeinfra program.
     */
    projectPath?: string;
...
export interface RemoteWorkspaceOptions {
    ...
    /**
     * An optional list of arbitrary commands to run before a remote Codeinfra
