...
//
// When Codeinfra CLI decides how to structure command line arguments for
// plugins that will be parsed with this function, it uses the
// following code:
//
// https://github.com/khulnasoft/codeinfra/blob/master/sdk/go/common/resource/plugin/plugin.go#L281
//
