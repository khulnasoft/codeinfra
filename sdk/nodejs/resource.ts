...
export function createUrn(
    ...
    if (parent) {
        ...
        parentPrefix = parentUrn.apply((parentUrnString) => {
            ...
            if (prefix.endsWith("::codeinfra:codeinfra:Stack$")) {
                // Don't prefix the stack type as a parent type
                return `urn:codeinfra:${stack || getStack()}::${project || getProject()}::`;
            }
            return prefix;
        });
    } else {
        parentPrefix = output(`urn:codeinfra:${stack || getStack()}::${project || getProject()}::`);
    }
...
export abstract class Resource {
    ...
    public readonly __codeinfraResource: boolean = true;
     ...
     */
    // eslint-disable-next-line @typescript-eslint/naming-convention,no-underscore-dangle,id-blacklist,id-match
    public readonly __codeinfraType: string;

    public static isInstance(obj: any): obj is Resource {
        return utils.isInstance<Resource>(obj, "__codeinfraResource");
    }
...
/**
 * A constant to represent the "root stack" resource for a Codeinfra application.
...
export interface Alias {
     ...
     *
     * To specify no original parent, use `{ parent: codeinfra.rootStackResource }`.
     */
    parent?: Resource | Input<URN>;
...
export interface CustomResourceOptions extends ResourceOptions {
     ...
     * This augments the list that the resource provider and Codeinfra engine
...
export abstract class CustomResource extends Resource {
     ...
     */
    // eslint-disable-next-line @typescript-eslint/naming-convention,no-underscore-dangle,id-blacklist,id-match
    public readonly __codeinfraCustomResource: boolean;
     ...
     * designed to work even when multiple copies of the Codeinfra SDK have been
     * loaded into the same process.
     */
    public static isInstance(obj: any): obj is CustomResource {
        return utils.isInstance<CustomResource>(obj, "__codeinfraCustomResource");
    }
    ...
    constructor(
        ...
        this.__codeinfraCustomResource = true;
    }
}
...
export abstract class ProviderResource extends CustomResource {
    ...
    constructor(
        ...
        super(`codeinfra:providers:${pkg}`, name, props, opts, dependency, packageRef);
        this.pkg = pkg;
    }
...
export class ComponentResource<TData = any> extends Resource {
     ...
     */
    // eslint-disable-next-line @typescript-eslint/naming-convention,no-underscore-dangle,id-blacklist,id-match
    public readonly __codeinfraComponentResource = true;
    ...
    public static isInstance(obj: any): obj is ComponentResource {
        return utils.isInstance<ComponentResource>(obj, "__codeinfraComponentResource");
    }
...
export class DependencyProviderResource extends ProviderResource {
    constructor(ref: string) {
        ...
        // type will be "codeinfra:providers:<package>" and we want the last part.
