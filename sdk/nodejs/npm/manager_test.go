...
func fakeNPMRegistry(t testing.TB) string {
	...
	srv = httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		switch r.URL.Path {
		case "/@codeinfra/codeinfra":
			tarballURL := srv.URL + "/@codeinfra/codeinfra/-/codeinfra-3.0.0.tgz"
			fmt.Fprintf(w, `{
				"name": "@codeinfra/codeinfra",
		...
		case "/@codeinfra/codeinfra/-/codeinfra-3.0.0.tgz":
