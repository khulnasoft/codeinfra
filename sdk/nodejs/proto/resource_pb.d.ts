...
export class ReadResourceRequest extends jspb.Message { 
    ...
    getSourceposition(): codeinfra_source_pb.SourcePosition | undefined;
    setSourceposition(value?: codeinfra_source_pb.SourcePosition): ReadResourceRequest;
...
export namespace ReadResourceRequest {
    export type AsObject = {
        ...
        sourceposition?: codeinfra_source_pb.SourcePosition.AsObject,
        packageref: string,
    }
}
...
export class RegisterResourceRequest extends jspb.Message { 
    ...
    getAliasesList(): Array<codeinfra_alias_pb.Alias>;
    setAliasesList(value: Array<codeinfra_alias_pb.Alias>): RegisterResourceRequest;
    addAliases(value?: codeinfra_alias_pb.Alias, index?: number): codeinfra_alias_pb.Alias;
    ...
    clearSourceposition(): void;
    getSourceposition(): codeinfra_source_pb.SourcePosition | undefined;
    setSourceposition(value?: codeinfra_source_pb.SourcePosition): RegisterResourceRequest;
    clearTransformsList(): void;
    getTransformsList(): Array<codeinfra_callback_pb.Callback>;
    setTransformsList(value: Array<codeinfra_callback_pb.Callback>): RegisterResourceRequest;
    addTransforms(value?: codeinfra_callback_pb.Callback, index?: number): codeinfra_callback_pb.Callback;
...
export namespace RegisterResourceRequest {
    export type AsObject = {
        ...
        aliasesList: Array<codeinfra_alias_pb.Alias.AsObject>,
        deletedwith: string,
        aliasspecs: boolean,
        sourceposition?: codeinfra_source_pb.SourcePosition.AsObject,
        transformsList: Array<codeinfra_callback_pb.Callback.AsObject>,
...
export class ResourceInvokeRequest extends jspb.Message { 
    ...
    clearSourceposition(): void;
    getSourceposition(): codeinfra_source_pb.SourcePosition | undefined;
    setSourceposition(value?: codeinfra_source_pb.SourcePosition): ResourceInvokeRequest;
    getPackageref(): string;
...
export class ResourceCallRequest extends jspb.Message { 
    ...
    clearSourceposition(): void;
    getSourceposition(): codeinfra_source_pb.SourcePosition | undefined;
    setSourceposition(value?: codeinfra_source_pb.SourcePosition): ResourceCallRequest;
    getPackageref(): string;
...
export class TransformResourceOptions extends jspb.Message { 
    ...
    clearAliasesList(): void;
    getAliasesList(): Array<codeinfra_alias_pb.Alias>;
    setAliasesList(value: Array<codeinfra_alias_pb.Alias>): TransformResourceOptions;
    addAliases(value?: codeinfra_alias_pb.Alias, index?: number): codeinfra_alias_pb.Alias;
    getProvider(): string;
