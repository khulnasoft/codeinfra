...
proto.codegen.GetMappingRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    codeinfraProvider: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
...
proto.codegen.GetMappingRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      var value = /** @type {string} */ (reader.readString());
      msg.setCodeinfraProvider(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.codegen.GetMappingRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getCodeinfraProvider();
  if (f.length > 0) {
    writer.writeString(
      2,
      f
...
/**
 * optional string codeinfra_provider = 2;
 * @return {string}
 */
proto.codegen.GetMappingRequest.prototype.getCodeinfraProvider = function() {
 ...
 * @return {!proto.codegen.GetMappingRequest} returns this
 */
proto.codegen.GetMappingRequest.prototype.setCodeinfraProvider = function(value) {
