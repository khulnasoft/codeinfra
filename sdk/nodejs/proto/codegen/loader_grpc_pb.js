...
var codeinfra_codegen_loader_pb = require('../codegen/loader_pb.js');

function serialize_codegen_GetSchemaRequest(arg) {
  if (!(arg instanceof codeinfra_codegen_loader_pb.GetSchemaRequest)) {
...
function deserialize_codegen_GetSchemaRequest(buffer_arg) {
  return codeinfra_codegen_loader_pb.GetSchemaRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_codegen_GetSchemaResponse(arg) {
  if (!(arg instanceof codeinfra_codegen_loader_pb.GetSchemaResponse)) {
...
function deserialize_codegen_GetSchemaResponse(buffer_arg) {
  return codeinfra_codegen_loader_pb.GetSchemaResponse.deserializeBinary(new Uint8Array(buffer_arg));
}


// Loader is a service for getting schemas from the Codeinfra engine for use in code generators and other tools.
...
getSchema: {
    ...
    requestType: codeinfra_codegen_loader_pb.GetSchemaRequest,
    responseType: codeinfra_codegen_loader_pb.GetSchemaResponse,
