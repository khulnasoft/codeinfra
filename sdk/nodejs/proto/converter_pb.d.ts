...
export class ConvertStateResponse extends jspb.Message { 
    ...
    setDiagnosticsList(value: Array<codeinfra_codegen_hcl_pb.Diagnostic>): ConvertStateResponse;
...
export class ConvertProgramResponse extends jspb.Message { 
    clearDiagnosticsList(): void;
    getDiagnosticsList(): Array<codeinfra_codegen_hcl_pb.Diagnostic>;
    setDiagnosticsList(value: Array<codeinfra_codegen_hcl_pb.Diagnostic>): ConvertProgramResponse;
    addDiagnostics(value?: codeinfra_codegen_hcl_pb.Diagnostic, index?: number): codeinfra_codegen_hcl_pb.Diagnostic;
