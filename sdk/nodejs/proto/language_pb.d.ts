...
export class GetRequiredPluginsResponse extends jspb.Message { 
    ...
    getPluginsList(): Array<codeinfra_plugin_pb.PluginDependency>;
    setPluginsList(value: Array<codeinfra_plugin_pb.PluginDependency>): GetRequiredPluginsResponse;
    addPlugins(value?: codeinfra_plugin_pb.PluginDependency, index?: number): codeinfra_plugin_pb.PluginDependency;
...
export namespace GetRequiredPluginsResponse {
    export type AsObject = {
        pluginsList: Array<codeinfra_plugin_pb.PluginDependency.AsObject>,
    }
}
...
export class GetRequiredPackagesResponse extends jspb.Message { 
    ...
    getPackagesList(): Array<codeinfra_plugin_pb.PackageDependency>;
    setPackagesList(value: Array<codeinfra_plugin_pb.PackageDependency>): GetRequiredPackagesResponse;
    addPackages(value?: codeinfra_plugin_pb.PackageDependency, index?: number): codeinfra_plugin_pb.PackageDependency;
...
export namespace GetRequiredPackagesResponse {
    export type AsObject = {
        packagesList: Array<codeinfra_plugin_pb.PackageDependency.AsObject>,
    }
}
...
export class GenerateProgramResponse extends jspb.Message { 
    ...
    getDiagnosticsList(): Array<codeinfra_codegen_hcl_pb.Diagnostic>;
    setDiagnosticsList(value: Array<codeinfra_codegen_hcl_pb.Diagnostic>): GenerateProgramResponse;
    addDiagnostics(value?: codeinfra_codegen_hcl_pb.Diagnostic, index?: number): codeinfra_codegen_hcl_pb.Diagnostic;
...
export namespace GenerateProgramResponse {
    export type AsObject = {
        diagnosticsList: Array<codeinfra_codegen_hcl_pb.Diagnostic.AsObject>,
...
export class GenerateProjectResponse extends jspb.Message { 
    clearDiagnosticsList(): void;
    getDiagnosticsList(): Array<codeinfra_codegen_hcl_pb.Diagnostic>;
    setDiagnosticsList(value: Array<codeinfra_codegen_hcl_pb.Diagnostic>): GenerateProjectResponse;
    addDiagnostics(value?: codeinfra_codegen_hcl_pb.Diagnostic, index?: number): codeinfra_codegen_hcl_pb.Diagnostic;
...
export class GeneratePackageResponse extends jspb.Message { 
    clearDiagnosticsList(): void;
    getDiagnosticsList(): Array<codeinfra_codegen_hcl_pb.Diagnostic>;
    setDiagnosticsList(value: Array<codeinfra_codegen_hcl_pb.Diagnostic>): GeneratePackageResponse;
    addDiagnostics(value?: codeinfra_codegen_hcl_pb.Diagnostic, index?: number): codeinfra_codegen_hcl_pb.Diagnostic;
