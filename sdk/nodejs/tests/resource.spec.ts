...
describe("createUrn", () => {
    ...
    it("handles name and type", async () => {
        ...
        assert.strictEqual(urn, "urn:codeinfra:mystack::myproject::t::n");
    });

    it("handles name and type and parent", async () => {
        const res = new MyResource("myres");
        const urn = await createUrn("n", "t", res).promise();
        assert.strictEqual(urn, "urn:codeinfra:mystack::myproject::my:mod:MyResource$t::n");
    });
    ...
    it("handles name and type and parent with parent", async () => {
        ...
        assert.strictEqual(urn, "urn:codeinfra:mystack::myproject::my:mod:MyParentResource$my:mod:MyResource$t::n");
    });
});
...
describe("allAliases", () => {
    ...
    const testCases = [
        ...
        },
        {
            ...
            results: ["urn:codeinfra:stack::project::test:resource:type$test:resource:child2::myres-child"],
        },
        {
            name: "one child alias (name), no parent aliases",
            parentAliases: [],
            childAliases: [{ name: "child2" }],
            results: ["urn:codeinfra:stack::project::test:resource:type$test:resource:child::child2"],
        },
        {
...
describe("CustomResource", () => {
    ...
    // https://github.com/khulnasoft/codeinfra/issues/13777
...
describe("ComponentResource", () => {
    ...
    // https://github.com/khulnasoft/codeinfra/issues/12161
