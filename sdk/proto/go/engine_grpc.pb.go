...
func (c *engineClient) Log(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/codeinfrarpc.Engine/Log", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *engineClient) GetRootResource(ctx context.Context, in *GetRootResourceRequest, opts ...grpc.CallOption) (*GetRootResourceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/codeinfrarpc.Engine/GetRootResource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *engineClient) SetRootResource(ctx context.Context, in *SetRootResourceRequest, opts ...grpc.CallOption) (*SetRootResourceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/codeinfrarpc.Engine/SetRootResource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *engineClient) StartDebugging(ctx context.Context, in *StartDebuggingRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/codeinfrarpc.Engine/StartDebugging", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Engine_Log_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/codeinfrarpc.Engine/Log",
	}
...
func _Engine_GetRootResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/codeinfrarpc.Engine/GetRootResource",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Engine_SetRootResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/codeinfrarpc.Engine/SetRootResource",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Engine_StartDebugging_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/codeinfrarpc.Engine/StartDebugging",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
