...
func (x *ConvertStateRequest) Reset() {
	*x = ConvertStateRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_codeinfra_converter_proto_msgTypes[0]
...
func (*ConvertStateRequest) Descriptor() ([]byte, []int) {
	return file_codeinfra_converter_proto_rawDescGZIP(), []int{0}
}
...
func (x *ResourceImport) Reset() {
	*x = ResourceImport{}
	if protoimpl.UnsafeEnabled {
		mi := &file_codeinfra_converter_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResourceImport) Descriptor() ([]byte, []int) {
	return file_codeinfra_converter_proto_rawDescGZIP(), []int{1}
}
...
func (x *ConvertStateResponse) Reset() {
	*x = ConvertStateResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_codeinfra_converter_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConvertStateResponse) Descriptor() ([]byte, []int) {
	return file_codeinfra_converter_proto_rawDescGZIP(), []int{2}
}
...
func (x *ConvertProgramRequest) Reset() {
	*x = ConvertProgramRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_codeinfra_converter_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConvertProgramRequest) Descriptor() ([]byte, []int) {
	return file_codeinfra_converter_proto_rawDescGZIP(), []int{3}
}
...
func (x *ConvertProgramResponse) Reset() {
	*x = ConvertProgramResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_codeinfra_converter_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConvertProgramResponse) Descriptor() ([]byte, []int) {
	return file_codeinfra_converter_proto_rawDescGZIP(), []int{4}
}
...
var file_codeinfra_converter_proto_rawDesc = []byte{
...
var (
	file_codeinfra_converter_proto_rawDescOnce sync.Once
	file_codeinfra_converter_proto_rawDescData = file_codeinfra_converter_proto_rawDesc
)

func file_codeinfra_converter_proto_rawDescGZIP() []byte {
	file_codeinfra_converter_proto_rawDescOnce.Do(func() {
		file_codeinfra_converter_proto_rawDescData = protoimpl.X.CompressGZIP(file_codeinfra_converter_proto_rawDescData)
	})
	return file_codeinfra_converter_proto_rawDescData
}

var file_codeinfra_converter_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_codeinfra_converter_proto_goTypes = []interface{}{
	(*ConvertStateRequest)(nil),    // 0: codeinfrarpc.ConvertStateRequest
	(*ResourceImport)(nil),         // 1: codeinfrarpc.ResourceImport
	(*ConvertStateResponse)(nil),   // 2: codeinfrarpc.ConvertStateResponse
	(*ConvertProgramRequest)(nil),  // 3: codeinfrarpc.ConvertProgramRequest
	(*ConvertProgramResponse)(nil), // 4: codeinfrarpc.ConvertProgramResponse
	(*codegen.Diagnostic)(nil),     // 5: codeinfrarpc.codegen.Diagnostic
}
var file_codeinfra_converter_proto_depIdxs = []int32{
	1, // 0: codeinfrarpc.ConvertStateResponse.resources:type_name -> codeinfrarpc.ResourceImport
	5, // 1: codeinfrarpc.ConvertStateResponse.diagnostics:type_name -> codeinfrarpc.codegen.Diagnostic
	5, // 2: codeinfrarpc.ConvertProgramResponse.diagnostics:type_name -> codeinfrarpc.codegen.Diagnostic
	0, // 3: codeinfrarpc.Converter.ConvertState:input_type -> codeinfrarpc.ConvertStateRequest
	3, // 4: codeinfrarpc.Converter.ConvertProgram:input_type -> codeinfrarpc.ConvertProgramRequest
	2, // 5: codeinfrarpc.Converter.ConvertState:output_type -> codeinfrarpc.ConvertStateResponse
	4, // 6: codeinfrarpc.Converter.ConvertProgram:output_type -> codeinfrarpc.ConvertProgramResponse
...
func init() { file_codeinfra_converter_proto_init() }
func file_codeinfra_converter_proto_init() {
	if File_codeinfra_converter_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_codeinfra_converter_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_codeinfra_converter_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_codeinfra_converter_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_codeinfra_converter_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_codeinfra_converter_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_codeinfra_converter_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_codeinfra_converter_proto_goTypes,
		DependencyIndexes: file_codeinfra_converter_proto_depIdxs,
		MessageInfos:      file_codeinfra_converter_proto_msgTypes,
	}.Build()
	File_codeinfra_converter_proto = out.File
	file_codeinfra_converter_proto_rawDesc = nil
	file_codeinfra_converter_proto_goTypes = nil
	file_codeinfra_converter_proto_depIdxs = nil
}
