...
// 	protoc        v3.20.1
// source: codeinfra/codegen/loader.proto
...
func (x *Parameterization) Reset() {
	*x = Parameterization{}
	if protoimpl.UnsafeEnabled {
		mi := &file_codeinfra_codegen_loader_proto_msgTypes[0]
...
func (*Parameterization) Descriptor() ([]byte, []int) {
	return file_codeinfra_codegen_loader_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetSchemaRequest) Reset() {
	*x = GetSchemaRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_codeinfra_codegen_loader_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetSchemaRequest) Descriptor() ([]byte, []int) {
	return file_codeinfra_codegen_loader_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetSchemaResponse) Reset() {
	*x = GetSchemaResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_codeinfra_codegen_loader_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetSchemaResponse) Descriptor() ([]byte, []int) {
	return file_codeinfra_codegen_loader_proto_rawDescGZIP(), []int{2}
}
...
var file_codeinfra_codegen_loader_proto_rawDesc = []byte{
...
var (
	file_codeinfra_codegen_loader_proto_rawDescOnce sync.Once
	file_codeinfra_codegen_loader_proto_rawDescData = file_codeinfra_codegen_loader_proto_rawDesc
)

func file_codeinfra_codegen_loader_proto_rawDescGZIP() []byte {
	file_codeinfra_codegen_loader_proto_rawDescOnce.Do(func() {
		file_codeinfra_codegen_loader_proto_rawDescData = protoimpl.X.CompressGZIP(file_codeinfra_codegen_loader_proto_rawDescData)
	})
	return file_codeinfra_codegen_loader_proto_rawDescData
}

var file_codeinfra_codegen_loader_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_codeinfra_codegen_loader_proto_goTypes = []interface{}{
...
var file_codeinfra_codegen_loader_proto_depIdxs = []int32{
...
func init() { file_codeinfra_codegen_loader_proto_init() }
func file_codeinfra_codegen_loader_proto_init() {
	if File_codeinfra_codegen_loader_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_codeinfra_codegen_loader_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_codeinfra_codegen_loader_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_codeinfra_codegen_loader_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_codeinfra_codegen_loader_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_codeinfra_codegen_loader_proto_goTypes,
		DependencyIndexes: file_codeinfra_codegen_loader_proto_depIdxs,
		MessageInfos:      file_codeinfra_codegen_loader_proto_msgTypes,
	}.Build()
	File_codeinfra_codegen_loader_proto = out.File
	file_codeinfra_codegen_loader_proto_rawDesc = nil
	file_codeinfra_codegen_loader_proto_goTypes = nil
	file_codeinfra_codegen_loader_proto_depIdxs = nil
}
