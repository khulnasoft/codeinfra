...
func (DiagnosticSeverity) Descriptor() protoreflect.EnumDescriptor {
	return file_codeinfra_codegen_hcl_proto_enumTypes[0].Descriptor()
}

func (DiagnosticSeverity) Type() protoreflect.EnumType {
	return &file_codeinfra_codegen_hcl_proto_enumTypes[0]
}
...
func (DiagnosticSeverity) EnumDescriptor() ([]byte, []int) {
	return file_codeinfra_codegen_hcl_proto_rawDescGZIP(), []int{0}
}
...
func (x *Pos) Reset() {
	*x = Pos{}
	if protoimpl.UnsafeEnabled {
		mi := &file_codeinfra_codegen_hcl_proto_msgTypes[0]
...
func (x *Range) Reset() {
	*x = Range{}
	if protoimpl.UnsafeEnabled {
		mi := &file_codeinfra_codegen_hcl_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Range) Descriptor() ([]byte, []int) {
	return file_codeinfra_codegen_hcl_proto_rawDescGZIP(), []int{1}
}
...
func (x *Diagnostic) Reset() {
	*x = Diagnostic{}
	if protoimpl.UnsafeEnabled {
		mi := &file_codeinfra_codegen_hcl_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Diagnostic) Descriptor() ([]byte, []int) {
	return file_codeinfra_codegen_hcl_proto_rawDescGZIP(), []int{2}
}
...
var file_codeinfra_codegen_hcl_proto_rawDesc = []byte{
...
var (
	file_codeinfra_codegen_hcl_proto_rawDescOnce sync.Once
	file_codeinfra_codegen_hcl_proto_rawDescData = file_codeinfra_codegen_hcl_proto_rawDesc
)

func file_codeinfra_codegen_hcl_proto_rawDescGZIP() []byte {
	file_codeinfra_codegen_hcl_proto_rawDescOnce.Do(func() {
		file_codeinfra_codegen_hcl_proto_rawDescData = protoimpl.X.CompressGZIP(file_codeinfra_codegen_hcl_proto_rawDescData)
	})
	return file_codeinfra_codegen_hcl_proto_rawDescData
}

var file_codeinfra_codegen_hcl_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_codeinfra_codegen_hcl_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_codeinfra_codegen_hcl_proto_goTypes = []interface{}{
	(DiagnosticSeverity)(0), // 0: codeinfrarpc.codegen.DiagnosticSeverity
	(*Pos)(nil),             // 1: codeinfrarpc.codegen.Pos
	(*Range)(nil),           // 2: codeinfrarpc.codegen.Range
	(*Diagnostic)(nil),      // 3: codeinfrarpc.codegen.Diagnostic
}
var file_codeinfra_codegen_hcl_proto_depIdxs = []int32{
	1, // 0: codeinfrarpc.codegen.Range.start:type_name -> codeinfrarpc.codegen.Pos
	1, // 1: codeinfrarpc.codegen.Range.end:type_name -> codeinfrarpc.codegen.Pos
	0, // 2: codeinfrarpc.codegen.Diagnostic.severity:type_name -> codeinfrarpc.codegen.DiagnosticSeverity
	2, // 3: codeinfrarpc.codegen.Diagnostic.subject:type_name -> codeinfrarpc.codegen.Range
	2, // 4: codeinfrarpc.codegen.Diagnostic.context:type_name -> codeinfrarpc.codegen.Range
...
func init() { file_codeinfra_codegen_hcl_proto_init() }
func file_codeinfra_codegen_hcl_proto_init() {
	if File_codeinfra_codegen_hcl_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_codeinfra_codegen_hcl_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pos); i {
			case 0:
				return &v.state
			case 1:
		...
		file_codeinfra_codegen_hcl_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Range); i {
			case 0:
				return &v.state
			case 1:
		...
		file_codeinfra_codegen_hcl_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_codeinfra_codegen_hcl_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_codeinfra_codegen_hcl_proto_goTypes,
		DependencyIndexes: file_codeinfra_codegen_hcl_proto_depIdxs,
		EnumInfos:         file_codeinfra_codegen_hcl_proto_enumTypes,
		MessageInfos:      file_codeinfra_codegen_hcl_proto_msgTypes,
	}.Build()
	File_codeinfra_codegen_hcl_proto = out.File
	file_codeinfra_codegen_hcl_proto_rawDesc = nil
	file_codeinfra_codegen_hcl_proto_goTypes = nil
	file_codeinfra_codegen_hcl_proto_depIdxs = nil
}
