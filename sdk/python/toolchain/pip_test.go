...
func TestRunningPipInVirtualEnvironment(t *testing.T) {
	...
	assert.NoError(t, os.WriteFile(requirementsFile, []byte("codeinfra==2.0.0\n"), 0o600))
...
func TestCommandCodeinfraPythonCommand(t *testing.T) {
	t.Setenv("CODEINFRA_PYTHON_CMD", "python-not-found")
