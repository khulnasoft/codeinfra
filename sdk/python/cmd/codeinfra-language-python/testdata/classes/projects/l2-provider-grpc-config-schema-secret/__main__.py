import codeinfra
import codeinfra_config_grpc as config_grpc
...
config_grpc_provider = config_grpc.Provider("config_grpc_provider",
    ...
    obj_secret_string1=config_grpc.TsecretString1Args(
        secret_x="SECRET",
    ))
config = config_grpc.ConfigFetcher("config", opts = codeinfra.ResourceOptions(provider=config_grpc_provider))
