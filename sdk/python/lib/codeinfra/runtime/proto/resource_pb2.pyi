...
import codeinfra.alias_pb2
import codeinfra.callback_pb2
import codeinfra.source_pb2
import sys
import typing
...
class ReadResourceRequest(google.protobuf.message.Message):
    ...
    properties that exist on Codeinfra resources as projected into the target language. It is important to call out that the
    ...
    @property
    def sourcePosition(self) -> codeinfra.source_pb2.SourcePosition:
    ...
    def __init__(
        ...
        *,
        ...
        sourcePosition: codeinfra.source_pb2.SourcePosition | None = ...,
        packageRef: builtins.str = ...,
    ) -> None: ...
...
class RegisterResourceRequest(google.protobuf.message.Message):
    ...
    @property
    def aliases(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[codeinfra.alias_pb2.Alias]:
    ...
    @property
    def transforms(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[codeinfra.callback_pb2.Callback]:
    ...
    def __init__(
        ...
        *,
        ...
        pluginChecksums: collections.abc.Mapping[builtins.str, builtins.bytes] | None = ...,
        retainOnDelete: builtins.bool = ...,
        aliases: collections.abc.Iterable[codeinfra.alias_pb2.Alias] | None = ...,
        deletedWith: builtins.str = ...,
        aliasSpecs: builtins.bool = ...,
        sourcePosition: codeinfra.source_pb2.SourcePosition | None = ...,
        transforms: collections.abc.Iterable[codeinfra.callback_pb2.Callback] | None = ...,
        supportsResultReporting: builtins.bool = ...,
        packageRef: builtins.str = ...,
    ) -> None: ...
