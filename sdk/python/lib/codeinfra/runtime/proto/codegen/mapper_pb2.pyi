...
class GetMappingRequest(google.protobuf.message.Message):
    ...
    CODEINFRA_PROVIDER_FIELD_NUMBER: builtins.int
    provider: builtins.str
    """the provider name for the mapping being requested."""
    codeinfra_provider: builtins.str
    ...
    def ClearField(self, field_name: typing_extensions.Literal["provider", b"provider", "codeinfra_provider", b"codeinfra_provider"]) -> None: ...
