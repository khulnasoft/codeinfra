...
import abc
import grpc
import codeinfra.testing.language_pb2
...
class LanguageTestStub:
    ...
    GetLanguageTests: grpc.UnaryUnaryMultiCallable[
        codeinfra.testing.language_pb2.GetLanguageTestsRequest,
        codeinfra.testing.language_pb2.GetLanguageTestsResponse,
    ]
    """GetLanguageTests returns a list of all the language tests."""
    PrepareLanguageTests: grpc.UnaryUnaryMultiCallable[
        codeinfra.testing.language_pb2.PrepareLanguageTestsRequest,
        codeinfra.testing.language_pb2.PrepareLanguageTestsResponse,
    ]
    ...
    RunLanguageTest: grpc.UnaryUnaryMultiCallable[
        codeinfra.testing.language_pb2.RunLanguageTestRequest,
        codeinfra.testing.language_pb2.RunLanguageTestResponse,
    ]
...
class LanguageTestServicer(metaclass=abc.ABCMeta):
    ...
    def GetLanguageTests(
        self,
        request: codeinfra.testing.language_pb2.GetLanguageTestsRequest,
    ...
    def PrepareLanguageTests(
        self,
        request: codeinfra.testing.language_pb2.PrepareLanguageTestsRequest,
        context: grpc.ServicerContext,
    ) -> codeinfra.testing.language_pb2.PrepareLanguageTestsResponse:
        """PrepareLanguageTests prepares the engine to run language tests. It sets up a stable artifacts folder
        (which should be .gitignore'd) and fills it with the core SDK artifact.
    ...
    def RunLanguageTest(
        self,
        request: codeinfra.testing.language_pb2.RunLanguageTestRequest,
        context: grpc.ServicerContext,
    ) -> codeinfra.testing.language_pb2.RunLanguageTestResponse:
        """RunLanguageTest runs a single test of the language plugin."""
