...
Because the Codeinfra top-level module depends on the `codeinfra.runtime` submodule,
it is not allowed for `codeinfra.runtime` to reach back to the `codeinfra` top-level
