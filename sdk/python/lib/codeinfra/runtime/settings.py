...
class Settings:
    """
    A bag of properties for configuring the Codeinfra Python language runtime.
    """
    ...
    def __init__(
        ...
        if self.legacy_apply_enabled is None:
            self.legacy_apply_enabled = (
                os.getenv("CODEINFRA_ENABLE_LEGACY_APPLY", "false") == "true"
            )
...
def is_dry_run() -> bool:
    ...
    When writing unit tests, you can set this flag via `codeinfra.runtime.set_mocks` by supplying a value
