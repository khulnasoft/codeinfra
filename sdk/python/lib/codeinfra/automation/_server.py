...
from ._workspace import CodeinfraFn


class LanguageServer(LanguageRuntimeServicer):
    program: CodeinfraFn

    def __init__(self, program: CodeinfraFn) -> None:
    ...
    def Run(self, request, context):
        ...
        def run():
            ...
            # The strategy here is derived from sdk/python/cmd/codeinfra-language-python-exec
...
def _suppress_unobserved_task_logging():
    ...
    Python Codeinfra user programs. See rationale in
    `sdk/python/cmd/codeinfra-language-python-exec`.
