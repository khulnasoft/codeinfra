...
"""
The automation module contains the Codeinfra Automation API, the programmatic interface for driving Codeinfra programs
without the CLI.
...
2. Programs defined as a function alongside your Automation API code (inline source)::
    ...
    def codeinfra_program():
        ...
        codeinfra.export("bucket_name", bucket.Bucket)

    stack = create_stack("myOrg/myProj/myStack", program=codeinfra_program)
    ```
...
Workspaces can be explicitly created and customized beyond the three Stack creation helpers noted above::
    ...
    ws = LocalWorkspace(work_dir=os.path.join(".", "project", "path"), codeinfra_home="~/.codeinfra")
...
from codeinfra.automation._remote_workspace import (
...
from codeinfra.automation._remote_stack import RemoteStack
