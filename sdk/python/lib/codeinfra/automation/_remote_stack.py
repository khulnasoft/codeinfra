...
from codeinfra.automation._cmd import OnOutput
from codeinfra.automation._output import OutputMap
from codeinfra.automation._stack import (
    DestroyResult,
    OnEvent,
    PreviewResult,
    RefreshResult,
...
from codeinfra.automation._workspace import Deployment


class RemoteStack:
    """
    RemoteStack is an isolated, independencly configurable instance of a Codeinfra program that is
