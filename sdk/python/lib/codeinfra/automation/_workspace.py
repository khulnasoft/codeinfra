...
from ._cmd import CodeinfraCommand
...
CodeinfraFn = Callable[[], Optional[Awaitable[None]]]
...
class WhoAmIResult:
    """The currently logged-in Codeinfra identity."""
...
class Workspace(ABC):
    ...
    work_dir: str
    """
    The working directory to run Codeinfra CLI commands
    """

    codeinfra_home: Optional[str]
    """
    ...
    program: Optional[CodeinfraFn]
    """
    The inline program `CodeinfraFn` to be used for Preview/Update operations if any.
    ...
    codeinfra_version: str
    """
    The version of the underlying Codeinfra CLI/Engine.
    """

    codeinfra_command: CodeinfraCommand
    """
    The underlying CodeinfraCommand instance that is used to execute CLI commands.
    """
