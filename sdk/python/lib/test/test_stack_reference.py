...
import codeinfra
from codeinfra.runtime import mocks
from codeinfra import StackReference, StackReferenceOutputDetails
...
class StackReferenceOutputMock(codeinfra.runtime.Mocks):
    def new_resource(self, args: codeinfra.runtime.MockResourceArgs):
        assert "codeinfra:codeinfra:StackReference" == args.typ
        return [
            args.name + "_id",
            {
                "outputs": {
                    "bucket": "mybucket-1234",
                    "password": codeinfra.Output.secret("mypassword"),
                },
            },
        ]
