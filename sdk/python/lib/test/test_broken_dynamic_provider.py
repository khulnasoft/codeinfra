...
https://github.com/khulnasoft/codeinfra/issues/6981
...
from codeinfra import Input, Output
from codeinfra.runtime import settings, mocks
import codeinfra
import codeinfra.dynamic as dyn
...
def test_codeinfra_broken_dynamic_provider(my_mocks):
