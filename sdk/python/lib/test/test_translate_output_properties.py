...
from codeinfra.runtime import rpc
import codeinfra
...
class Foo(dict):
    ...
    second_arg: float = codeinfra.property("secondArg")
...
@codeinfra.output_type
class Bar(dict):
    third_arg: Foo = codeinfra.property("thirdArg")
    third_optional_arg: Optional[Foo] = codeinfra.property("thirdOptionalArg")

    fourth_arg: Dict[str, Foo] = codeinfra.property("fourthArg")
    fourth_optional_arg: Dict[str, Optional[Foo]] = codeinfra.property("fourthOptionalArg")

    fifth_arg: List[Foo] = codeinfra.property("fifthArg")
    fifth_optional_arg: List[Optional[Foo]] = codeinfra.property("fifthOptionalArg")

    sixth_arg: Dict[str, List[Foo]] = codeinfra.property("sixthArg")
    sixth_optional_arg: Dict[str, Optional[List[Foo]]] = codeinfra.property(
        "sixthOptionalArg"
    )
    sixth_optional_optional_arg: Dict[str, Optional[List[Optional[Foo]]]] = (
        codeinfra.property("sixthOptionalOptionalArg")
    )

    seventh_arg: List[Dict[str, Foo]] = codeinfra.property("seventhArg")
    seventh_optional_arg: List[Optional[Dict[str, Foo]]] = codeinfra.property(
        "seventhOptionalArg"
    )
    seventh_optional_optional_arg: List[Optional[Dict[str, Optional[Foo]]]] = (
        codeinfra.property("seventhOptionalOptionalArg")
    )

    eighth_arg: List[Dict[str, List[Foo]]] = codeinfra.property("eighthArg")
    eighth_optional_arg: List[Optional[Dict[str, List[Foo]]]] = codeinfra.property(
        "eighthOptionalArg"
    )
    eighth_optional_optional_arg: List[Optional[Dict[str, Optional[List[Foo]]]]] = (
        codeinfra.property("eighthOptionalOptionalArg")
    )
    eighth_optional_optional_optional_arg: List[
        Optional[Dict[str, Optional[List[Optional[Foo]]]]]
    ] = codeinfra.property("eighthOptionalOptionalOptionalArg")
...
class BarMappingSequence(dict):
    ...
    fourth_arg: Mapping[str, Foo] = codeinfra.property("fourthArg")
    fourth_optional_arg: Mapping[str, Optional[Foo]] = codeinfra.property(
        "fourthOptionalArg"
    )

    fifth_arg: Sequence[Foo] = codeinfra.property("fifthArg")
    fifth_optional_arg: Sequence[Optional[Foo]] = codeinfra.property("fifthOptionalArg")

    sixth_arg: Mapping[str, Sequence[Foo]] = codeinfra.property("sixthArg")
    sixth_optional_arg: Mapping[str, Optional[Sequence[Foo]]] = codeinfra.property(
        "sixthOptionalArg"
    )
    ...
    seventh_arg: Sequence[Mapping[str, Foo]] = codeinfra.property("seventhArg")
    seventh_optional_arg: Sequence[Optional[Mapping[str, Foo]]] = codeinfra.property(
        "seventhOptionalArg"
    )
    ...
    eighth_arg: Sequence[Mapping[str, Sequence[Foo]]] = codeinfra.property("eighthArg")
    eighth_optional_arg: Sequence[Optional[Mapping[str, Sequence[Foo]]]] = (
        codeinfra.property("eighthOptionalArg")
    )
...
class BarDeclared(dict):
    def __init__(
        ...
        codeinfra.set(self, "third_arg", third_arg)
        codeinfra.set(self, "third_optional_arg", third_optional_arg)
        codeinfra.set(self, "fourth_arg", fourth_arg)
        codeinfra.set(self, "fourth_optional_arg", fourth_optional_arg)
        codeinfra.set(self, "fifth_arg", fifth_arg)
        codeinfra.set(self, "fifth_optional_arg", fifth_optional_arg)
        codeinfra.set(self, "sixth_arg", sixth_arg)
        codeinfra.set(self, "sixth_optional_arg", sixth_optional_arg)
        codeinfra.set(self, "sixth_optional_optional_arg", sixth_optional_optional_arg)
        codeinfra.set(self, "seventh_arg", seventh_arg)
        codeinfra.set(self, "seventh_optional_arg", seventh_optional_arg)
        codeinfra.set(self, "seventh_optional_optional_arg", seventh_optional_optional_arg)
        codeinfra.set(self, "eighth_arg", eighth_arg)
        codeinfra.set(self, "eighth_optional_arg", eighth_optional_arg)
        codeinfra.set(self, "eighth_optional_optional_arg", eighth_optional_optional_arg)
        codeinfra.set(
            self,
...
class InvalidTypeStr(dict):
    value: str = codeinfra.property("value")
...
class InvalidTypeOptionalStr(dict):
    value: Optional[str] = codeinfra.property("value")
...
class InvalidTypeDictStr(dict):
    value: Dict[str, str] = codeinfra.property("value")


@codeinfra.output_type
class InvalidTypeMappingStr(dict):
    value: Mapping[str, str] = codeinfra.property("value")
...
class InvalidTypeOptionalDictStr(dict):
    value: Optional[Dict[str, str]] = codeinfra.property("value")


@codeinfra.output_type
class InvalidTypeOptionalMappingStr(dict):
    value: Optional[Mapping[str, str]] = codeinfra.property("value")
...
class InvalidTypeDictOptionalStr(dict):
    value: Dict[str, Optional[str]] = codeinfra.property("value")


@codeinfra.output_type
class InvalidTypeMappingOptionalStr(dict):
    value: Mapping[str, Optional[str]] = codeinfra.property("value")
...
class InvalidTypeOptionalDictOptionalStr(dict):
    value: Optional[Dict[str, Optional[str]]] = codeinfra.property("value")


@codeinfra.output_type
class InvalidTypeOptionalMappingOptionalStr(dict):
    value: Optional[Mapping[str, Optional[str]]] = codeinfra.property("value")
...
class InvalidTypeListStr(dict):
    value: List[str] = codeinfra.property("value")


@codeinfra.output_type
class InvalidTypeSequenceStr(dict):
    value: Sequence[str] = codeinfra.property("value")
...
class InvalidTypeOptionalListStr(dict):
    value: Optional[List[str]] = codeinfra.property("value")


@codeinfra.output_type
class InvalidTypeOptionalSequenceStr(dict):
    value: Optional[Sequence[str]] = codeinfra.property("value")
...
class InvalidTypeListOptionalStr(dict):
    value: List[Optional[str]] = codeinfra.property("value")


@codeinfra.output_type
class InvalidTypeSequenceOptionalStr(dict):
    value: Sequence[Optional[str]] = codeinfra.property("value")
...
class InvalidTypeOptionalListOptionalStr(dict):
    value: Optional[List[Optional[str]]] = codeinfra.property("value")


@codeinfra.output_type
class InvalidTypeOptionalSequenceOptionalStr(dict):
    value: Optional[Sequence[Optional[str]]] = codeinfra.property("value")
...
class TranslateOutputPropertiesTests(unittest.TestCase):
    ...
    def test_individual_values(self):
        ...
        class MyOutput:
            first_arg: str = codeinfra.property("firstArg")
            second_arg: int = codeinfra.property("secondArg")
