...
import codeinfra
from codeinfra.runtime import to_json
...
class ToJSONTests(unittest.TestCase):
    ...
    def test_to_json_basic_input_type(self):
        ...
        class ProviderAssumeRoleArgs:
            role_arn: Optional[codeinfra.Input[str]] = codeinfra.property("roleArn")
            tags: Optional[codeinfra.Input[Mapping[str, codeinfra.Input[str]]]]
    ...
    def test_to_json_nested_input_type(self):
        ...
        class ProviderFeaturesNetworkArgs:
            relaxed_locking: Optional[codeinfra.Input[bool]] = codeinfra.property(
                "relaxedLocking"
            )

        @codeinfra.input_type
        class ProviderFeaturesArgs:
            network: Optional[codeinfra.Input[ProviderFeaturesNetworkArgs]]
