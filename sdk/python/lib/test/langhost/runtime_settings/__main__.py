...
config = codeinfra.Config("test")
assert codeinfra.get_organization() == "myorg"
assert codeinfra.get_project() == "myproject"
assert codeinfra.get_stack() == "mystack"
...
except codeinfra.ConfigTypeError as exn:
