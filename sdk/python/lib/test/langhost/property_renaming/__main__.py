...
import codeinfra
from codeinfra import CustomResource, Output, Input
...
codeinfra.export("transformed_prop", res.transformed_prop)
codeinfra.export("engine_output_prop", res.engine_output_prop)
codeinfra.export("recursive_prop", res.recursive_prop)
