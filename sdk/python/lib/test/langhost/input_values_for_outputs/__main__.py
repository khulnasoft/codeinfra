...
class Instance(codeinfra.CustomResource):
    ...
    def __init__(
        self,
        resource_name,
        name: codeinfra.Input[str] = None,
        value: codeinfra.Input[str] = None,
        opts=None,
    ):
        if opts is None:
...
class DefaultLogGroupArgs:
    def __init__(self, *, skip: Optional[bool] = None):
        if skip is not None:
            codeinfra.set(self, "skip", skip)

    @property
    @codeinfra.getter
    def skip(self) -> Optional[bool]:
        return codeinfra.get(self, "skip")

    @skip.setter
    def skip(self, value: Optional[bool]):
        codeinfra.set(self, "skip", value)
...
class FargateTaskDefinitionArgs:
    def __init__(self, *, log_group: Optional[DefaultLogGroupArgs] = None):
        if log_group is not None:
            codeinfra.set(self, "log_group", log_group)

    @property
    @codeinfra.getter(name="logGroup")
    def log_group(self) -> Optional[DefaultLogGroupArgs]:
        return codeinfra.get(self, "log_group")

    @log_group.setter
    def log_group(self, value: Optional[DefaultLogGroupArgs]):
        codeinfra.set(self, "log_group", value)
...
class FargateTaskDefinition(codeinfra.ComponentResource):
    def __init__(
        self,
        resource_name: str,
        log_group: Optional[codeinfra.InputType[DefaultLogGroupArgs]] = None,
    ):
    ...
    @property
    @codeinfra.getter(name="logGroup")
    def log_group(self) -> codeinfra.Output[Optional[Instance]]:
        return codeinfra.get(self, "log_group")
