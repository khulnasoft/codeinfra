...
class Additional(dict):
    ...
    second_value: Optional[float] = codeinfra.property("secondValue")


class AdditionalResource(codeinfra.CustomResource):
...
class ExtraResource(codeinfra.CustomResource):
    extra: codeinfra.Output[Extra]

    def __init__(self, name: str, extra: codeinfra.InputType[ExtraArgs]):
...
class SupplementaryArgs:
    def __init__(
        ...
        first_value: codeinfra.Input[str],
        second_value: Optional[codeinfra.Input[float]] = None,
        third: Optional[codeinfra.Input[str]] = None,
        fourth: Optional[codeinfra.Input[str]] = None,
    ):
        codeinfra.set(self, "first_value", first_value)
        codeinfra.set(self, "second_value", second_value)
        codeinfra.set(self, "third", third)
        codeinfra.set(self, "fourth", fourth)
    ...
    def first_value(self, value: codeinfra.Input[str]):
        codeinfra.set(self, "first_value", value)
    ...
    @property
    @codeinfra.getter
    def third(self) -> Optional[codeinfra.Input[str]]: ...  # type: ignore

    @third.setter
    def third(self, value: Optional[codeinfra.Input[str]]): ...  # type: ignore
    ...
    @property
    @codeinfra.getter()
    def fourth(self) -> Optional[codeinfra.Input[str]]: ...

    @fourth.setter
    def fourth(self, value: Optional[codeinfra.Input[str]]): ...
...
class SupplementaryResource(codeinfra.CustomResource):
    supplementary: codeinfra.Output[Supplementary]

    def __init__(self, name: str, supplementary: codeinfra.InputType[SupplementaryArgs]):
        super().__init__(
...
class AncillaryArgs:
    ...
    @property
    @codeinfra.getter()
    def fourth(self) -> Optional[codeinfra.Input[str]]: ...  # type: ignore

    @fourth.setter
    def fourth(self, value: Optional[codeinfra.Input[str]]): ...  # type: ignore
...
class AncillaryResource(codeinfra.CustomResource):
    ancillary: codeinfra.Output[Ancillary]

    def __init__(self, name: str, ancillary: codeinfra.InputType[AncillaryArgs]):
