...
def test_invoke_failures(my_resources):
    ...
    try:
        codeinfra.runtime.invoke("test:index:FailFunction", props={})
...
def test_invoke_throws(my_resources):
    ...
    try:
        codeinfra.runtime.invoke("test:index:ThrowFunction", props={})
    except Exception as e:
        caught = str(e)
...
class MyMocks(codeinfra.runtime.Mocks):
    ...
    def new_resource(self, args: codeinfra.runtime.MockResourceArgs):
        ...
        elif args.typ == 'codeinfra:codeinfra:StackReference' and 'dns' in args.name:
...
class ImmediateExecutor(ThreadPoolExecutor):
    ...
    postponed - see https://github.com/khulnasoft/codeinfra/issues/7663
