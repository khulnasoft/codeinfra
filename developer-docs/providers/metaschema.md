...
# Codeinfra Package Metaschema

A description of the schema for a Codeinfra Package
...
types are referenced as "codeinfra.json#/Archive", "codeinfra.json#/Asset", and "codeinfra.json#/Any", respectively.
A type from this document is referenced as "#/types/codeinfra:type:token".
A type from another document is referenced as "path#/types/codeinfra:type:token", where path is of the form:
  "/provider/vX.Y.Z/schema.json" or "codeinfra.json" or "http[s]://example.com/provider/vX.Y.Z/schema.json"
A resource from this document is referenced as "#/resources/codeinfra:type:token".
A resource from another document is referenced as "path#/resources/codeinfra:type:token", where path is of the form:
  "/provider/vX.Y.Z/schema.json" or "codeinfra.json" or "http[s]://example.com/provider/vX.Y.Z/schema.json"
