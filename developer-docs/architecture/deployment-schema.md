...
## Codeinfra Deployment States

A schema for Codeinfra deployment states.
...
The version of the Codeinfra engine that produced the deployment.
...
[Resource V3](https://github.com/khulnasoft/codeinfra/blob/master/sdk/go/common/apitype/resources.json#/$defs/resourceV3)
...
Items: [Resource V3](https://github.com/khulnasoft/codeinfra/blob/master/sdk/go/common/apitype/resources.json#/$defs/resourceV3)
...
## Codeinfra Property Value

A schema for Codeinfra Property values.
...
Items: [Codeinfra Property Value](#codeinfra-property-value)
...
Additional properties: [`https://github.com/khulnasoft/codeinfra/blob/master/sdk/go/common/apitype/property-values.json#/oneOf/5/oneOf/1/properties/assets/additionalProperties`](#httpsgithubcomcodeinfracodeinfrablobmastersdkgocommonapitypeproperty-valuesjsononeof5oneof1propertiesassetsadditionalproperties)
...
Additional properties: [Codeinfra Property Value](#codeinfra-property-value)
...
### `https://github.com/khulnasoft/codeinfra/blob/master/sdk/go/common/apitype/property-values.json#/oneOf/5/oneOf/1/properties/assets/additionalProperties`

One of:

## Codeinfra Resource State

Schemas for Codeinfra resource states.

One of:

### Resource V3

Version 3 of a Codeinfra resource state.
...
True when the lifecycle of this resource is not managed by Codeinfra.
...
Additional properties: [Codeinfra Property Value](https://github.com/khulnasoft/codeinfra/blob/master/sdk/go/common/apitype/property-values.json#)
...
Additional properties: [`https://github.com/khulnasoft/codeinfra/blob/master/sdk/go/common/apitype/resources.json#/$defs/resourceV3/properties/propertyDependencies/additionalProperties`](#httpsgithubcomcodeinfracodeinfrablobmastersdkgocommonapityperesourcesjsondefsresourcev3propertiespropertydependenciesadditionalproperties)
...
The unique name for a resource in a Codeinfra stack.

`string`

### `https://github.com/khulnasoft/codeinfra/blob/master/sdk/go/common/apitype/resources.json#/$defs/resourceV3/properties/propertyDependencies/additionalProperties`
