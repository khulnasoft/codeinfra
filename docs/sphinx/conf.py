...
project = "Codeinfra"
copyright = "Codeinfra 2024"
author = "Codeinfra engineering"
...
# the top-level directory. Our top-level README is designed to introduce Codeinfra
...
myst_url_schemes = {
    "http": None,
    "https": None,
    # Usage: <gh-file:repository-under-codeinfra-org#path/to/file>
    "gh-file": {
        "url": "https://github.com/codeinfra/{{path}}/blob/master/{{fragment}}",
        "title": "codeinfra/{{path}}:{{fragment}}",
        "classes": ["github"],
    },
    # Usage: <gh-file:repository-under-codeinfra-org#issue-or-pr-number>
    "gh-issue": {
        "url": "https://github.com/codeinfra/{{path}}/issues/{{fragment}}",
        "title": "codeinfra/{{path}} #{{fragment}}",
        "classes": ["github"],
    },
}
...
# Codeinfra projects that are all hosted under the root Codeinfra site.
intersphinx_mapping = {
    # Terrafom Bridge developer documentation
    # https://github.com/khulnasoft/codeinfra-terraform-bridge
    "tfbridge": ("https://codeinfra-developer-docs.readthedocs.io/projects/codeinfra-terraform-bridge/en/latest/", None),
}
...
html_title = "Codeinfra developer documentation"
html_logo = "https://www.codeinfra.com/images/logo/logo-on-white-box.svg"
...
html_theme_options = {
    ...
    "repository_url": "https://github.com/khulnasoft/codeinfra",
