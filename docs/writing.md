...
[docs](https://github.com/khulnasoft/codeinfra/tree/master/docs) folder of the
[codeinfra](https://github.com/khulnasoft/codeinfra) GitHub repository. Codeinfra welcomes contributions to the developer
...
* <gh-issue:codeinfra#1234> will link to issue 1234 in the `codeinfra` repository.
* <gh-file:codeinfra#README.md> will link to the `README.md` file in the `codeinfra`
  repository.
````
