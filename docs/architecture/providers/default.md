...
Codeinfra will use to manage resources that do not have a provider explicitly
...
The `Bucket` constructor will yield a [](codeinfrarpc.RegisterResourceRequest) such
as the following:
...
[](codeinfrarpc.ResourceMonitor) implementation ensures that only a single default
...
RegisterResourceRequest{
  ...
  custom: true,
  object: {},
  provider: "urn:codeinfra:dev::project::codeinfra:providers:aws::us-west-2::308b79ee-8249-40fb-a203-de190cb8faa8",
  version: "4.16.0",
}
```
