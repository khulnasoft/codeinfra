...
def main():
    ...
    config = Config(
        ...
        proto_path="../proto",
        proto_files={
            "Aliasing": "codeinfra/alias.proto",
            "Analysis": "codeinfra/analyzer.proto",
            "Callbacks": "codeinfra/callback.proto",
            "Engine services": "codeinfra/engine.proto",
            "Errors": "codeinfra/errors.proto",
            "Language hosts": "codeinfra/language.proto",
            "Plugins": "codeinfra/plugin.proto",
            "Program conversion": "codeinfra/converter.proto",
            "Providers": "codeinfra/provider.proto",
            "Resource registration": "codeinfra/resource.proto",
            "Schema loading": "codeinfra/codegen/loader.proto",
            "Source positions": "codeinfra/source.proto",
        },
