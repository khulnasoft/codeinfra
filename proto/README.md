...
various types, messages and interfaces that Codeinfra components use to
...
The <gh-file:codeinfra#proto/generate.sh> script in this directory (called by the
`build_proto` target in the top-level <gh-file:codeinfra#Makefile>) generates types
...
<gh-file:codeinfra#sdk/nodejs/proto>).
...
<gh-file:codeinfra#docs/Makefile> in the `docs` directory and uses the
<gh-file:codeinfra#docs/references/proto.md.tmpl> template. Generated documentation ends
