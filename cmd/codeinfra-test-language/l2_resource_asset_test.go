...
func (h *L2ResourceAssetArchiveLanguageHost) Run(
	...
	_, err = monitor.RegisterResource(ctx, &codeinfrarpc.RegisterResourceRequest{
	...
	remoteass, err := resource.NewURIAsset(
		"https://raw.githubusercontent.com/khulnasoft/codeinfra/master" +
			"/cmd/codeinfra-test-language/testdata/l2-resource-asset-archive/test.txt",
	)
	if err != nil {
