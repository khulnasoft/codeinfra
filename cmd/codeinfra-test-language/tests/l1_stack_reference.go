		...
		Runs: []TestRun{
			{
				Assert: func(l *L,
					...
					require.Equal(l, "codeinfra:providers:codeinfra", prov.Type.String(), "expected a default codeinfra provider resource")
					ref := snap.Resources[2]
					require.Equal(l, "codeinfra:codeinfra:StackReference", ref.Type.String(), "expected a stack reference resource")
