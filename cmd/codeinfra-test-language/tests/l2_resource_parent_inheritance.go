...
import (
	...
	deployProviders "github.com/khulnasoft/codeinfra/pkg/v3/resource/deploy/providers"
		...
		Runs: []TestRun{
			{
				Assert: func(l *L,
					...
					require.Equal(l, "codeinfra:providers:simple", defaultProvider.Type.String(), "expected default simple provider")
					...
					require.Equal(l, "codeinfra:providers:simple", explicitProvider.Type.String(), "expected explicit simple provider")
