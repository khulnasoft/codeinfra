...
resource "config_grpc_provider" "codeinfra:providers:config-grpc" {
    ...
    # TODO[codeinfra/codeinfra#17535] this currently breaks Go compilation unfortunately.
    ...
    # TODO[codeinfra/codeinfra#17535] this breaks Go compilation as well.
