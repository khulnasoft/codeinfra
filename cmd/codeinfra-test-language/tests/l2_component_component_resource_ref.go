		...
		Runs: []TestRun{
			{
				Assert: func(l *L,
					...
					// 0. The stack
					//
					// 1. The builtin Codeinfra provider (used for hydrating resource references)
					...
					require.Equal(
						l, "codeinfra:providers:codeinfra", builtinProvider.Type.String(),
						"expected builtin provider",
					)

					defaultProvider := RequireSingleNamedResource(l, snap.Resources, "default_13_3_7")
					require.Equal(
						l, "codeinfra:providers:component", defaultProvider.Type.String(),
