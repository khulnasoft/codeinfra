		...
		Runs: []TestRun{
			{
				...
				Assert: func(l *L,
					...
					require.Equal(l, "codeinfra:providers:config", explicitProvider.Type.String(), "expected explicit provider resource")
					...
					require.Equal(l, "codeinfra:providers:config", defaultProvider.Type.String(), "expected default provider resource")
