		...
		Runs: []TestRun{
			{
				Assert: func(l *L,
					...
					assert.Equal(l, "codeinfra:providers:secret", provider.Type.String(), "expected secret provider")
					...
					want := resource.NewPropertyMapFromMap(map[string]any{
						...
						"publicData": map[string]interface{}{
							"public": "open",
							// TODO https://github.com/khulnasoft/codeinfra/issues/10319: This should be a secret,
