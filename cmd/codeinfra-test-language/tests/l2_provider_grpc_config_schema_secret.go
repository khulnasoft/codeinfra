		...
		Runs: []TestRun{
			{
				Assert: func(l *L,
					...
					// TODO[codeinfra/codeinfra#16876]: CheckConfig request gets the secrets in the plain.
					...
					// TODO[codeinfra/codeinfra#17652] Languages do not agree on the object property
