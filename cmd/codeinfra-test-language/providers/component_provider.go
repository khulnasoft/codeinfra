...
func (p *ComponentProvider) constructComponentCustomRefOutput(
	...
	parent, err := monitor.RegisterResource(ctx, &codeinfrarpc.RegisterResourceRequest{
	...
	child, err := monitor.RegisterResource(ctx, &codeinfrarpc.RegisterResourceRequest{
...
func (p *ComponentProvider) constructComponentCustomRefInputOutput(
	...
	getRes, err := monitor.Invoke(ctx, &codeinfrarpc.ResourceInvokeRequest{
