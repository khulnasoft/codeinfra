module github.com/khulnasoft/codeinfra/cmd/codeinfra-test-language

go 1.21

replace github.com/khulnasoft/codeinfra/sdk/v3 => ../../sdk

replace github.com/khulnasoft/codeinfra/pkg/v3 => ../../pkg
