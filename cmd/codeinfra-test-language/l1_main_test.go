...
func (h *L1MainLanguageHost) Pack(ctx context.Context, req *codeinfrarpc.PackRequest) (*codeinfrarpc.PackResponse, error) {
...
func (h *L1MainLanguageHost) Run(ctx context.Context, req *codeinfrarpc.RunRequest) (*codeinfrarpc.RunResponse, error) {
	if req.Info.RootDirectory != filepath.Join(h.tempDir, "projects", "l1-main") {
	...
	resp, err := monitor.RegisterResource(ctx, &codeinfrarpc.RegisterResourceRequest{
