...
import (
	...
	pschema "github.com/khulnasoft/codeinfra/pkg/v3/codegen/schema"
	...
	rpc "github.com/khulnasoft/codeinfra/sdk/v3/proto/go"
...
func (p *testproviderProvider) Construct(ctx context.Context, req *rpc.ConstructRequest) (*rpc.ConstructResponse, error) {
	...
	return codeinfraprovider.Construct(
		ctx, req, p.host.EngineConn(),
		func(ctx *codeinfra.Context, typ, name string, inputs codeinfraprovider.ConstructInputs,
