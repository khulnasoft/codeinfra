...
from codeinfra import Input, Inputs, ComponentResource, ResourceOptions
import codeinfra
import codeinfra.runtime.config as config
...
class Component(ComponentResource):
    def __init__(self, name: str, echo: Input[Any], secret: Input[str], opts: Optional[ResourceOptions]=None):
        ...
        self.echo = codeinfra.Output.from_input(echo)
