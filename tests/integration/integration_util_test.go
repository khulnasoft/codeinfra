...
func testComponentProviderSchema(t *testing.T, path string) {
	...
	for _, test := range tests {
		...
		t.Run(test.name, func(t *testing.T) {
			...
			resp, err := client.GetSchema(context.Background(), &codeinfrarpc.GetSchemaRequest{Version: test.version})
...
func testConstructComponentConfigureProviderCommonOptions() integration.ProgramTestOptions {
	...
	return integration.ProgramTestOptions{
		...
		AllowEmptyPreviewChanges: true,  // Codeinfra will warn that provider has unknowns in its config
		ExtraRuntimeValidation: func(t *testing.T, stackInfo integration.RuntimeValidationStackInfo) {
