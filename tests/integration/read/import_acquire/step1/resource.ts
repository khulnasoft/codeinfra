...
export class Provider implements dynamic.ResourceProvider {
    ...
    public async read(id: codeinfra.ID, props: any): Promise<dynamic.ReadResult> {
        return {
            id: id,
            props: props,
        }
...
export class Resource extends codeinfra.dynamic.Resource {
    public readonly state: codeinfra.Output<any>;

    constructor(name: string, props: any, opts?: codeinfra.CustomResourceOptions) {
