...
class FailsOnDelete(codeinfra.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FailsOnDeleteArgs, codeinfra.ResourceOptions, *args, **kwargs)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[codeinfra.ResourceOptions] = None) -> 'FailsOnDelete':
        """
