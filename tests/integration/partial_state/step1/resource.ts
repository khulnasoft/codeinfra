...
export class Provider implements dynamic.ResourceProvider {
    ...
    public async update(id: codeinfra.ID, olds: any, news: any): Promise<dynamic.UpdateResult> {
        if (news.state === 4) {
            return Promise.reject({
...
export class Resource extends dynamic.Resource {
    public readonly state: codeinfra.Output<number>;

    constructor(name: string, num: codeinfra.Input<number>, opts?: codeinfra.ResourceOptions) {
