...
class Component extends codeinfra.ComponentResource {
    ...
    constructor(name: string, opts?: codeinfra.ComponentResourceOptions) {
        ...
        this.resource = new Resource(`${name}-child`, {
            ...
            aliases: [codeinfra.createUrn("res2", "my:module:Resource")],
        });
    }
}
...
class Component2 extends codeinfra.ComponentResource {
    constructor(name: string, opts?: codeinfra.ComponentResourceOptions) {
...
class Component3 extends codeinfra.ComponentResource {
    constructor(name: string, opts: codeinfra.ComponentResourceOptions = {}) {
...
class Component4 extends codeinfra.ComponentResource {
    constructor(name: string, opts: codeinfra.ComponentResourceOptions = {}) {
        super("my:module:Component4", name, {}, {
            aliases: [
                { parent: codeinfra.rootStackResource },
                { parent: codeinfra.rootStackResource },
            ],
            ...opts,
        });
