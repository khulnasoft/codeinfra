...
from codeinfra import Resource, export
from codeinfra.resource import ProviderResource as Provider
from codeinfra.resource import ResourceOptions
...
provider_url = ResourceOptions(plugin_download_url="get.codeinfra.test/providers")
