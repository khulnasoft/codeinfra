from codeinfra import Input, Output, export
...
class Farm(str, Enum):
    ...
    CODEINFRA_PLANTERS_INC = "Codeinfra Planters Inc."
...
tree = Tree("myTree", type=RubberTreeVariety.BURGUNDY, farm=Farm.CODEINFRA_PLANTERS_INC)
