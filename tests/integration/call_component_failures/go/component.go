...
func (c *Component) GetMessage(ctx *codeinfra.Context) (codeinfra.Output, error) {
	return ctx.Call("testcomponent:index:Component/getMessage", nil, codeinfra.StringOutput{}, c)
}
