...
namespace Codeinfra.Xyz
{
    ...
    public partial class StaticPage : global::Codeinfra.ComponentResource
    {
        /// <summary>
        /// The bucket resource.
        /// </summary>
        [Output("bucket")]
        public Output<Codeinfra.Aws.S3.Bucket> Bucket { get; private set; } = null!;
    ...
    public sealed class StaticPageArgs : global::Codeinfra.ResourceArgs
    {
        [Input("foo")]
