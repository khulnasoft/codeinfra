...
namespace Codeinfra.Myedgeorder
{
    public static class ListConfigurations
    {
        ...
        public static Task<ListConfigurationsResult> InvokeAsync(ListConfigurationsArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.InvokeAsync<ListConfigurationsResult>("myedgeorder::listConfigurations", args ?? new ListConfigurationsArgs(), options.WithDefaults());
        ...
        public static Output<ListConfigurationsResult> Invoke(ListConfigurationsInvokeArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.Invoke<ListConfigurationsResult>("myedgeorder::listConfigurations", args ?? new ListConfigurationsInvokeArgs(), options.WithDefaults());
    ...
    public sealed class ListConfigurationsArgs : global::Codeinfra.InvokeArgs
    {
    ...
    public sealed class ListConfigurationsInvokeArgs : global::Codeinfra.InvokeArgs
    {
        [Input("configurationFilters", required: true)]
