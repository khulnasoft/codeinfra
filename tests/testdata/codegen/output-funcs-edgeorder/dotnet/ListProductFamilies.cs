...
namespace Codeinfra.Myedgeorder
{
    public static class ListProductFamilies
    {
        ...
        public static Task<ListProductFamiliesResult> InvokeAsync(ListProductFamiliesArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.InvokeAsync<ListProductFamiliesResult>("myedgeorder::listProductFamilies", args ?? new ListProductFamiliesArgs(), options.WithDefaults());
        ...
        public static Output<ListProductFamiliesResult> Invoke(ListProductFamiliesInvokeArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.Invoke<ListProductFamiliesResult>("myedgeorder::listProductFamilies", args ?? new ListProductFamiliesInvokeArgs(), options.WithDefaults());
    ...
    public sealed class ListProductFamiliesArgs : global::Codeinfra.InvokeArgs
    {
        /// <summary>
    ...
    public sealed class ListProductFamiliesInvokeArgs : global::Codeinfra.InvokeArgs
    {
        /// <summary>
        /// Customer subscription properties. Clients can display available products to unregistered customers by explicitly passing subscription details
        /// </summary>
