...
class ConfigurationFilters:
    def __init__(__self__, *,
        ...
        if filterable_property is not None:
            codeinfra.set(__self__, "filterable_property", filterable_property)
    ...
    def hierarchy_information(self, value: 'HierarchyInformation'):
        codeinfra.set(self, "hierarchy_information", value)

    @property
    @codeinfra.getter(name="filterableProperty")
    def filterable_property(self) -> Optional[Sequence['FilterableProperty']]:
        """
        Filters specific to product
        """
        return codeinfra.get(self, "filterable_property")

    @filterable_property.setter
    def filterable_property(self, value: Optional[Sequence['FilterableProperty']]):
        codeinfra.set(self, "filterable_property", value)
...
class CustomerSubscriptionDetails:
    def __init__(__self__, *,
        ...
        """
        codeinfra.set(__self__, "quota_id", quota_id)
        if location_placement_id is not None:
            codeinfra.set(__self__, "location_placement_id", location_placement_id)
        if registered_features is not None:
            codeinfra.set(__self__, "registered_features", registered_features)

    @property
    @codeinfra.getter(name="quotaId")
    def quota_id(self) -> str:
        """
        Quota ID of a subscription
        """
        return codeinfra.get(self, "quota_id")

    @quota_id.setter
    def quota_id(self, value: str):
        codeinfra.set(self, "quota_id", value)

    @property
    @codeinfra.getter(name="locationPlacementId")
    def location_placement_id(self) -> Optional[str]:
        """
        Location placement Id of a subscription
        """
        return codeinfra.get(self, "location_placement_id")

    @location_placement_id.setter
    def location_placement_id(self, value: Optional[str]):
        codeinfra.set(self, "location_placement_id", value)

    @property
    @codeinfra.getter(name="registeredFeatures")
    def registered_features(self) -> Optional[Sequence['CustomerSubscriptionRegisteredFeatures']]:
        """
        List of registered feature flags for subscription
        """
        return codeinfra.get(self, "registered_features")

    @registered_features.setter
    def registered_features(self, value: Optional[Sequence['CustomerSubscriptionRegisteredFeatures']]):
        codeinfra.set(self, "registered_features", value)
...
class CustomerSubscriptionRegisteredFeatures:
    def __init__(__self__, *,
        ...
        if state is not None:
            codeinfra.set(__self__, "state", state)
    ...
    def state(self) -> Optional[str]:
        ...
        State of subscription registered feature
        """
        return codeinfra.get(self, "state")

    @state.setter
    def state(self, value: Optional[str]):
        codeinfra.set(self, "state", value)
...
class FilterableProperty:
    ...
    def supported_values(self, value: Sequence[str]):
        codeinfra.set(self, "supported_values", value)
...
class HierarchyInformation:
    ...
    def configuration_name(self, value: Optional[str]):
        codeinfra.set(self, "configuration_name", value)
    ...
    def product_family_name(self, value: Optional[str]):
        codeinfra.set(self, "product_family_name", value)
    ...
    def product_line_name(self, value: Optional[str]):
        codeinfra.set(self, "product_line_name", value)
    ...
    def product_name(self, value: Optional[str]):
        codeinfra.set(self, "product_name", value)
