The native Azure provider package offers support for all Azure Resource Manager (ARM)
...
version using infrastructure as code, which Codeinfra then uses to drive the ARM API.
