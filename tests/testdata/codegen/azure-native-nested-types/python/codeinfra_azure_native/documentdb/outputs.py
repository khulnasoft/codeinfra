...
class CompositePathResponse(dict):
    def __init__(__self__, *,
        ...
        if order is not None:
            codeinfra.set(__self__, "order", order)
        if path is not None:
            codeinfra.set(__self__, "path", path)
    ...
    def order(self) -> Optional[str]:
        ...
        """
        return codeinfra.get(self, "order")
    ...
    def path(self) -> Optional[str]:
        ...
        """
        return codeinfra.get(self, "path")
...
class IndexingPolicyResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            codeinfra.log.warn(f"Key '{key}' not found in IndexingPolicyResponse. Access the value via the '{suggest}' property getter instead.")
    ...
    def __init__(__self__, *,
        ...
        if composite_indexes is not None:
            codeinfra.set(__self__, "composite_indexes", composite_indexes)

    @property
    @codeinfra.getter(name="compositeIndexes")
    def composite_indexes(self) -> Optional[Sequence[Sequence['outputs.CompositePathResponse']]]:
        """
        List of composite path list
        """
        return codeinfra.get(self, "composite_indexes")
...
class SqlContainerGetPropertiesResponseResource(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            codeinfra.log.warn(f"Key '{key}' not found in SqlContainerGetPropertiesResponseResource. Access the value via the '{suggest}' property getter instead.")
    ...
    def __init__(__self__, *,
        ...
        if indexing_policy is not None:
            codeinfra.set(__self__, "indexing_policy", indexing_policy)

    @property
    @codeinfra.getter(name="indexingPolicy")
    def indexing_policy(self) -> Optional['outputs.IndexingPolicyResponse']:
        """
        The configuration of the indexing policy. By default, the indexing is automatic for all document paths within the container
        """
        return codeinfra.get(self, "indexing_policy")
