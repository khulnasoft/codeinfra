...
return await Deployment.RunAsync(() => 
{
    ...
    {
        Bucket = siteBucket.Id,
        Source = new RemoteAsset("https://codeinfra.test"),
    });
    ...
    {
        Role = siteBucket.Arn,
        Code = new RemoteArchive("https://codeinfra.test/foo.tar.gz"),
    });
    ...
    var testAssetArchive = new Aws.Lambda.Function("testAssetArchive", new()
    {
        ...
        Code = new AssetArchive(new Dictionary<string, AssetOrArchive>
        {
            ...
            ["remote.txt"] = new RemoteAsset("https://codeinfra.test"),
            ["file.tar"] = new FileArchive("file.tar.gz"),
            ["remote.tar"] = new RemoteArchive("https://codeinfra.test/foo.tar.gz"),
