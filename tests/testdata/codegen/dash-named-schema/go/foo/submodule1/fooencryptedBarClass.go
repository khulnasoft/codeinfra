...
func NewFOOEncryptedBarClass(ctx *codeinfra.Context,
	name string, args *FOOEncryptedBarClassArgs, opts ...codeinfra.ResourceOption) (*FOOEncryptedBarClass, error) {
	if args == nil {
...
func GetFOOEncryptedBarClass(ctx *codeinfra.Context,
	name string, id codeinfra.IDInput, state *FOOEncryptedBarClassState, opts ...codeinfra.ResourceOption) (*FOOEncryptedBarClass, error) {
	var resource FOOEncryptedBarClass
...
func (i *FOOEncryptedBarClass) ToFOOEncryptedBarClassOutputWithContext(ctx context.Context) FOOEncryptedBarClassOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(FOOEncryptedBarClassOutput)
}

type FOOEncryptedBarClassOutput struct{ *codeinfra.OutputState }
...
func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*FOOEncryptedBarClassInput)(nil)).Elem(), &FOOEncryptedBarClass{})
	codeinfra.RegisterOutputType(FOOEncryptedBarClassOutput{})
}
