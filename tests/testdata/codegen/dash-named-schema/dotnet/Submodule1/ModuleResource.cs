...
namespace Codeinfra.FooBar.Submodule1
{
    ...
    {
        [Input("thing")]
        public Input<Codeinfra.FooBar.Inputs.TopLevelArgs>? Thing { get; set; }
