...
func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*CatInput)(nil)).Elem(), &Cat{})
	codeinfra.RegisterInputType(reflect.TypeOf((*CatArrayInput)(nil)).Elem(), CatArray{})
	codeinfra.RegisterInputType(reflect.TypeOf((*CatMapInput)(nil)).Elem(), CatMap{})
