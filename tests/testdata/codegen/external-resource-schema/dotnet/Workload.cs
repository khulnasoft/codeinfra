...
namespace Codeinfra.Example
{
    ...
    public partial class Workload : global::Codeinfra.CustomResource
    {
        [Output("pod")]
        public Output<Codeinfra.Kubernetes.Types.Outputs.Core.V1.Pod?> Pod { get; private set; } = null!;
    ...
    public sealed class WorkloadArgs : global::Codeinfra.ResourceArgs
    {
        public WorkloadArgs()
        {
        }
