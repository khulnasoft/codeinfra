...
func (i OtherResourceOutputTypeArgs) ToOtherResourceOutputTypeOutputWithContext(ctx context.Context) OtherResourceOutputTypeOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(OtherResourceOutputTypeOutput)
}

type OtherResourceOutputTypeOutput struct{ *codeinfra.OutputState }
...
func (o OtherResourceOutputTypeOutput) Foo() codeinfra.StringPtrOutput {
	return o.ApplyT(func(v OtherResourceOutputType) *string { return v.Foo }).(codeinfra.StringPtrOutput)
}
...
func init() {
	...
	codeinfra.RegisterInputType(reflect.TypeOf((*OtherResourceOutputTypeInput)(nil)).Elem(), OtherResourceOutputTypeArgs{})
	...
	codeinfra.RegisterOutputType(OtherResourceOutputTypeOutput{})
