...
func (i GetCustomDbRolesResultArgs) ToGetCustomDbRolesResultOutputWithContext(ctx context.Context) GetCustomDbRolesResultOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(GetCustomDbRolesResultOutput)
}
...
func (i GetCustomDbRolesResultArgs) ToGetCustomDbRolesResultPtrOutputWithContext(ctx context.Context) GetCustomDbRolesResultPtrOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(GetCustomDbRolesResultOutput).ToGetCustomDbRolesResultPtrOutputWithContext(ctx)
}
...
func (i *getCustomDbRolesResultPtrType) ToGetCustomDbRolesResultPtrOutputWithContext(ctx context.Context) GetCustomDbRolesResultPtrOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(GetCustomDbRolesResultPtrOutput)
}

type GetCustomDbRolesResultOutput struct{ *codeinfra.OutputState }
...
type GetCustomDbRolesResultPtrOutput struct{ *codeinfra.OutputState }
...
func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*GetCustomDbRolesResultInput)(nil)).Elem(), GetCustomDbRolesResultArgs{})
	codeinfra.RegisterInputType(reflect.TypeOf((*GetCustomDbRolesResultPtrInput)(nil)).Elem(), GetCustomDbRolesResultArgs{})
	codeinfra.RegisterOutputType(GetCustomDbRolesResultOutput{})
	codeinfra.RegisterOutputType(GetCustomDbRolesResultPtrOutput{})
}
