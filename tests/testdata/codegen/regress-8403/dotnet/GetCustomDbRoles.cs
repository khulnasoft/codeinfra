...
namespace Codeinfra.Mongodbatlas
{
    public static class GetCustomDbRoles
    {
        public static Task<GetCustomDbRolesResult> InvokeAsync(GetCustomDbRolesArgs? args = null, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.InvokeAsync<GetCustomDbRolesResult>("mongodbatlas::getCustomDbRoles", args ?? new GetCustomDbRolesArgs(), options.WithDefaults());

        public static Output<GetCustomDbRolesResult> Invoke(InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.Invoke<GetCustomDbRolesResult>("mongodbatlas::getCustomDbRoles", InvokeArgs.Empty, options.WithDefaults());
    ...
    public sealed class GetCustomDbRolesArgs : global::Codeinfra.InvokeArgs
    {
