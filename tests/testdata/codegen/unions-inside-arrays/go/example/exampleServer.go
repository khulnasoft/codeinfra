...
type exampleServerArgs struct {
	PropertiesCollection []interface{} `codeinfra:"propertiesCollection"`
}

// The set of arguments for constructing a ExampleServer resource.
type ExampleServerArgs struct {
	PropertiesCollection codeinfra.ArrayInput
}
...
func (i *ExampleServer) ToOutput(ctx context.Context) codeinfrax.Output[*ExampleServer] {
	return codeinfrax.Output[*ExampleServer]{
...
func (o ExampleServerOutput) ToOutput(ctx context.Context) codeinfrax.Output[*ExampleServer] {
	return codeinfrax.Output[*ExampleServer]{
		OutputState: o.OutputState,
	}
}

func (o ExampleServerOutput) Name() codeinfra.StringPtrOutput {
	return o.ApplyT(func(v *ExampleServer) codeinfra.StringPtrOutput { return v.Name }).(codeinfra.StringPtrOutput)
}
