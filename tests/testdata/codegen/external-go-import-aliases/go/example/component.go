...
import (
	...
	awsec2 "github.com/khulnasoft/codeinfra-aws/sdk/v4/go/aws/ec2"
	...
	dns "github.com/khulnasoft/codeinfra-google-native/sdk/go/google/dns/v1"
	gcpiamv1 "github.com/khulnasoft/codeinfra-google-native/sdk/go/google/iam/v1"
...
type Component struct {
	...
	ResourceLocalAlias                awsec2.InstanceOutput               `codeinfra:"resourceLocalAlias"`
	ResourceLocalInsteadOfRemoteAlias gcpiamv1.KeyOutput                  `codeinfra:"resourceLocalInsteadOfRemoteAlias"`
	ResourceNoAlias                   s3.BucketOutput                     `codeinfra:"resourceNoAlias"`
	ResourceRemoteAlias               dns.PolicyOutput                    `codeinfra:"resourceRemoteAlias"`
	TypeLocalAlias                    awsec2.InstanceLaunchTemplateOutput `codeinfra:"typeLocalAlias"`
	TypeLocalInsteadOfRemoteAlias     gcpiamv1.AuditConfigResponseOutput  `codeinfra:"typeLocalInsteadOfRemoteAlias"`
	TypeNoAlias                       s3.BucketWebsiteOutput              `codeinfra:"typeNoAlias"`
	TypeRemoteAlias                   dns.DnsKeySpecResponseOutput        `codeinfra:"typeRemoteAlias"`
}
...
type componentArgs struct {
	ResourceLocalAlias                *awsec2.Instance                                                    `codeinfra:"resourceLocalAlias"`
	ResourceLocalInsteadOfRemoteAlias *gcpiamv1.Key                                                       `codeinfra:"resourceLocalInsteadOfRemoteAlias"`
	ResourceNoAlias                   *s3.Bucket                                                          `codeinfra:"resourceNoAlias"`
	ResourceRemoteAlias               *dns.Policy                                                         `codeinfra:"resourceRemoteAlias"`
	TypeLocalAlias                    awsec2.InstanceLaunchTemplate                                       `codeinfra:"typeLocalAlias"`
	TypeLocalInsteadOfRemoteAlias     gcpiamv1.AuditConfig                                                `codeinfra:"typeLocalInsteadOfRemoteAlias"`
	TypeNoAlias                       s3.BucketWebsite                                                    `codeinfra:"typeNoAlias"`
	TypeRemoteAlias                   dns.DnsKeySpec                                                      `codeinfra:"typeRemoteAlias"`
	TypeRemoteEnum                    *accesscontextmanager.DevicePolicyAllowedDeviceManagementLevelsItem `codeinfra:"typeRemoteEnum"`
}
