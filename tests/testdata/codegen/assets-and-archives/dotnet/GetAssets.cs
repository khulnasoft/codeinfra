...
namespace Codeinfra.Example
{
    public static class GetAssets
    {
        public static Task<GetAssetsResult> InvokeAsync(GetAssetsArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.InvokeAsync<GetAssetsResult>("example::GetAssets", args ?? new GetAssetsArgs(), options.WithDefaults());

        public static Output<GetAssetsResult> Invoke(GetAssetsInvokeArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.Invoke<GetAssetsResult>("example::GetAssets", args ?? new GetAssetsInvokeArgs(), options.WithDefaults());
    ...
    public sealed class GetAssetsArgs : global::Codeinfra.InvokeArgs
    {
    ...
    public sealed class GetAssetsInvokeArgs : global::Codeinfra.InvokeArgs
    {
        [Input("archive", required: true)]
