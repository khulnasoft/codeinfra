...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">ResourceWithAssets</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ResourceWithAssetsArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/codeinfra/codeinfra/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">ResourceWithAssets</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                       <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/codeinfra/#codeinfra.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">,</span>
                       <span class="nx">source</span><span class="p">:</span> <span class="nx">Optional[Union[codeinfra.Asset, codeinfra.Archive]]</span> = None<span class="p">,</span>
                       <span class="nx">archive</span><span class="p">:</span> <span class="nx">Optional[codeinfra.Archive]</span> = None<span class="p">,</span>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewResourceWithAssets</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ResourceWithAssetsArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ResourceWithAssets</span>, error)</span></code></pre></div>
</div></codeinfra-choosable>
</div>

<div>
<codeinfra-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">ResourceWithAssets</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ResourceWithAssetsArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Codeinfra/Codeinfra.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></codeinfra-choosable>
</div>
...
example, err := example.NewResourceWithAssets(ctx, "resourceWithAssetsResource", &example.ResourceWithAssetsArgs{
	Source:  codeinfra.NewStringAsset("content"),
	Archive: codeinfra.NewFileArchive("./path/to/archive"),
	Nested: &example.TypeWithAssetsArgs{
		Asset:        codeinfra.NewStringAsset("content"),
		PlainArchive: codeinfra.NewFileArchive("./path/to/archive"),
		Archive:      codeinfra.NewFileArchive("./path/to/archive"),
		PlainAsset:   codeinfra.NewStringAsset("content"),
	},
})
```
...
resource_with_assets_resource = example.ResourceWithAssets("resourceWithAssetsResource",
    source=codeinfra.StringAsset("content"),
    archive=codeinfra.FileArchive("./path/to/archive"),
    nested={
        "asset": codeinfra.StringAsset("content"),
        "plain_archive": codeinfra.FileArchive("./path/to/archive"),
        "archive": codeinfra.FileArchive("./path/to/archive"),
        "plain_asset": codeinfra.StringAsset("content"),
    })
```
...
const resourceWithAssetsResource = new example.ResourceWithAssets("resourceWithAssetsResource", {
    source: new codeinfra.asset.StringAsset("content"),
    archive: new codeinfra.asset.FileArchive("./path/to/archive"),
    nested: {
        asset: new codeinfra.asset.StringAsset("content"),
        plainArchive: new codeinfra.asset.FileArchive("./path/to/archive"),
        archive: new codeinfra.asset.FileArchive("./path/to/archive"),
        plainAsset: new codeinfra.asset.StringAsset("content"),
    },
});
```
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#source_go" style="color: inherit; text-decoration: inherit;">Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">codeinfra.<wbr>Asset<wbr>Or<wbr>Archive</span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
        <span id="archive_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#archive_go" style="color: inherit; text-decoration: inherit;">Archive</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">codeinfra.<wbr>Archive</span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
        <span id="nested_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#source_nodejs" style="color: inherit; text-decoration: inherit;">source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">codeinfra.asset.<wbr>Asset | codeinfra.asset.<wbr>Archive</span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#archive_nodejs" style="color: inherit; text-decoration: inherit;">archive</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">codeinfra.asset.<wbr>Archive</span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#source_python" style="color: inherit; text-decoration: inherit;">source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Union[codeinfra.<wbr>Asset, codeinfra.<wbr>Archive]</span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
...
Type<wbr>With<wbr>Assets<codeinfra-choosable type="language" values="python,go" class="inline">, Type<wbr>With<wbr>Assets<wbr>Args</codeinfra-choosable>
</h4>
