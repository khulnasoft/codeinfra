...
type ResourceWithAssets struct {
	...
	Archive codeinfra.ArchiveOutput        `codeinfra:"archive"`
	Asset   codeinfra.AssetOrArchiveOutput `codeinfra:"asset"`
	Nested  TypeWithAssetsPtrOutput     `codeinfra:"nested"`
}
...
type ResourceWithAssetsArgs struct {
	Archive codeinfra.ArchiveInput
	Nested  TypeWithAssetsPtrInput
	Source  codeinfra.AssetOrArchiveInput
}
...
func (i *ResourceWithAssets) ToResourceWithAssetsOutputWithContext(ctx context.Context) ResourceWithAssetsOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ResourceWithAssetsOutput)
}
...
func (o ResourceWithAssetsOutput) Archive() codeinfra.ArchiveOutput {
	return o.ApplyT(func(v *ResourceWithAssets) codeinfra.ArchiveOutput { return v.Archive }).(codeinfra.ArchiveOutput)
}

func (o ResourceWithAssetsOutput) Asset() codeinfra.AssetOrArchiveOutput {
	return o.ApplyT(func(v *ResourceWithAssets) codeinfra.AssetOrArchiveOutput { return v.Asset }).(codeinfra.AssetOrArchiveOutput)
}
...
func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*ResourceWithAssetsInput)(nil)).Elem(), &ResourceWithAssets{})
