...
namespace Codeinfra.Example
{
    ...
    public partial class MainComponent : global::Codeinfra.CustomResource
    {
        /// <summary>
        ...
        private MainComponent(string name, Input<string> id, CustomResourceOptions? options = null)
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MainComponent Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new MainComponent(name, id, options);
        }
    }

    public sealed class MainComponentArgs : global::Codeinfra.ResourceArgs
    {
