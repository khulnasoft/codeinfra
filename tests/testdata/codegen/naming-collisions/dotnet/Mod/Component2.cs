...
namespace Codeinfra.Example.Mod
{
    [ExampleResourceType("example:mod:Component2")]
    public partial class Component2 : global::Codeinfra.CustomResource
    {
        /// <summary>
        ...
        private Component2(string name, Input<string> id, CustomResourceOptions? options = null)
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Component2 Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new Component2(name, id, options);
        }
    }

    public sealed class Component2Args : global::Codeinfra.ResourceArgs
    {
