...
namespace Codeinfra.Foo
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Codeinfra.Foo.version.txt");
    ...
    internal sealed class FooResourceTypeAttribute : global::Codeinfra.ResourceTypeAttribute
    {
