...
namespace Codeinfra.Foo.Nested.Module
{
    [FooResourceType("foo:nested/module:Resource")]
    public partial class Resource : global::Codeinfra.CustomResource
    {
        [Output("bar")]
        ...
        public Resource(string name, ResourceArgs? args = null, CustomResourceOptions? options = null)
            : base("foo:nested/module:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("foo:nested/module:Resource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ResourceArgs : global::Codeinfra.ResourceArgs
    {
        [Input("bar")]
