...
### Constructor syntax
<div>
<codeinfra-chooser type="language" options="csharp,go,typescript,python,yaml,java"></codeinfra-chooser>
</div>


<div>
<codeinfra-choosable type="language" values="javascript,typescript">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">Component</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">?:</span> <span class="nx"><a href="#inputs">ComponentArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/codeinfra/codeinfra/#ComponentResourceOptions">ComponentResourceOptions</a></span><span class="p">);</span></code></pre></div>
</div></codeinfra-choosable>
</div>

<div>
<codeinfra-choosable type="language" values="python">
...
<span class="k">def </span><span class="nx">Component</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
              ...
              <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/codeinfra/#codeinfra.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">)</span>
<span></span>
...
<span class="k">def </span><span class="nx">Component</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
              ...
              <span class="nx">pod</span><span class="p">:</span> <span class="nx">Optional[codeinfra_kubernetes.core.v1.PodArgs]</span> = None<span class="p">)</span></code></pre></div>
</div></codeinfra-choosable>
</div>

<div>
<codeinfra-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewComponent</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="#inputs">ComponentArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Component</span>, error)</span></code></pre></div>
</div></codeinfra-choosable>
</div>

<div>
<codeinfra-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">Component</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ComponentArgs</a></span><span class="p">? </span><span class="nx">args = null<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Codeinfra/Codeinfra.ComponentResourceOptions.html">ComponentResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></codeinfra-choosable>
</div>

<div>
<codeinfra-choosable type="language" values="java">
...
<div>
<codeinfra-choosable type="language" values="yaml">
...
<dl class="resources-properties"><dt
    ...
    <dd>The arguments to resource properties.</dd><dt
        ...
        <span>opts</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/codeinfra/codeinfra/#ComponentResourceOptions">ComponentResourceOptions</a></span>
    </dt>
...
<dl class="resources-properties"><dt
    ...
    <dd>The arguments to resource properties.</dd><dt
        ...
        <span>opts</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/python/codeinfra/#codeinfra.ResourceOptions">ResourceOptions</a></span>
    </dt>
    <dd>Bag of options to control resource&#39;s behavior.</dd></dl>
...
<dl class="resources-properties"><dt
        ...
        <span>ctx</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#Context">Context</a></span>
    </dt>
    ...
    <dd>The arguments to resource properties.</dd><dt
        ...
        <span>opts</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#ResourceOption">ResourceOption</a></span>
    </dt>
    <dd>Bag of options to control resource&#39;s behavior.</dd></dl>
...
<dl class="resources-properties"><dt
    ...
    <dd>The arguments to resource properties.</dd><dt
        ...
        <span>opts</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Codeinfra/Codeinfra.ComponentResourceOptions.html">ComponentResourceOptions</a></span>
    </dt>
    <dd>Bag of options to control resource&#39;s behavior.</dd></dl>
...
example, err := foo.NewComponent(ctx, "componentResource", &foo.ComponentArgs{
	EniConfig: v1alpha1.ENIConfigSpecMap{
		"string": &v1alpha1.ENIConfigSpecArgs{
			...
			Subnet: codeinfra.String("string"),
		},
	},
	Pod: &corev1.PodTypeArgs{
		ApiVersion: codeinfra.String("v1"),
		Kind:       codeinfra.String("Pod"),
		Metadata: &metav1.ObjectMetaArgs{
			Annotations: codeinfra.StringMap{
				"string": codeinfra.String("string"),
			},
			ClusterName:                codeinfra.String("string"),
			CreationTimestamp:          codeinfra.String("string"),
			DeletionGracePeriodSeconds: codeinfra.Int(0),
			DeletionTimestamp:          codeinfra.String("string"),
			Finalizers: codeinfra.StringArray{
				codeinfra.String("string"),
			},
			GenerateName: codeinfra.String("string"),
			Generation:   codeinfra.Int(0),
			Labels: codeinfra.StringMap{
				"string": codeinfra.String("string"),
			},
			ManagedFields: metav1.ManagedFieldsEntryArray{
				&metav1.ManagedFieldsEntryArgs{
					ApiVersion:  codeinfra.String("string"),
					FieldsType:  codeinfra.String("string"),
					FieldsV1:    codeinfra.Any("{}"),
					Manager:     codeinfra.String("string"),
					Operation:   codeinfra.String("string"),
					Subresource: codeinfra.String("string"),
					Time:        codeinfra.String("string"),
				},
			},
			Name:      codeinfra.String("string"),
			Namespace: codeinfra.String("string"),
			OwnerReferences: metav1.OwnerReferenceArray{
				&metav1.OwnerReferenceArgs{
					ApiVersion:         codeinfra.String("string"),
					Kind:               codeinfra.String("string"),
					Name:               codeinfra.String("string"),
					Uid:                codeinfra.String("string"),
					BlockOwnerDeletion: codeinfra.Bool(false),
					Controller:         codeinfra.Bool(false),
				},
			},
			ResourceVersion: codeinfra.String("string"),
			SelfLink:        codeinfra.String("string"),
			Uid:             codeinfra.String("string"),
		},
		Spec: &corev1.PodSpecArgs{
			Containers: corev1.ContainerArray{
				&corev1.ContainerArgs{
					...
					ReadinessProbe: &corev1.ProbeArgs{
						...
						FailureThreshold: codeinfra.Int(0),
						HttpGet: &corev1.HTTPGetActionArgs{
							Port: codeinfra.Any(0),
							Host: codeinfra.String("string"),
							HttpHeaders: corev1.HTTPHeaderArray{
								&corev1.HTTPHeaderArgs{
									Name:  codeinfra.String("string"),
									Value: codeinfra.String("string"),
								},
							},
							Path:   codeinfra.String("string"),
							Scheme: codeinfra.String("string"),
						},
						InitialDelaySeconds: codeinfra.Int(0),
						PeriodSeconds:       codeinfra.Int(0),
						SuccessThreshold:    codeinfra.Int(0),
						TcpSocket: &corev1.TCPSocketActionArgs{
							Port: codeinfra.Any(0),
							Host: codeinfra.String("string"),
						},
						TerminationGracePeriodSeconds: codeinfra.Int(0),
						TimeoutSeconds:                codeinfra.Int(0),
					},
					ImagePullPolicy: codeinfra.String("string"),
					Resources: &corev1.ResourceRequirementsArgs{
						Limits: codeinfra.StringMap{
							"string": codeinfra.String("string"),
						},
						Requests: codeinfra.StringMap{
							"string": codeinfra.String("string"),
						},
					},
					...
					SecurityContext: &corev1.SecurityContextArgs{
						AllowPrivilegeEscalation: codeinfra.Bool(false),
						Capabilities: &corev1.CapabilitiesArgs{
							Add: codeinfra.StringArray{
								codeinfra.String("string"),
							},
							Drop: codeinfra.StringArray{
								codeinfra.String("string"),
							},
						},
						Privileged:             codeinfra.Bool(false),
						ProcMount:              codeinfra.String("string"),
						ReadOnlyRootFilesystem: codeinfra.Bool(false),
						RunAsGroup:             codeinfra.Int(0),
						RunAsNonRoot:           codeinfra.Bool(false),
						RunAsUser:              codeinfra.Int(0),
						SeLinuxOptions: &corev1.SELinuxOptionsArgs{
							Level: codeinfra.String("string"),
							Role:  codeinfra.String("string"),
							Type:  codeinfra.String("string"),
							User:  codeinfra.String("string"),
						},
						SeccompProfile: &corev1.SeccompProfileArgs{
							Type:             codeinfra.String("string"),
							LocalhostProfile: codeinfra.String("string"),
						},
						WindowsOptions: &corev1.WindowsSecurityContextOptionsArgs{
							GmsaCredentialSpec:     codeinfra.String("string"),
							GmsaCredentialSpecName: codeinfra.String("string"),
							HostProcess:            codeinfra.Bool(false),
							RunAsUserName:          codeinfra.String("string"),
						},
					},
					...
					Ports: corev1.ContainerPortArray{
						&corev1.ContainerPortArgs{
							ContainerPort: codeinfra.Int(0),
							HostIP:        codeinfra.String("string"),
							HostPort:      codeinfra.Int(0),
							Name:          codeinfra.String("string"),
							Protocol:      codeinfra.String("string"),
						},
					},
					...
					EnvFrom: corev1.EnvFromSourceArray{
						&corev1.EnvFromSourceArgs{
							ConfigMapRef: &corev1.ConfigMapEnvSourceArgs{
								Name:     codeinfra.String("string"),
								Optional: codeinfra.Bool(false),
							},
							Prefix: codeinfra.String("string"),
						...
						&corev1.EnvVarArgs{
							...
							ValueFrom: &corev1.EnvVarSourceArgs{
								ConfigMapKeyRef: &corev1.ConfigMapKeySelectorArgs{
									Key:      codeinfra.String("string"),
									Name:     codeinfra.String("string"),
									Optional: codeinfra.Bool(false),
								},
								FieldRef: &corev1.ObjectFieldSelectorArgs{
									FieldPath:  codeinfra.String("string"),
									ApiVersion: codeinfra.String("string"),
								},
								ResourceFieldRef: &corev1.ResourceFieldSelectorArgs{
									Resource:      codeinfra.String("string"),
									ContainerName: codeinfra.String("string"),
									Divisor:       codeinfra.String("string"),
								},
					...
					Image:                    codeinfra.String("string"),
					Stdin:                    codeinfra.Bool(false),
					StdinOnce:                codeinfra.Bool(false),
					TerminationMessagePath:   codeinfra.String("string"),
					TerminationMessagePolicy: codeinfra.String("string"),
					Tty:                      codeinfra.Bool(false),
					VolumeDevices: corev1.VolumeDeviceArray{
						&corev1.VolumeDeviceArgs{
							DevicePath: codeinfra.String("string"),
							Name:       codeinfra.String("string"),
						},
					},
					VolumeMounts: corev1.VolumeMountArray{
						&corev1.VolumeMountArgs{
							MountPath:        codeinfra.String("string"),
							Name:             codeinfra.String("string"),
							MountPropagation: codeinfra.String("string"),
							ReadOnly:         codeinfra.Bool(false),
							SubPath:          codeinfra.String("string"),
							SubPathExpr:      codeinfra.String("string"),
						},
					},
					WorkingDir: codeinfra.String("string"),
				},
			},
			NodeSelector: codeinfra.StringMap{
				"string": codeinfra.String("string"),
			},
			HostAliases: corev1.HostAliasArray{
				&corev1.HostAliasArgs{
					Hostnames: codeinfra.StringArray{
						codeinfra.String("string"),
					},
					Ip: codeinfra.String("string"),
				},
			},
							...
							Preference: &corev1.NodeSelectorTermArgs{
								MatchExpressions: corev1.NodeSelectorRequirementArray{
									&corev1.NodeSelectorRequirementArgs{
										Key:      codeinfra.String("string"),
										Operator: codeinfra.String("string"),
					...
					PreferredDuringSchedulingIgnoredDuringExecution: corev1.WeightedPodAffinityTermArray{
						&corev1.WeightedPodAffinityTermArgs{
							PodAffinityTerm: &corev1.PodAffinityTermArgs{
								TopologyKey: codeinfra.String("string"),
								...
								Namespaces: codeinfra.StringArray{
									codeinfra.String("string"),
								},
							},
							Weight: codeinfra.Int(0),
			...
			DnsConfig: &corev1.PodDNSConfigArgs{
				Nameservers: codeinfra.StringArray{
					codeinfra.String("string"),
				},
				...
				Searches: codeinfra.StringArray{
					codeinfra.String("string"),
				},
			},
			Overhead: codeinfra.StringMap{
				"string": codeinfra.String("string"),
			},
			EnableServiceLinks: codeinfra.Bool(false),
			EphemeralContainers: corev1.EphemeralContainerArray{
				&corev1.EphemeralContainerArgs{
					...
					Stdin:                    codeinfra.Bool(false),
					StdinOnce:                codeinfra.Bool(false),
					TargetContainerName:      codeinfra.String("string"),
					TerminationMessagePath:   codeinfra.String("string"),
					TerminationMessagePolicy: codeinfra.String("string"),
					Tty:                      codeinfra.Bool(false),
					VolumeDevices: corev1.VolumeDeviceArray{
			...
			PreemptionPolicy: codeinfra.String("string"),
			HostIPC:          codeinfra.Bool(false),
			Priority:         codeinfra.Int(0),
			HostPID:          codeinfra.Bool(false),
			Hostname:         codeinfra.String("string"),
			...
			NodeName:                     codeinfra.String("string"),
			ActiveDeadlineSeconds:        codeinfra.Int(0),
			DnsPolicy:                    codeinfra.String("string"),
			AutomountServiceAccountToken: codeinfra.Bool(false),
			HostNetwork:                  codeinfra.Bool(false),
			PriorityClassName:            codeinfra.String("string"),
			ReadinessGates: corev1.PodReadinessGateArray{
				&corev1.PodReadinessGateArgs{
					ConditionType: codeinfra.String("string"),
				},
			},
			RestartPolicy:    codeinfra.String("string"),
			RuntimeClassName: codeinfra.String("string"),
			SchedulerName:    codeinfra.String("string"),
			SecurityContext: &corev1.PodSecurityContextArgs{
				FsGroup:             codeinfra.Int(0),
				FsGroupChangePolicy: codeinfra.String("string"),
				RunAsGroup:          codeinfra.Int(0),
				RunAsNonRoot:        codeinfra.Bool(false),
				RunAsUser:           codeinfra.Int(0),
				SeLinuxOptions: &corev1.SELinuxOptionsArgs{
				...
				SupplementalGroups: codeinfra.IntArray{
					codeinfra.Int(0),
				},
			...
			ServiceAccount:                codeinfra.String("string"),
			ServiceAccountName:            codeinfra.String("string"),
			SetHostnameAsFQDN:             codeinfra.Bool(false),
			ShareProcessNamespace:         codeinfra.Bool(false),
			Subdomain:                     codeinfra.String("string"),
			TerminationGracePeriodSeconds: codeinfra.Int(0),
			Tolerations: corev1.TolerationArray{
				&corev1.TolerationArgs{
					Effect:            codeinfra.String("string"),
					Key:               codeinfra.String("string"),
					Operator:          codeinfra.String("string"),
					TolerationSeconds: codeinfra.Int(0),
					Value:             codeinfra.String("string"),
				},
			},
			TopologySpreadConstraints: corev1.TopologySpreadConstraintArray{
				&corev1.TopologySpreadConstraintArgs{
					MaxSkew:           codeinfra.Int(0),
					TopologyKey:       codeinfra.String("string"),
					WhenUnsatisfiable: codeinfra.String("string"),
					LabelSelector: &metav1.LabelSelectorArgs{
						MatchExpressions: metav1.LabelSelectorRequirementArray{
							&metav1.LabelSelectorRequirementArgs{
								Key:      codeinfra.String("string"),
			...
			Volumes: corev1.VolumeArray{
				&corev1.VolumeArgs{
					...
					GitRepo: &corev1.GitRepoVolumeSourceArgs{
						Repository: codeinfra.String("string"),
						Directory:  codeinfra.String("string"),
						Revision:   codeinfra.String("string"),
					},
					ConfigMap: &corev1.ConfigMapVolumeSourceArgs{
						DefaultMode: codeinfra.Int(0),
						Items: corev1.KeyToPathArray{
							&corev1.KeyToPathArgs{
								Key:  codeinfra.String("string"),
								Path: codeinfra.String("string"),
								Mode: codeinfra.Int(0),
							},
						},
						Name:     codeinfra.String("string"),
						Optional: codeinfra.Bool(false),
					...
					Glusterfs: &corev1.GlusterfsVolumeSourceArgs{
						Endpoints: codeinfra.String("string"),
						Path:      codeinfra.String("string"),
						ReadOnly:  codeinfra.Bool(false),
					},
					Cinder: &corev1.CinderVolumeSourceArgs{
						VolumeID: codeinfra.String("string"),
						FsType:   codeinfra.String("string"),
						ReadOnly: codeinfra.Bool(false),
					...
					Csi: &corev1.CSIVolumeSourceArgs{
						Driver: codeinfra.String("string"),
						FsType: codeinfra.String("string"),
						NodePublishSecretRef: &corev1.LocalObjectReferenceArgs{
							Name: codeinfra.String("string"),
						},
						ReadOnly: codeinfra.Bool(false),
						VolumeAttributes: codeinfra.StringMap{
							"string": codeinfra.String("string"),
						},
					},
					...
					Ephemeral: &corev1.EphemeralVolumeSourceArgs{
						...
						VolumeClaimTemplate: &corev1.PersistentVolumeClaimTemplateArgs{
							Spec: &corev1.PersistentVolumeClaimSpecArgs{
								...
								StorageClassName: codeinfra.String("string"),
								VolumeMode:       codeinfra.String("string"),
								VolumeName:       codeinfra.String("string"),
							},
							Metadata: &metav1.ObjectMetaArgs{
								Annotations: codeinfra.StringMap{
									"string": codeinfra.String("string"),
					...
					Fc: &corev1.FCVolumeSourceArgs{
						...
						Lun:      codeinfra.Int(0),
						ReadOnly: codeinfra.Bool(false),
						TargetWWNs: codeinfra.StringArray{
							codeinfra.String("string"),
						},
						Wwids: codeinfra.StringArray{
							codeinfra.String("string"),
						},
					},
					...
					Iscsi: &corev1.ISCSIVolumeSourceArgs{
						Iqn:               codeinfra.String("string"),
						Lun:               codeinfra.Int(0),
						TargetPortal:      codeinfra.String("string"),
						ChapAuthDiscovery: codeinfra.Bool(false),
						ChapAuthSession:   codeinfra.Bool(false),
						FsType:            codeinfra.String("string"),
						InitiatorName:     codeinfra.String("string"),
						IscsiInterface:    codeinfra.String("string"),
						Portals: codeinfra.StringArray{
							codeinfra.String("string"),
						},
						ReadOnly: codeinfra.Bool(false),
						SecretRef: &corev1.LocalObjectReferenceArgs{
					...
					GcePersistentDisk: &corev1.GCEPersistentDiskVolumeSourceArgs{
						PdName:    codeinfra.String("string"),
						FsType:    codeinfra.String("string"),
						Partition: codeinfra.Int(0),
						ReadOnly:  codeinfra.Bool(false),
					},
					...
					Cephfs: &corev1.CephFSVolumeSourceArgs{
						Monitors: codeinfra.StringArray{
							codeinfra.String("string"),
						},
						Path:       codeinfra.String("string"),
						ReadOnly:   codeinfra.Bool(false),
						SecretFile: codeinfra.String("string"),
						SecretRef: &corev1.LocalObjectReferenceArgs{
							Name: codeinfra.String("string"),
						},
						User: codeinfra.String("string"),
					...
					AzureFile: &corev1.AzureFileVolumeSourceArgs{
						SecretName: codeinfra.String("string"),
						ShareName:  codeinfra.String("string"),
						ReadOnly:   codeinfra.Bool(false),
					},
					Flocker: &corev1.FlockerVolumeSourceArgs{
						DatasetName: codeinfra.String("string"),
						DatasetUUID: codeinfra.String("string"),
					},
					AzureDisk: &corev1.AzureDiskVolumeSourceArgs{
						DiskName:    codeinfra.String("string"),
						DiskURI:     codeinfra.String("string"),
						CachingMode: codeinfra.String("string"),
						FsType:      codeinfra.String("string"),
						Kind:        codeinfra.String("string"),
						ReadOnly:    codeinfra.Bool(false),
					},
					Nfs: &corev1.NFSVolumeSourceArgs{
						Path:     codeinfra.String("string"),
						Server:   codeinfra.String("string"),
						ReadOnly: codeinfra.Bool(false),
					},
					PersistentVolumeClaim: &corev1.PersistentVolumeClaimVolumeSourceArgs{
						ClaimName: codeinfra.String("string"),
						ReadOnly:  codeinfra.Bool(false),
					},
					PhotonPersistentDisk: &corev1.PhotonPersistentDiskVolumeSourceArgs{
						PdID:   codeinfra.String("string"),
						FsType: codeinfra.String("string"),
					},
						...
						Sources: corev1.VolumeProjectionArray{
							&corev1.VolumeProjectionArgs{
								...
								ServiceAccountToken: &corev1.ServiceAccountTokenProjectionArgs{
									Path:              codeinfra.String("string"),
									Audience:          codeinfra.String("string"),
									ExpirationSeconds: codeinfra.Int(0),
								},
							},
						},
						DefaultMode: codeinfra.Int(0),
					...
					Quobyte: &corev1.QuobyteVolumeSourceArgs{
						Registry: codeinfra.String("string"),
						Volume:   codeinfra.String("string"),
						Group:    codeinfra.String("string"),
						ReadOnly: codeinfra.Bool(false),
						Tenant:   codeinfra.String("string"),
						User:     codeinfra.String("string"),
					},
					Rbd: &corev1.RBDVolumeSourceArgs{
						...
						FsType:   codeinfra.String("string"),
						Keyring:  codeinfra.String("string"),
						Pool:     codeinfra.String("string"),
						ReadOnly: codeinfra.Bool(false),
						SecretRef: &corev1.LocalObjectReferenceArgs{
							Name: codeinfra.String("string"),
						},
					...
					ScaleIO: &corev1.ScaleIOVolumeSourceArgs{
						Gateway: codeinfra.String("string"),
						SecretRef: &corev1.LocalObjectReferenceArgs{
							Name: codeinfra.String("string"),
						},
						System:           codeinfra.String("string"),
						FsType:           codeinfra.String("string"),
						ProtectionDomain: codeinfra.String("string"),
						ReadOnly:         codeinfra.Bool(false),
						SslEnabled:       codeinfra.Bool(false),
						StorageMode:      codeinfra.String("string"),
						StoragePool:      codeinfra.String("string"),
						VolumeName:       codeinfra.String("string"),
					},
					...
					Storageos: &corev1.StorageOSVolumeSourceArgs{
						...
						VolumeName:      codeinfra.String("string"),
						VolumeNamespace: codeinfra.String("string"),
					},
					VsphereVolume: &corev1.VsphereVirtualDiskVolumeSourceArgs{
						VolumePath:        codeinfra.String("string"),
						FsType:            codeinfra.String("string"),
						StoragePolicyID:   codeinfra.String("string"),
						StoragePolicyName: codeinfra.String("string"),
					},
				},
			},
		},
		Status: &corev1.PodStatusArgs{
			Conditions: corev1.PodConditionArray{
				&corev1.PodConditionArgs{
					Status:             codeinfra.String("string"),
					Type:               codeinfra.String("string"),
					LastProbeTime:      codeinfra.String("string"),
					LastTransitionTime: codeinfra.String("string"),
					Message:            codeinfra.String("string"),
					Reason:             codeinfra.String("string"),
				},
			},
			ContainerStatuses: corev1.ContainerStatusArray{
				&corev1.ContainerStatusArgs{
					Image:        codeinfra.String("string"),
					ImageID:      codeinfra.String("string"),
					Name:         codeinfra.String("string"),
					Ready:        codeinfra.Bool(false),
					RestartCount: codeinfra.Int(0),
					ContainerID:  codeinfra.String("string"),
					LastState: &corev1.ContainerStateArgs{
						Running: &corev1.ContainerStateRunningArgs{
							StartedAt: codeinfra.String("string"),
						},
						Terminated: &corev1.ContainerStateTerminatedArgs{
							ExitCode:    codeinfra.Int(0),
							ContainerID: codeinfra.String("string"),
							FinishedAt:  codeinfra.String("string"),
							Message:     codeinfra.String("string"),
							Reason:      codeinfra.String("string"),
							Signal:      codeinfra.Int(0),
							StartedAt:   codeinfra.String("string"),
						},
			...
			Message:           codeinfra.String("string"),
			NominatedNodeName: codeinfra.String("string"),
			Phase:             codeinfra.String("string"),
			PodIP:             codeinfra.String("string"),
			PodIPs: corev1.PodIPArray{
				&corev1.PodIPArgs{
					Ip: codeinfra.String("string"),
				},
			},
			QosClass:  codeinfra.String("string"),
			Reason:    codeinfra.String("string"),
			StartTime: codeinfra.String("string"),
		},
	},
})
```
...
<div>
<codeinfra-choosable type="language" values="typescript">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#eniconfig_csharp" style="color: inherit; text-decoration: inherit;">Eni<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Dictionary&lt;string, Codeinfra.<wbr>Kubernetes.<wbr>Crd.k8s.amazonaws.com.<wbr>V1alpha1.<wbr>Inputs.<wbr>ENIConfig<wbr>Spec<wbr>Args&gt;</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pod_csharp" style="color: inherit; text-decoration: inherit;">Pod</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pod">Codeinfra.<wbr>Kubernetes.<wbr>Types.<wbr>Inputs.<wbr>Core.<wbr>V1.<wbr>Pod</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pod_nodejs" style="color: inherit; text-decoration: inherit;">pod</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pod">codeinfra<wbr>Kubernetestypesinputcorev1Pod</a></span>
    </dt>
    <dd>This type is defined in the <a href="/registry/packages/kubernetes">Kubernetes</a> package.</dd></dl>
</codeinfra-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pod_python" style="color: inherit; text-decoration: inherit;">pod</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pod">codeinfra_<wbr>kubernetes.core.v1.<wbr>Pod<wbr>Args</a></span>
    </dt>
    <dd>This type is defined in the <a href="/registry/packages/kubernetes">Kubernetes</a> package.</dd></dl>
</codeinfra-choosable>
</div>
...
<h4 id="eniconfigspec">
ENIConfig<wbr>Spec<codeinfra-choosable type="language" values="python,go" class="inline">, ENIConfig<wbr>Spec<wbr>Args</codeinfra-choosable>
</h4>
