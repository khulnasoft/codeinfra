...
class OtherResourceArgs:
    def __init__(__self__, *,
                 bar: Optional[Sequence[codeinfra.Input[str]]] = None,
    ...
    @property
    @codeinfra.getter
    def bar(self) -> Optional[Sequence[codeinfra.Input[str]]]:
        return codeinfra.get(self, "bar")

    @bar.setter
    def bar(self, value: Optional[Sequence[codeinfra.Input[str]]]):
...
class OtherResource(codeinfra.ComponentResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OtherResourceArgs, codeinfra.ResourceOptions, *args, **kwargs)
