...
type TypeUses struct {
	...
	Alpha OutputOnlyEnumTypePtrOutput           `codeinfra:"alpha"`
	Bar   SomeOtherObjectPtrOutput              `codeinfra:"bar"`
	Baz   ObjectWithNodeOptionalInputsPtrOutput `codeinfra:"baz"`
	Beta  OutputOnlyObjectTypeArrayOutput       `codeinfra:"beta"`
	Foo   ObjectPtrOutput                       `codeinfra:"foo"`
	Gamma OutputOnlyEnumTypeMapOutput           `codeinfra:"gamma"`
	Qux   RubberTreeVarietyPtrOutput            `codeinfra:"qux"`
	Zed   OutputOnlyObjectTypePtrOutput         `codeinfra:"zed"`
}
...
type typeUsesArgs struct {
	...
	Qux *RubberTreeVariety            `codeinfra:"qux"`
}
