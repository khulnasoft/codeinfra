...
namespace Codeinfra.Example
{
    ...
    public partial class OtherResource : global::Codeinfra.ComponentResource
    {
        [Output("foo")]
        public Output<Codeinfra.Example.Resource?> Foo { get; private set; } = null!;
    ...
    public sealed class OtherResourceArgs : global::Codeinfra.ResourceArgs
    {
        [Input("bar")]
        ...
        [Input("foo")]
        public Input<Codeinfra.Example.Resource>? Foo { get; set; }
