...
namespace Codeinfra.Example
{
    ...
    public partial class TypeUses : global::Codeinfra.CustomResource
    {
        [Output("alpha")]
        public Output<Codeinfra.Example.OutputOnlyEnumType?> Alpha { get; private set; } = null!;
        ...
        [Output("gamma")]
        public Output<ImmutableDictionary<string, Codeinfra.Example.OutputOnlyEnumType>?> Gamma { get; private set; } = null!;

        [Output("qux")]
        public Output<Codeinfra.Example.RubberTreeVariety?> Qux { get; private set; } = null!;
    ...
    public sealed class TypeUsesArgs : global::Codeinfra.ResourceArgs
    {
        [Input("bar")]
        ...
        [Input("qux")]
        public Input<Codeinfra.Example.RubberTreeVariety>? Qux { get; set; }
