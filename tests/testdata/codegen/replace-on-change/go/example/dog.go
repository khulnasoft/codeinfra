...
type Dog struct {
	...
	Bone codeinfra.StringPtrOutput `codeinfra:"bone"`
}

// NewDog registers a new resource with the given unique name, arguments, and options.
func NewDog(ctx *codeinfra.Context,
	name string, args *DogArgs, opts ...codeinfra.ResourceOption) (*Dog, error) {
	if args == nil {
		args = &DogArgs{}
	}
...
func GetDog(ctx *codeinfra.Context,
	name string, id codeinfra.IDInput, state *DogState, opts ...codeinfra.ResourceOption) (*Dog, error) {
	var resource Dog
...
func (i *Dog) ToDogOutputWithContext(ctx context.Context) DogOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(DogOutput)
}
...
func (i DogArray) ToDogArrayOutputWithContext(ctx context.Context) DogArrayOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(DogArrayOutput)
}
...
func (i DogMap) ToDogMapOutputWithContext(ctx context.Context) DogMapOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(DogMapOutput)
}

type DogOutput struct{ *codeinfra.OutputState }
...
func (o DogOutput) Bone() codeinfra.StringPtrOutput {
	return o.ApplyT(func(v *Dog) codeinfra.StringPtrOutput { return v.Bone }).(codeinfra.StringPtrOutput)
}

type DogArrayOutput struct{ *codeinfra.OutputState }
...
func (o DogArrayOutput) Index(i codeinfra.IntInput) DogOutput {
	return codeinfra.All(o, i).ApplyT(func(vs []interface{}) *Dog {
		return vs[0].([]*Dog)[vs[1].(int)]
	}).(DogOutput)
}

type DogMapOutput struct{ *codeinfra.OutputState }
...
func (o DogMapOutput) MapIndex(k codeinfra.StringInput) DogOutput {
	return codeinfra.All(o, k).ApplyT(func(vs []interface{}) *Dog {
		return vs[0].(map[string]*Dog)[vs[1].(string)]
	}).(DogOutput)
}

func init() {
	codeinfra.RegisterOutputType(DogOutput{})
	codeinfra.RegisterOutputType(DogArrayOutput{})
	codeinfra.RegisterOutputType(DogMapOutput{})
}
