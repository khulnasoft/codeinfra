...
namespace Codeinfra.Example
{
    ...
    public partial class Cat : global::Codeinfra.CustomResource
    {
        [Output("foes")]
        ...
        [Output("other")]
        public Output<Codeinfra.Example.God?> Other { get; private set; } = null!;
    ...
    public sealed class CatArgs : global::Codeinfra.ResourceArgs
    {
        public CatArgs()
        {
        }
