...
namespace Codeinfra.Example
{
    ...
    public partial class God : global::Codeinfra.CustomResource
    {
        [Output("backwards")]
        public Output<Codeinfra.Example.Dog?> Backwards { get; private set; } = null!;
    ...
    public sealed class GodArgs : global::Codeinfra.ResourceArgs
    {
        public GodArgs()
        {
        }
