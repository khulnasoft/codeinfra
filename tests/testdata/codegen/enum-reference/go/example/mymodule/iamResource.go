...
import (
	...
	iam "github.com/khulnasoft/codeinfra-google-native/sdk/go/google/iam/v1"
...
func NewIamResource(ctx *codeinfra.Context,
	name string, args *IamResourceArgs, opts ...codeinfra.ResourceOption) (*IamResource, error) {
	if args == nil {
...
type iamResourceArgs struct {
	Config *iam.AuditConfig `codeinfra:"config"`
}
...
func (i *IamResource) ToIamResourceOutputWithContext(ctx context.Context) IamResourceOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(IamResourceOutput)
}

type IamResourceOutput struct{ *codeinfra.OutputState }
...
func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*IamResourceInput)(nil)).Elem(), &IamResource{})
	codeinfra.RegisterOutputType(IamResourceOutput{})
}
