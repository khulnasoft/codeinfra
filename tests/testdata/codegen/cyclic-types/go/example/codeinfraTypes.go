...
type AcyclicReferent struct {
	Bar  IndirectCycleS `codeinfra:"bar"`
	Baz  IndirectCycleT `codeinfra:"baz"`
	Foo4 DirectCycle    `codeinfra:"foo4"`
}
...
type AcyclicReferentArgs struct {
	Bar  IndirectCycleSInput `codeinfra:"bar"`
	Baz  IndirectCycleTInput `codeinfra:"baz"`
	Foo4 DirectCycleInput    `codeinfra:"foo4"`
}
...
func (i AcyclicReferentArgs) ToAcyclicReferentOutputWithContext(ctx context.Context) AcyclicReferentOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(AcyclicReferentOutput)
}

type AcyclicReferentOutput struct{ *codeinfra.OutputState }
...
type AcyclicSArgs struct {
	Foo5 codeinfra.StringInput `codeinfra:"foo5"`
}
...
func (i AcyclicSArgs) ToAcyclicSOutputWithContext(ctx context.Context) AcyclicSOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(AcyclicSOutput)
}

type AcyclicSOutput struct{ *codeinfra.OutputState }
...
func (o AcyclicSOutput) Foo5() codeinfra.StringOutput {
	return o.ApplyT(func(v AcyclicS) string { return v.Foo5 }).(codeinfra.StringOutput)
}

type AcyclicT struct {
	Foo6 AcyclicS `codeinfra:"foo6"`
}
...
type AcyclicTArgs struct {
	Foo6 AcyclicSInput `codeinfra:"foo6"`
}
...
func (i AcyclicTArgs) ToAcyclicTOutputWithContext(ctx context.Context) AcyclicTOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(AcyclicTOutput)
}

type AcyclicTOutput struct{ *codeinfra.OutputState }
...
type DirectCycleArgs struct {
	Foo DirectCyclePtrInput `codeinfra:"foo"`
}
...
func (i DirectCycleArgs) ToDirectCycleOutputWithContext(ctx context.Context) DirectCycleOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(DirectCycleOutput)
}
...
func (i DirectCycleArgs) ToDirectCyclePtrOutputWithContext(ctx context.Context) DirectCyclePtrOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(DirectCycleOutput).ToDirectCyclePtrOutputWithContext(ctx)
}
...
func (i *directCyclePtrType) ToDirectCyclePtrOutputWithContext(ctx context.Context) DirectCyclePtrOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(DirectCyclePtrOutput)
}

type DirectCycleOutput struct{ *codeinfra.OutputState }
...
type DirectCyclePtrOutput struct{ *codeinfra.OutputState }
...
type IndirectCycleS struct {
	Foo2 *IndirectCycleT `codeinfra:"foo2"`
}
...
type IndirectCycleSArgs struct {
	Foo2 IndirectCycleTPtrInput `codeinfra:"foo2"`
}
...
func (i IndirectCycleSArgs) ToIndirectCycleSOutputWithContext(ctx context.Context) IndirectCycleSOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(IndirectCycleSOutput)
}
...
func (i IndirectCycleSArgs) ToIndirectCycleSPtrOutputWithContext(ctx context.Context) IndirectCycleSPtrOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(IndirectCycleSOutput).ToIndirectCycleSPtrOutputWithContext(ctx)
}
...
func (i *indirectCycleSPtrType) ToIndirectCycleSPtrOutputWithContext(ctx context.Context) IndirectCycleSPtrOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(IndirectCycleSPtrOutput)
}

type IndirectCycleSOutput struct{ *codeinfra.OutputState }
...
type IndirectCycleSPtrOutput struct{ *codeinfra.OutputState }
...
type IndirectCycleT struct {
	Foo3 *IndirectCycleS `codeinfra:"foo3"`
}
...
type IndirectCycleTArgs struct {
	Foo3 IndirectCycleSPtrInput `codeinfra:"foo3"`
}
...
func (i IndirectCycleTArgs) ToIndirectCycleTOutputWithContext(ctx context.Context) IndirectCycleTOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(IndirectCycleTOutput)
}
...
func (i IndirectCycleTArgs) ToIndirectCycleTPtrOutputWithContext(ctx context.Context) IndirectCycleTPtrOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(IndirectCycleTOutput).ToIndirectCycleTPtrOutputWithContext(ctx)
}
...
func (i *indirectCycleTPtrType) ToIndirectCycleTPtrOutputWithContext(ctx context.Context) IndirectCycleTPtrOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(IndirectCycleTPtrOutput)
}

type IndirectCycleTOutput struct{ *codeinfra.OutputState }
...
type IndirectCycleTPtrOutput struct{ *codeinfra.OutputState }
...
func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*AcyclicReferentInput)(nil)).Elem(), AcyclicReferentArgs{})
	codeinfra.RegisterInputType(reflect.TypeOf((*AcyclicSInput)(nil)).Elem(), AcyclicSArgs{})
	codeinfra.RegisterInputType(reflect.TypeOf((*AcyclicTInput)(nil)).Elem(), AcyclicTArgs{})
	codeinfra.RegisterInputType(reflect.TypeOf((*DirectCycleInput)(nil)).Elem(), DirectCycleArgs{})
	codeinfra.RegisterInputType(reflect.TypeOf((*DirectCyclePtrInput)(nil)).Elem(), DirectCycleArgs{})
	codeinfra.RegisterInputType(reflect.TypeOf((*IndirectCycleSInput)(nil)).Elem(), IndirectCycleSArgs{})
	codeinfra.RegisterInputType(reflect.TypeOf((*IndirectCycleSPtrInput)(nil)).Elem(), IndirectCycleSArgs{})
	codeinfra.RegisterInputType(reflect.TypeOf((*IndirectCycleTInput)(nil)).Elem(), IndirectCycleTArgs{})
	codeinfra.RegisterInputType(reflect.TypeOf((*IndirectCycleTPtrInput)(nil)).Elem(), IndirectCycleTArgs{})
	codeinfra.RegisterOutputType(AcyclicReferentOutput{})
	codeinfra.RegisterOutputType(AcyclicSOutput{})
	codeinfra.RegisterOutputType(AcyclicTOutput{})
	codeinfra.RegisterOutputType(DirectCycleOutput{})
	codeinfra.RegisterOutputType(DirectCyclePtrOutput{})
	codeinfra.RegisterOutputType(IndirectCycleSOutput{})
	codeinfra.RegisterOutputType(IndirectCycleSPtrOutput{})
	codeinfra.RegisterOutputType(IndirectCycleTOutput{})
	codeinfra.RegisterOutputType(IndirectCycleTPtrOutput{})
}
