...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">Resource</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ResourceArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Codeinfra/Codeinfra.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></codeinfra-choosable>
</div>
...
example, err := mypkg.NewResource(ctx, "resourceResource", &mypkg.ResourceArgs{
	...
	Foo: codeinfra.String("string"),
	FooArray: codeinfra.StringArray{
		codeinfra.String("string"),
	},
	FooMap: codeinfra.StringMap{
...
<h4 id="config">
Config<codeinfra-choosable type="language" values="python,go" class="inline">, Config<wbr>Args</codeinfra-choosable>
</h4>
