...
codeinfra.runtime.registerResourceModule("legacy_names", "index", _module)
codeinfra.runtime.registerResourcePackage("legacy_names", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): codeinfra.ProviderResource => {
        if (type !== "codeinfra:providers:legacy_names") {
