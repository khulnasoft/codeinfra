...
func (i Enum_XYZMapArray) ToEnum_XYZMapArrayOutputWithContext(ctx context.Context) Enum_XYZMapArrayOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(Enum_XYZMapArrayOutput)
}
...
type Enum_XYZMapArrayOutput struct{ *codeinfra.OutputState }
...
func (o Enum_XYZMapArrayOutput) Index(i codeinfra.IntInput) Enum_XYZMapOutput {
	return codeinfra.All(o, i).ApplyT(func(vs []interface{}) map[string]Enum_XYZ {
		return vs[0].([]map[string]Enum_XYZ)[vs[1].(int)]
	}).(Enum_XYZMapOutput)
}

func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*Enum_XYZMapArrayInput)(nil)).Elem(), Enum_XYZMapArray{})
	codeinfra.RegisterOutputType(Enum_XYZMapArrayOutput{})
}
