...
namespace Codeinfra.Legacy_names
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Codeinfra.Legacy_names.version.txt");
    ...
    internal sealed class Legacy_namesResourceTypeAttribute : global::Codeinfra.ResourceTypeAttribute
    {
        public Legacy_namesResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
