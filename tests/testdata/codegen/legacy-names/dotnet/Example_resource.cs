...
namespace Codeinfra.Legacy_names
{
    ...
    public partial class Example_resource : global::Codeinfra.CustomResource
    {
        [Output("URL")]
        ...
        [Output("map_enum")]
        public Output<ImmutableArray<ImmutableDictionary<string, Codeinfra.Legacy_names.Enum_XYZ>>> Map_enum { get; private set; } = null!;
    ...
    public sealed class Example_resourceArgs : global::Codeinfra.ResourceArgs
    {
        [Input("map_enum")]
        private InputList<ImmutableDictionary<string, Codeinfra.Legacy_names.Enum_XYZ>>? _map_enum;
        public InputList<ImmutableDictionary<string, Codeinfra.Legacy_names.Enum_XYZ>> Map_enum
        {
            get => _map_enum ?? (_map_enum = new InputList<ImmutableDictionary<string, Codeinfra.Legacy_names.Enum_XYZ>>());
            set => _map_enum = value;
        }

        [Input("request_HTTP")]
        public Input<Codeinfra.Legacy_names.HTTP_module.Inputs.RequestArgs>? Request_HTTP { get; set; }
