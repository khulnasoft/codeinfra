...
export class ModuleResource extends codeinfra.CustomResource {
    ...
    /** @internal */
    public static readonly __codeinfraType = 'foobar::ModuleResource';
    ...
    public readonly optionalBool!: codeinfra.Output<boolean | undefined>;
...
export interface ModuleResourceArgs {
    optionalBool?: codeinfra.Input<boolean>;
    optionalConst?: codeinfra.Input<"val">;
    optionalEnum?: codeinfra.Input<enums.EnumThing>;
    optionalNumber?: codeinfra.Input<number>;
    optionalString?: codeinfra.Input<string>;
    ...
    requiredBool: codeinfra.Input<boolean>;
    requiredEnum: codeinfra.Input<enums.EnumThing>;
    requiredNumber: codeinfra.Input<number>;
    requiredString: codeinfra.Input<string>;
}
