...
namespace Codeinfra.FooBar
{
    ...
    public partial class ModuleResource : global::Codeinfra.CustomResource
    {
        [Output("optionalBool")]
    ...
    public sealed class ModuleResourceArgs : global::Codeinfra.ResourceArgs
    {
        [Input("optionalBool")]
        ...
        [Input("optionalEnum")]
        public Input<Codeinfra.FooBar.EnumThing>? OptionalEnum { get; set; }
        ...
        public Input<Codeinfra.FooBar.EnumThing> RequiredEnum { get; set; } = null!;
        ...
        public ModuleResourceArgs()
        {
            ...
            OptionalEnum = Codeinfra.FooBar.EnumThing.Eight;
            OptionalNumber = 42;
            ...
            RequiredBool = true;
            RequiredEnum = Codeinfra.FooBar.EnumThing.Four;
            RequiredNumber = 42;
