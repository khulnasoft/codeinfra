...
namespace Codeinfra.Mypkg
{
    ...
    public static class GetAmiIds
    {
        ...
        public static Task<GetAmiIdsResult> InvokeAsync(GetAmiIdsArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.InvokeAsync<GetAmiIdsResult>("mypkg::getAmiIds", args ?? new GetAmiIdsArgs(), options.WithDefaults());

        /// <summary>
        /// Taken from codeinfra-AWS to regress an issue
        /// </summary>
        public static Output<GetAmiIdsResult> Invoke(GetAmiIdsInvokeArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.Invoke<GetAmiIdsResult>("mypkg::getAmiIds", args ?? new GetAmiIdsInvokeArgs(), options.WithDefaults());
    ...
    public sealed class GetAmiIdsArgs : global::Codeinfra.InvokeArgs
    {
    ...
    public sealed class GetAmiIdsInvokeArgs : global::Codeinfra.InvokeArgs
    {
        [Input("executableUsers")]
