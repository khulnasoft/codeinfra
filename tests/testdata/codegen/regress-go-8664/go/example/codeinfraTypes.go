...
type ConditionalAccessPolicyConditions struct {
	ClientAppTypes []string `codeinfra:"clientAppTypes"`
}
...
type ConditionalAccessPolicyConditionsArgs struct {
	ClientAppTypes codeinfra.StringArrayInput `codeinfra:"clientAppTypes"`
}
...
func (i ConditionalAccessPolicyConditionsArgs) ToConditionalAccessPolicyConditionsOutputWithContext(ctx context.Context) ConditionalAccessPolicyConditionsOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ConditionalAccessPolicyConditionsOutput)
}
...
func (i ConditionalAccessPolicyConditionsArgs) ToConditionalAccessPolicyConditionsPtrOutputWithContext(ctx context.Context) ConditionalAccessPolicyConditionsPtrOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ConditionalAccessPolicyConditionsOutput).ToConditionalAccessPolicyConditionsPtrOutputWithContext(ctx)
}
...
func (i *conditionalAccessPolicyConditionsPtrType) ToConditionalAccessPolicyConditionsPtrOutputWithContext(ctx context.Context) ConditionalAccessPolicyConditionsPtrOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ConditionalAccessPolicyConditionsPtrOutput)
}

type ConditionalAccessPolicyConditionsOutput struct{ *codeinfra.OutputState }
...
func (o ConditionalAccessPolicyConditionsOutput) ClientAppTypes() codeinfra.StringArrayOutput {
	return o.ApplyT(func(v ConditionalAccessPolicyConditions) []string { return v.ClientAppTypes }).(codeinfra.StringArrayOutput)
}

type ConditionalAccessPolicyConditionsPtrOutput struct{ *codeinfra.OutputState }
...
func (o ConditionalAccessPolicyConditionsPtrOutput) ClientAppTypes() codeinfra.StringArrayOutput {
...
func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*ConditionalAccessPolicyConditionsInput)(nil)).Elem(), ConditionalAccessPolicyConditionsArgs{})
	codeinfra.RegisterInputType(reflect.TypeOf((*ConditionalAccessPolicyConditionsPtrInput)(nil)).Elem(), ConditionalAccessPolicyConditionsArgs{})
	codeinfra.RegisterOutputType(ConditionalAccessPolicyConditionsOutput{})
	codeinfra.RegisterOutputType(ConditionalAccessPolicyConditionsPtrOutput{})
}
