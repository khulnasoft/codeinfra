...
from codeinfra_gcp.compute.instance import Instance, InstanceArgs
from codeinfra_gcp.compute.instancebootdisk import InstanceBootDiskArgs
from codeinfra_gcp.compute.instancebootdiskinitializeparams import InstanceBootDiskInitializeParamsArgs
