...
func (i ContainerArgs) ToOutput(ctx context.Context) codeinfrax.Output[Container] {
...
func (i *containerPtrType) ToOutput(ctx context.Context) codeinfrax.Output[*Container] {
	return codeinfrax.Output[*Container]{
...
func (o ContainerPtrOutput) ToOutput(ctx context.Context) codeinfrax.Output[*Container] {
	return codeinfrax.Output[*Container]{
		OutputState: o.OutputState,
	}
}
