...
func (i *Nursery) ToNurseryOutputWithContext(ctx context.Context) NurseryOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(NurseryOutput)
}

func (i *Nursery) ToOutput(ctx context.Context) codeinfrax.Output[*Nursery] {
...
func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*NurseryInput)(nil)).Elem(), &Nursery{})
