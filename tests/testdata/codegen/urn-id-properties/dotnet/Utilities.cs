...
namespace Codeinfra.Urnid
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Codeinfra.Urnid.version.txt");
    ...
    internal sealed class UrnidResourceTypeAttribute : global::Codeinfra.ResourceTypeAttribute
    {
        public UrnidResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
