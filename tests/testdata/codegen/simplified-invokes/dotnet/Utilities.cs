...
namespace Codeinfra.Std
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Codeinfra.Std.version.txt");
    ...
    internal sealed class StdResourceTypeAttribute : global::Codeinfra.ResourceTypeAttribute
    {
        public StdResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
