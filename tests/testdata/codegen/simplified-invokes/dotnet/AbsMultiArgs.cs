...
namespace Codeinfra.Std
{
    public static class AbsMultiArgs
    {
        ...
        public static async Task<AbsMultiArgsResult> InvokeAsync(double a, double? b = null, InvokeOptions? invokeOptions = null)
        {
            ...
            return await global::Codeinfra.Deployment.Instance.InvokeAsync<AbsMultiArgsResult>("std:index:AbsMultiArgs", args, invokeOptions.WithDefaults());
        }
        ...
        public static Output<AbsMultiArgsResult> Invoke(Input<double> a, Input<double?>? b = null, InvokeOptions? invokeOptions = null)
        {
            ...
            builder["b"] = b;
            var args = new global::Codeinfra.DictionaryInvokeArgs(builder.ToImmutableDictionary());
            return global::Codeinfra.Deployment.Instance.Invoke<AbsMultiArgsResult>("std:index:AbsMultiArgs", args, invokeOptions.WithDefaults());
        }
    }
