...
namespace Codeinfra.Std
{
    public static class AbsReducedOutput
    {
        ...
        public static Task<double> InvokeAsync(AbsReducedOutputArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.InvokeSingleAsync<double>("std:index:AbsReducedOutput", args ?? new AbsReducedOutputArgs(), options.WithDefaults());
        ...
        public static Output<double> Invoke(AbsReducedOutputInvokeArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.InvokeSingle<double>("std:index:AbsReducedOutput", args ?? new AbsReducedOutputInvokeArgs(), options.WithDefaults());
    ...
    public sealed class AbsReducedOutputArgs : global::Codeinfra.InvokeArgs
    {
    ...
    public sealed class AbsReducedOutputInvokeArgs : global::Codeinfra.InvokeArgs
    {
        [Input("a", required: true)]
