...
namespace Codeinfra.Std
{
    public static class Abs
    {
        ...
        public static Task<AbsResult> InvokeAsync(AbsArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.InvokeAsync<AbsResult>("std:index:Abs", args ?? new AbsArgs(), options.WithDefaults());
        ...
        public static Output<AbsResult> Invoke(AbsInvokeArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.Invoke<AbsResult>("std:index:Abs", args ?? new AbsInvokeArgs(), options.WithDefaults());
    ...
    public sealed class AbsArgs : global::Codeinfra.InvokeArgs
    {
    ...
    public sealed class AbsInvokeArgs : global::Codeinfra.InvokeArgs
    {
        [Input("a", required: true)]
