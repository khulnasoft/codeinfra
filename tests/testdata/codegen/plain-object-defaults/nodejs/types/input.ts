...
export function helmReleaseSettingsProvideDefaults(val: HelmReleaseSettings): HelmReleaseSettings {
    return {
        ...val,
        driver: (val.driver) ?? (utilities.getEnv("CODEINFRA_K8S_HELM_DRIVER") || "secret"),
        pluginsPath: (val.pluginsPath) ?? utilities.getEnv("CODEINFRA_K8S_HELM_PLUGINS_PATH"),
    };
}
...
export interface HelmReleaseSettingsArgs {
     ...
     * The backend storage driver for Helm. Values are: configmap, secret, memory, sql.
     */
    driver?: codeinfra.Input<string>;
    /**
     * The path to the helm plugins directory.
     */
    pluginsPath?: codeinfra.Input<string>;
    /**
     * to test required args
     */
    requiredArg: codeinfra.Input<string>;
}
/**
...
export interface KubeClientSettingsArgs {
     ...
     */
    burst?: codeinfra.Input<number>;
    /**
     * Maximum queries per second (QPS) to the API server from this client. Default value is 5.
     */
    qps?: codeinfra.Input<number>;
    recTest?: codeinfra.Input<inputs.KubeClientSettingsArgs>;
}
/**
...
export function kubeClientSettingsArgsProvideDefaults(val: KubeClientSettingsArgs): KubeClientSettingsArgs {
    return {
        ...val,
        burst: (val.burst) ?? utilities.getEnvNumber("CODEINFRA_K8S_CLIENT_BURST"),
        qps: (val.qps) ?? utilities.getEnvNumber("CODEINFRA_K8S_CLIENT_QPS"),
        recTest: (val.recTest ? codeinfra.output(val.recTest).apply(inputs.kubeClientSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface LayeredTypeArgs {
     ...
     */
    answer?: codeinfra.Input<number>;
    other: codeinfra.Input<inputs.HelmReleaseSettingsArgs>;
    /**
     ...
     */
    question?: codeinfra.Input<string>;
    recursive?: codeinfra.Input<inputs.LayeredTypeArgs>;
    /**
     * To ask and answer
     */
    thinker: codeinfra.Input<string>;
}
/**
...
export function layeredTypeArgsProvideDefaults(val: LayeredTypeArgs): LayeredTypeArgs {
    return {
        ...
        other: codeinfra.output(val.other).apply(inputs.helmReleaseSettingsArgsProvideDefaults),
        plainOther: (val.plainOther ? inputs.helmReleaseSettingsArgsProvideDefaults(val.plainOther) : undefined),
        question: (val.question) ?? (utilities.getEnv("CODEINFRA_THE_QUESTION") || "<unknown>"),
        recursive: (val.recursive ? codeinfra.output(val.recursive).apply(inputs.layeredTypeArgsProvideDefaults) : undefined),
...
export interface TypArgs {
    mod1?: codeinfra.Input<inputs.mod1.TypArgs>;
    mod2?: codeinfra.Input<inputs.mod2.TypArgs>;
    val?: codeinfra.Input<string>;
}
/**
...
export function typArgsProvideDefaults(val: TypArgs): TypArgs {
    return {
        ...val,
        mod1: (val.mod1 ? codeinfra.output(val.mod1).apply(inputs.mod1.typArgsProvideDefaults) : undefined),
        mod2: (val.mod2 ? codeinfra.output(val.mod2).apply(inputs.mod2.typArgsProvideDefaults) : undefined),
...
export namespace mod1 {
    ...
    export function typArgsProvideDefaults(val: TypArgs): TypArgs {
        return {
            ...val,
            val: (val.val) ?? (utilities.getEnv("CODEINFRA_EXAMPLE_MOD1_DEFAULT") || "mod1"),
        };
    }
}
