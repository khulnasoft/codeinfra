...
func NewModuleTest(ctx *codeinfra.Context,
	name string, args *ModuleTestArgs, opts ...codeinfra.ResourceOption) (*ModuleTest, error) {
	if args == nil {
		args = &ModuleTestArgs{}
	}
...
func GetModuleTest(ctx *codeinfra.Context,
	name string, id codeinfra.IDInput, state *ModuleTestState, opts ...codeinfra.ResourceOption) (*ModuleTest, error) {
	var resource ModuleTest
...
func (i *ModuleTest) ToModuleTestOutputWithContext(ctx context.Context) ModuleTestOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ModuleTestOutput)
}

type ModuleTestOutput struct{ *codeinfra.OutputState }
...
func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*ModuleTestInput)(nil)).Elem(), &ModuleTest{})
	codeinfra.RegisterOutputType(ModuleTestOutput{})
}
