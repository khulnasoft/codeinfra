...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">Foo</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">FooArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/codeinfra/codeinfra/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">Foo</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">FooArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Codeinfra/Codeinfra.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></codeinfra-choosable>
</div>
...
Burst: codeinfra.Int(0),
Qps: codeinfra.Float64(0),
RecTest: codeinfra.Any(kubeClientSettings),
},
Argument: "string",
KubeClientSettings: codeinfra.Any(kubeClientSettings),
Settings: &example.LayeredTypeArgs{
Other: &example.HelmReleaseSettingsArgs{
RequiredArg: codeinfra.String("string"),
Driver: codeinfra.String("string"),
PluginsPath: codeinfra.String("string"),
},
Thinker: codeinfra.String("string"),
Answer: codeinfra.Float64(0),
PlainOther: interface{}{
RequiredArg: codeinfra.String("string"),
Driver: codeinfra.String("string"),
PluginsPath: codeinfra.String("string"),
},
Question: codeinfra.String("string"),
Recursive: codeinfra.Any(layeredType),
},
})
```
...
Helm<wbr>Release<wbr>Settings<codeinfra-choosable type="language" values="python,go" class="inline">, Helm<wbr>Release<wbr>Settings<wbr>Args</codeinfra-choosable>
</h4>
...
Kube<wbr>Client<wbr>Settings<codeinfra-choosable type="language" values="python,go" class="inline">, Kube<wbr>Client<wbr>Settings<wbr>Args</codeinfra-choosable>
</h4>
...
<h4 id="layeredtype">
Layered<wbr>Type<codeinfra-choosable type="language" values="python,go" class="inline">, Layered<wbr>Type<wbr>Args</codeinfra-choosable>
</h4>
