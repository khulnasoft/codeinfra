...
codeinfra.runtime.registerResourceModule("registrygeoreplication", "index", _module)
codeinfra.runtime.registerResourcePackage("registrygeoreplication", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): codeinfra.ProviderResource => {
        if (type !== "codeinfra:providers:registrygeoreplication") {
