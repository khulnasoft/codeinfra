...
namespace Codeinfra.Example
{
    ...
    public partial class Foo : global::Codeinfra.ComponentResource
    {
        ...
        public global::Codeinfra.Output<string> GetKubeconfig(FooGetKubeconfigArgs? args = null)
            => global::Codeinfra.Deployment.Instance.Call<FooGetKubeconfigResult>("example::Foo/getKubeconfig", args ?? new FooGetKubeconfigArgs(), this).Apply(v => v.Kubeconfig);
    }
    ...
    /// </summary>
    public sealed class FooGetKubeconfigArgs : global::Codeinfra.CallArgs
    {
        [Input("profileName")]
