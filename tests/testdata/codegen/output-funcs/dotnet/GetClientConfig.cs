...
namespace Codeinfra.Mypkg
{
    public static class GetClientConfig
    {
        ...
        public static Task<GetClientConfigResult> InvokeAsync(InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.InvokeAsync<GetClientConfigResult>("mypkg::getClientConfig", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Failing example taken from azure-native. Original doc: Use this function to access the current configuration of the native Azure provider.
        /// </summary>
        public static Output<GetClientConfigResult> Invoke(InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.Invoke<GetClientConfigResult>("mypkg::getClientConfig", InvokeArgs.Empty, options.WithDefaults());
