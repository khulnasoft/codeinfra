...
namespace Codeinfra.Mypkg
{
    public static class FuncWithConstInput
    {
        ...
        public static Task InvokeAsync(FuncWithConstInputArgs? args = null, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.InvokeAsync("mypkg::funcWithConstInput", args ?? new FuncWithConstInputArgs(), options.WithDefaults());
    }


    public sealed class FuncWithConstInputArgs : global::Codeinfra.InvokeArgs
    {
        [Input("plainInput")]
