...
namespace Codeinfra.Mypkg
{
    public static class FuncWithDictParam
    {
        ...
        public static Task<FuncWithDictParamResult> InvokeAsync(FuncWithDictParamArgs? args = null, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.InvokeAsync<FuncWithDictParamResult>("mypkg::funcWithDictParam", args ?? new FuncWithDictParamArgs(), options.WithDefaults());

        /// <summary>
        /// Check codegen of functions with a Dict&lt;str,str&gt; parameter.
        /// </summary>
        public static Output<FuncWithDictParamResult> Invoke(FuncWithDictParamInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.Invoke<FuncWithDictParamResult>("mypkg::funcWithDictParam", args ?? new FuncWithDictParamInvokeArgs(), options.WithDefaults());
    ...
    public sealed class FuncWithDictParamArgs : global::Codeinfra.InvokeArgs
    {
        [Input("a")]
    ...
    public sealed class FuncWithDictParamInvokeArgs : global::Codeinfra.InvokeArgs
    {
        [Input("a")]
