...
namespace Codeinfra.Mypkg
{
    public static class FuncWithDefaultValue
    {
        ...
        public static Task<FuncWithDefaultValueResult> InvokeAsync(FuncWithDefaultValueArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.InvokeAsync<FuncWithDefaultValueResult>("mypkg::funcWithDefaultValue", args ?? new FuncWithDefaultValueArgs(), options.WithDefaults());

        /// <summary>
        /// Check codegen of functions with default values.
        /// </summary>
        public static Output<FuncWithDefaultValueResult> Invoke(FuncWithDefaultValueInvokeArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.Invoke<FuncWithDefaultValueResult>("mypkg::funcWithDefaultValue", args ?? new FuncWithDefaultValueInvokeArgs(), options.WithDefaults());
    ...
    public sealed class FuncWithDefaultValueArgs : global::Codeinfra.InvokeArgs
    {
    ...
    public sealed class FuncWithDefaultValueInvokeArgs : global::Codeinfra.InvokeArgs
    {
        [Input("a", required: true)]
