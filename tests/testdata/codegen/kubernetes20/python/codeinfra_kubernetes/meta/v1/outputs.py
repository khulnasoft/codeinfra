...
class ListMeta(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            codeinfra.log.warn(f"Key '{key}' not found in ListMeta. Access the value via the '{suggest}' property getter instead.")
...
class ManagedFieldsEntry(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            codeinfra.log.warn(f"Key '{key}' not found in ManagedFieldsEntry. Access the value via the '{suggest}' property getter instead.")
...
class ObjectMeta(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            codeinfra.log.warn(f"Key '{key}' not found in ObjectMeta. Access the value via the '{suggest}' property getter instead.")
...
class OwnerReference(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            codeinfra.log.warn(f"Key '{key}' not found in OwnerReference. Access the value via the '{suggest}' property getter instead.")
