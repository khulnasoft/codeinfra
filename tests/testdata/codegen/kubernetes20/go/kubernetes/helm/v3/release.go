...
type Release struct {
	...
	Chart codeinfra.StringOutput `codeinfra:"chart"`
	// List of assets (raw yaml files). Content is read and merged with values (with values taking precedence).
	ValueYamlFiles codeinfra.AssetOrArchiveArrayOutput `codeinfra:"valueYamlFiles"`
	// Custom values set for the release.
	Values codeinfra.MapOutput `codeinfra:"values"`
}

// NewRelease registers a new resource with the given unique name, arguments, and options.
func NewRelease(ctx *codeinfra.Context,
	name string, args *ReleaseArgs, opts ...codeinfra.ResourceOption) (*Release, error) {
	if args == nil {
...
func GetRelease(ctx *codeinfra.Context,
	name string, id codeinfra.IDInput, state *ReleaseState, opts ...codeinfra.ResourceOption) (*Release, error) {
	var resource Release
...
type releaseArgs struct {
	// Chart name to be installed. A path may be used.
	Chart string `codeinfra:"chart"`
	// List of assets (raw yaml files). Content is read and merged with values.
	ValueYamlFiles []codeinfra.AssetOrArchive `codeinfra:"valueYamlFiles"`
	// Custom values set for the release.
	Values map[string]interface{} `codeinfra:"values"`
}

// The set of arguments for constructing a Release resource.
type ReleaseArgs struct {
	// Chart name to be installed. A path may be used.
	Chart codeinfra.StringInput
	// List of assets (raw yaml files). Content is read and merged with values.
	ValueYamlFiles codeinfra.AssetOrArchiveArrayInput
	// Custom values set for the release.
	Values codeinfra.MapInput
}
...
func (i *Release) ToReleaseOutputWithContext(ctx context.Context) ReleaseOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ReleaseOutput)
}
...
func (i ReleaseArray) ToReleaseArrayOutputWithContext(ctx context.Context) ReleaseArrayOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ReleaseArrayOutput)
}
...
func (i ReleaseMap) ToReleaseMapOutputWithContext(ctx context.Context) ReleaseMapOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ReleaseMapOutput)
}

type ReleaseOutput struct{ *codeinfra.OutputState }
...
// Chart name to be installed. A path may be used.
func (o ReleaseOutput) Chart() codeinfra.StringOutput {
	return o.ApplyT(func(v *Release) codeinfra.StringOutput { return v.Chart }).(codeinfra.StringOutput)
}

// List of assets (raw yaml files). Content is read and merged with values (with values taking precedence).
func (o ReleaseOutput) ValueYamlFiles() codeinfra.AssetOrArchiveArrayOutput {
	return o.ApplyT(func(v *Release) codeinfra.AssetOrArchiveArrayOutput { return v.ValueYamlFiles }).(codeinfra.AssetOrArchiveArrayOutput)
}

// Custom values set for the release.
func (o ReleaseOutput) Values() codeinfra.MapOutput {
	return o.ApplyT(func(v *Release) codeinfra.MapOutput { return v.Values }).(codeinfra.MapOutput)
}

type ReleaseArrayOutput struct{ *codeinfra.OutputState }
...
func (o ReleaseArrayOutput) Index(i codeinfra.IntInput) ReleaseOutput {
	return codeinfra.All(o, i).ApplyT(func(vs []interface{}) *Release {
		return vs[0].([]*Release)[vs[1].(int)]
	}).(ReleaseOutput)
}

type ReleaseMapOutput struct{ *codeinfra.OutputState }
...
func (o ReleaseMapOutput) MapIndex(k codeinfra.StringInput) ReleaseOutput {
	return codeinfra.All(o, k).ApplyT(func(vs []interface{}) *Release {
		return vs[0].(map[string]*Release)[vs[1].(string)]
	}).(ReleaseOutput)
}

func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*ReleaseInput)(nil)).Elem(), &Release{})
	codeinfra.RegisterInputType(reflect.TypeOf((*ReleaseArrayInput)(nil)).Elem(), ReleaseArray{})
	codeinfra.RegisterInputType(reflect.TypeOf((*ReleaseMapInput)(nil)).Elem(), ReleaseMap{})
	codeinfra.RegisterOutputType(ReleaseOutput{})
	codeinfra.RegisterOutputType(ReleaseArrayOutput{})
	codeinfra.RegisterOutputType(ReleaseMapOutput{})
}
