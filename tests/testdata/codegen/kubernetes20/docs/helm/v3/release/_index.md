...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">Release</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ReleaseOpts</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/codeinfra/codeinfra/#ComponentResourceOptions">ComponentResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">Release</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">value_yaml_files</span><span class="p">:</span> <span class="nx">Optional[Sequence[Union[codeinfra.Asset, codeinfra.Archive]]]</span> = None<span class="p">,</span>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewRelease</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ReleaseArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Release</span>, error)</span></code></pre></div>
</div></codeinfra-choosable>
</div>

<div>
<codeinfra-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">Release</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ReleaseArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Codeinfra/Codeinfra.ComponentResourceOptions.html">ComponentResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></codeinfra-choosable>
</div>
...
example, err := helmv3.NewRelease(ctx, "releaseResource", &helmv3.ReleaseArgs{
	Chart: codeinfra.String("string"),
	ValueYamlFiles: codeinfra.AssetOrArchiveArray{
		codeinfra.NewStringAsset("content"),
	},
	Values: codeinfra.Map{
		"string": codeinfra.Any("any"),
	},
})
```
...
release_resource = kubernetes.helm.v3.Release("releaseResource",
    chart="string",
    value_yaml_files=[codeinfra.StringAsset("content")],
    values={
        "string": "any",
    })
```
...
const releaseResource = new kubernetes.helm.v3.Release("releaseResource", {
    chart: "string",
    valueYamlFiles: [new codeinfra.asset.StringAsset("content")],
    values: {
        string: "any",
    },
});
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#value_yaml_files_python" style="color: inherit; text-decoration: inherit;">value_<wbr>yaml_<wbr>files</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Sequence[Union[codeinfra.<wbr>Asset, codeinfra.<wbr>Archive]]</span>
    </dt>
    <dd>List of assets (raw yaml files). Content is read and merged with values.</dd><dt class="property-optional"
            title="Optional">
