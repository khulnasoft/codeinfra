...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">ConfigMapList</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ConfigMapList</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/codeinfra/codeinfra/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewConfigMapList</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ConfigMapListArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ConfigMapList</span>, error)</span></code></pre></div>
</div></codeinfra-choosable>
</div>

<div>
<codeinfra-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">ConfigMapList</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ConfigMapListArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Codeinfra/Codeinfra.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></codeinfra-choosable>
</div>
...
example, err := corev1.NewConfigMapList(ctx, "configMapListResource", &corev1.ConfigMapListArgs{
	Items: corev1.ConfigMapTypeArray{
		&corev1.ConfigMapTypeArgs{
			...
			BinaryData: codeinfra.StringMap{
				"string": codeinfra.String("string"),
			},
			Data: codeinfra.StringMap{
				"string": codeinfra.String("string"),
			},
			Immutable: codeinfra.Bool(false),
			Kind:      codeinfra.String("ConfigMap"),
	...
	Metadata: &metav1.ListMetaArgs{
		Continue:           codeinfra.String("string"),
		RemainingItemCount: codeinfra.Int(0),
		ResourceVersion:    codeinfra.String("string"),
		SelfLink:           codeinfra.String("string"),
	},
})
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metadata_csharp" style="color: inherit; text-decoration: inherit;">Metadata</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#listmeta">Codeinfra.<wbr>Kubernetes.<wbr>Meta.<wbr>V1.<wbr>Inputs.<wbr>List<wbr>Meta</a></span>
    </dt>
...
<h4 id="configmap">
Config<wbr>Map<codeinfra-choosable type="language" values="python,go" class="inline">, Config<wbr>Map<wbr>Args</codeinfra-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metadata_csharp" style="color: inherit; text-decoration: inherit;">Metadata</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#objectmeta">Codeinfra.<wbr>Kubernetes.<wbr>Meta.<wbr>V1.<wbr>Inputs.<wbr>Object<wbr>Meta</a></span>
    </dt>
...
<h4 id="listmeta">
List<wbr>Meta<codeinfra-choosable type="language" values="python,go" class="inline">, List<wbr>Meta<wbr>Args</codeinfra-choosable>
</h4>
...
Managed<wbr>Fields<wbr>Entry<codeinfra-choosable type="language" values="python,go" class="inline">, Managed<wbr>Fields<wbr>Entry<wbr>Args</codeinfra-choosable>
</h4>
...
<h4 id="objectmeta">
Object<wbr>Meta<codeinfra-choosable type="language" values="python,go" class="inline">, Object<wbr>Meta<wbr>Args</codeinfra-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#managedfields_csharp" style="color: inherit; text-decoration: inherit;">Managed<wbr>Fields</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#managedfieldsentry">List&lt;Codeinfra.<wbr>Kubernetes.<wbr>Meta.<wbr>V1.<wbr>Inputs.<wbr>Managed<wbr>Fields<wbr>Entry&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ownerreferences_csharp" style="color: inherit; text-decoration: inherit;">Owner<wbr>References</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ownerreference">List&lt;Codeinfra.<wbr>Kubernetes.<wbr>Meta.<wbr>V1.<wbr>Inputs.<wbr>Owner<wbr>Reference&gt;</a></span>
    </dt>
...
Owner<wbr>Reference<codeinfra-choosable type="language" values="python,go" class="inline">, Owner<wbr>Reference<wbr>Args</codeinfra-choosable>
</h4>
