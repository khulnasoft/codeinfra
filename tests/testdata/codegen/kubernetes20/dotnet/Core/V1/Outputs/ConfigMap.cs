...
namespace Codeinfra.Kubernetes.Types.Outputs.Core.V1
{
    ...
    public sealed class ConfigMap
    {
        ...
        /// </summary>
        public readonly Codeinfra.Kubernetes.Types.Outputs.Meta.V1.ObjectMeta Metadata;
        ...
        private ConfigMap(
            ...
            Codeinfra.Kubernetes.Types.Outputs.Meta.V1.ObjectMeta metadata)
        {
