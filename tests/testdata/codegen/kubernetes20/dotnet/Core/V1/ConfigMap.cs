...
namespace Codeinfra.Kubernetes.Core.V1
{
    ...
    public partial class ConfigMap : KubernetesResource
    {
        ...
        /// </summary>
        [Output("metadata")]
        public Output<Codeinfra.Kubernetes.Types.Outputs.Meta.V1.ObjectMeta> Metadata { get; private set; } = null!;
        ...
        public ConfigMap(string name, Codeinfra.Kubernetes.Types.Inputs.Core.V1.ConfigMapArgs? args = null, CustomResourceOptions? options = null)
        ...
        private static Codeinfra.Kubernetes.Types.Inputs.Core.V1.ConfigMapArgs? MakeArgs(Codeinfra.Kubernetes.Types.Inputs.Core.V1.ConfigMapArgs? args)
        {
            args ??= new Codeinfra.Kubernetes.Types.Inputs.Core.V1.ConfigMapArgs();
            args.ApiVersion = "v1";
            args.Kind = "ConfigMap";
            return args;
        }
...
namespace Codeinfra.Kubernetes.Types.Inputs.Core.V1
{
    ...
    public class ConfigMapArgs : global::Codeinfra.ResourceArgs
    {
        /// <summary>
        /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        /// </summary>
