...
namespace Codeinfra.Kubernetes.Yaml.V2
{
    /// <summary>
    /// A non-overlay component resource.
    /// </summary>
    [KubernetesResourceType("kubernetes:yaml/v2:ConfigGroup")]
    public partial class ConfigGroup : global::Codeinfra.ComponentResource
    {
        /// <summary>
        ...
        public ConfigGroup(string name, Codeinfra.Kubernetes.Types.Inputs.Yaml.V2.ConfigGroupArgs? args = null, ComponentResourceOptions? options = null)
            : base("kubernetes:yaml/v2:ConfigGroup", name, args ?? new Codeinfra.Kubernetes.Types.Inputs.Yaml.V2.ConfigGroupArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
...
namespace Codeinfra.Kubernetes.Types.Inputs.Yaml.V2
{

    public class ConfigGroupArgs : global::Codeinfra.ResourceArgs
    {
        /// <summary>
