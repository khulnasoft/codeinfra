...
namespace Codeinfra.Kubernetes.Helm.V3
{
    /// <summary>
    ...
    public partial class Release : KubernetesResource
    {
        ...
        public Release(string name, Codeinfra.Kubernetes.Types.Inputs.Helm.V3.ReleaseArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:helm.sh/v3:Release", name, args ?? new Codeinfra.Kubernetes.Types.Inputs.Helm.V3.ReleaseArgs(), MakeResourceOptions(options, ""))
        {
        }
...
namespace Codeinfra.Kubernetes.Types.Inputs.Helm.V3
{

    public class ReleaseArgs : global::Codeinfra.ResourceArgs
    {
        /// <summary>
        /// Chart name to be installed. A path may be used.
        /// </summary>
