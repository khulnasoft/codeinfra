...
namespace Codeinfra.Mypkg
{
    public static class FuncWithSecrets
    {
        public static Task<FuncWithSecretsResult> InvokeAsync(FuncWithSecretsArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.InvokeAsync<FuncWithSecretsResult>("mypkg::funcWithSecrets", args ?? new FuncWithSecretsArgs(), options.WithDefaults());

        public static Output<FuncWithSecretsResult> Invoke(FuncWithSecretsInvokeArgs args, InvokeOptions? options = null)
            => global::Codeinfra.Deployment.Instance.Invoke<FuncWithSecretsResult>("mypkg::funcWithSecrets", args ?? new FuncWithSecretsInvokeArgs(), options.WithDefaults());
    ...
    public sealed class FuncWithSecretsArgs : global::Codeinfra.InvokeArgs
    {
    ...
    public sealed class FuncWithSecretsInvokeArgs : global::Codeinfra.InvokeArgs
    {
        [Input("cryptoKey", required: true)]
