...
func NewBarResource(ctx *codeinfra.Context,
	name string, args *BarResourceArgs, opts ...codeinfra.ResourceOption) (*BarResource, error) {
	if args == nil {
...
func (i *BarResource) ToBarResourceOutputWithContext(ctx context.Context) BarResourceOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(BarResourceOutput)
}

type BarResourceOutput struct{ *codeinfra.OutputState }
...
func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*BarResourceInput)(nil)).Elem(), &BarResource{})
	codeinfra.RegisterOutputType(BarResourceOutput{})
}
