...
func NewFooResource(ctx *codeinfra.Context,
	name string, args *FooResourceArgs, opts ...codeinfra.ResourceOption) (*FooResource, error) {
	if args == nil {
...
func (i *FooResource) ToFooResourceOutputWithContext(ctx context.Context) FooResourceOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(FooResourceOutput)
}

type FooResourceOutput struct{ *codeinfra.OutputState }
...
func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*FooResourceInput)(nil)).Elem(), &FooResource{})
	codeinfra.RegisterOutputType(FooResourceOutput{})
}
