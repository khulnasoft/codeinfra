...
func NewConsumer(ctx *codeinfra.Context,
	name string, args *ConsumerArgs, opts ...codeinfra.ResourceOption) (*Consumer, error) {
	if args == nil {
		args = &ConsumerArgs{}
	}
...
func GetConsumer(ctx *codeinfra.Context,
	name string, id codeinfra.IDInput, state *ConsumerState, opts ...codeinfra.ResourceOption) (*Consumer, error) {
	var resource Consumer
...
type consumerArgs struct {
	Typ  map[string]*SomeType `codeinfra:"typ"`
	TypM *SomeTypeMap         `codeinfra:"typM"`
}
...
func (i *Consumer) ToConsumerOutputWithContext(ctx context.Context) ConsumerOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ConsumerOutput)
}
...
func (i ConsumerArray) ToConsumerArrayOutputWithContext(ctx context.Context) ConsumerArrayOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ConsumerArrayOutput)
}
...
func (i ConsumerMap) ToConsumerMapOutputWithContext(ctx context.Context) ConsumerMapOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ConsumerMapOutput)
}

type ConsumerOutput struct{ *codeinfra.OutputState }
...
type ConsumerArrayOutput struct{ *codeinfra.OutputState }
...
func (o ConsumerArrayOutput) Index(i codeinfra.IntInput) ConsumerOutput {
	return codeinfra.All(o, i).ApplyT(func(vs []interface{}) *Consumer {
		return vs[0].([]*Consumer)[vs[1].(int)]
	}).(ConsumerOutput)
}

type ConsumerMapOutput struct{ *codeinfra.OutputState }
...
func (o ConsumerMapOutput) MapIndex(k codeinfra.StringInput) ConsumerOutput {
	return codeinfra.All(o, k).ApplyT(func(vs []interface{}) *Consumer {
		return vs[0].(map[string]*Consumer)[vs[1].(string)]
	}).(ConsumerOutput)
}

func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*ConsumerInput)(nil)).Elem(), &Consumer{})
	codeinfra.RegisterInputType(reflect.TypeOf((*ConsumerArrayInput)(nil)).Elem(), ConsumerArray{})
	codeinfra.RegisterInputType(reflect.TypeOf((*ConsumerMapInput)(nil)).Elem(), ConsumerMap{})
	codeinfra.RegisterOutputType(ConsumerOutput{})
	codeinfra.RegisterOutputType(ConsumerArrayOutput{})
	codeinfra.RegisterOutputType(ConsumerMapOutput{})
}
