...
func NewSomeTypeMapResource(ctx *codeinfra.Context,
	name string, args *SomeTypeMapResourceArgs, opts ...codeinfra.ResourceOption) (*SomeTypeMapResource, error) {
	if args == nil {
...
func GetSomeTypeMapResource(ctx *codeinfra.Context,
	name string, id codeinfra.IDInput, state *SomeTypeMapResourceState, opts ...codeinfra.ResourceOption) (*SomeTypeMapResource, error) {
	var resource SomeTypeMapResource
...
func (i *SomeTypeMapResource) ToSomeTypeMapResourceOutputWithContext(ctx context.Context) SomeTypeMapResourceOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(SomeTypeMapResourceOutput)
}
...
func (i SomeTypeMapResourceArray) ToSomeTypeMapResourceArrayOutputWithContext(ctx context.Context) SomeTypeMapResourceArrayOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(SomeTypeMapResourceArrayOutput)
}
...
func (i SomeTypeMapResourceMap) ToSomeTypeMapResourceMapOutputWithContext(ctx context.Context) SomeTypeMapResourceMapOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(SomeTypeMapResourceMapOutput)
}

type SomeTypeMapResourceOutput struct{ *codeinfra.OutputState }
...
type SomeTypeMapResourceArrayOutput struct{ *codeinfra.OutputState }
...
func (o SomeTypeMapResourceArrayOutput) Index(i codeinfra.IntInput) SomeTypeMapResourceOutput {
	return codeinfra.All(o, i).ApplyT(func(vs []interface{}) *SomeTypeMapResource {
		return vs[0].([]*SomeTypeMapResource)[vs[1].(int)]
	}).(SomeTypeMapResourceOutput)
}

type SomeTypeMapResourceMapOutput struct{ *codeinfra.OutputState }
...
func (o SomeTypeMapResourceMapOutput) MapIndex(k codeinfra.StringInput) SomeTypeMapResourceOutput {
	return codeinfra.All(o, k).ApplyT(func(vs []interface{}) *SomeTypeMapResource {
		return vs[0].(map[string]*SomeTypeMapResource)[vs[1].(string)]
	}).(SomeTypeMapResourceOutput)
}

func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*SomeTypeMapResourceInput)(nil)).Elem(), &SomeTypeMapResource{})
	codeinfra.RegisterInputType(reflect.TypeOf((*SomeTypeMapResourceArrayInput)(nil)).Elem(), SomeTypeMapResourceArray{})
	codeinfra.RegisterInputType(reflect.TypeOf((*SomeTypeMapResourceMapInput)(nil)).Elem(), SomeTypeMapResourceMap{})
	codeinfra.RegisterOutputType(SomeTypeMapResourceOutput{})
	codeinfra.RegisterOutputType(SomeTypeMapResourceArrayOutput{})
	codeinfra.RegisterOutputType(SomeTypeMapResourceMapOutput{})
}
