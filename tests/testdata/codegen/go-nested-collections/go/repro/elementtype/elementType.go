...
type ElementType struct {
	...
	ElementType_ ElementTypeTypePtrOutput `codeinfra:"elementType"`
}

// NewElementType registers a new resource with the given unique name, arguments, and options.
func NewElementType(ctx *codeinfra.Context,
	name string, args *ElementTypeArgs, opts ...codeinfra.ResourceOption) (*ElementType, error) {
	if args == nil {
...
func GetElementType(ctx *codeinfra.Context,
	name string, id codeinfra.IDInput, state *ElementTypeState, opts ...codeinfra.ResourceOption) (*ElementType, error) {
	var resource ElementType
...
func (i *ElementType) ToElementTypeOutputWithContext(ctx context.Context) ElementTypeOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ElementTypeOutput)
}
...
func (i ElementTypeArray) ToElementTypeArrayOutputWithContext(ctx context.Context) ElementTypeArrayOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ElementTypeArrayOutput)
}
...
func (i ElementTypeMap) ToElementTypeMapOutputWithContext(ctx context.Context) ElementTypeMapOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(ElementTypeMapOutput)
}

type ElementTypeOutput struct{ *codeinfra.OutputState }
...
type ElementTypeArrayOutput struct{ *codeinfra.OutputState }
...
func (o ElementTypeArrayOutput) Index(i codeinfra.IntInput) ElementTypeOutput {
	return codeinfra.All(o, i).ApplyT(func(vs []interface{}) *ElementType {
		return vs[0].([]*ElementType)[vs[1].(int)]
	}).(ElementTypeOutput)
}

type ElementTypeMapOutput struct{ *codeinfra.OutputState }
...
func (o ElementTypeMapOutput) MapIndex(k codeinfra.StringInput) ElementTypeOutput {
	return codeinfra.All(o, k).ApplyT(func(vs []interface{}) *ElementType {
		return vs[0].(map[string]*ElementType)[vs[1].(string)]
	}).(ElementTypeOutput)
}

func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*ElementTypeInput)(nil)).Elem(), &ElementType{})
	codeinfra.RegisterInputType(reflect.TypeOf((*ElementTypeArrayInput)(nil)).Elem(), ElementTypeArray{})
	codeinfra.RegisterInputType(reflect.TypeOf((*ElementTypeMapInput)(nil)).Elem(), ElementTypeMap{})
	codeinfra.RegisterOutputType(ElementTypeOutput{})
	codeinfra.RegisterOutputType(ElementTypeArrayOutput{})
	codeinfra.RegisterOutputType(ElementTypeMapOutput{})
}
