...
type Foo struct {
	...
	PrivateEndpoint codeinfra.StringMapMapMapOutput `codeinfra:"privateEndpoint"`
}
...
func (o FooOutput) PrivateEndpoint() codeinfra.StringMapMapMapOutput {
	return o.ApplyT(func(v *Foo) codeinfra.StringMapMapMapOutput { return v.PrivateEndpoint }).(codeinfra.StringMapMapMapOutput)
}
