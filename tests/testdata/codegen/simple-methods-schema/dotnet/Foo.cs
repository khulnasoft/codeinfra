...
namespace Codeinfra.Example
{
    ...
    public partial class Foo : global::Codeinfra.ComponentResource
    {
        /// <summary>
        ...
        /// </summary>
        public global::Codeinfra.Output<FooBarResult> Bar(FooBarArgs args)
            => global::Codeinfra.Deployment.Instance.Call<FooBarResult>("example::Foo/bar", args ?? new FooBarArgs(), this);

        public void Baz()
            => global::Codeinfra.Deployment.Instance.Call("example::Foo/baz", CallArgs.Empty, this);

        /// <summary>
        /// Do something with something else
        /// </summary>
        public global::Codeinfra.Output<FooGenerateKubeconfigResult> GenerateKubeconfig(FooGenerateKubeconfigArgs args)
            => global::Codeinfra.Deployment.Instance.Call<FooGenerateKubeconfigResult>("example::Foo/generateKubeconfig", args ?? new FooGenerateKubeconfigArgs(), this);
    }
    ...
    /// </summary>
    public sealed class FooBarArgs : global::Codeinfra.CallArgs
    {
        [Input("baz")]
        public Input<Codeinfra.Example.Nested.Inputs.BazArgs>? Baz { get; set; }

        [Input("bazPlain")]
        public Codeinfra.Example.Nested.Inputs.BazArgs? BazPlain { get; set; }

        [Input("bazRequired", required: true)]
        public Input<Codeinfra.Example.Nested.Inputs.BazArgs> BazRequired { get; set; } = null!;
        ...
        [Input("namePlain")]
        public Codeinfra.Random.RandomPet? NamePlain { get; set; }

        [Input("nameRequired", required: true)]
        public Input<Codeinfra.Random.RandomPet> NameRequired { get; set; } = null!;
    ...
    /// </summary>
    public sealed class FooGenerateKubeconfigArgs : global::Codeinfra.CallArgs
    {
