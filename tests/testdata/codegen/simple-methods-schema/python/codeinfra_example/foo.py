...
class Foo(codeinfra.ComponentResource):
    ...
    class BarResult:
        def __init__(__self__, some_value=None):
            ...
            codeinfra.set(__self__, "some_value", some_value)
    ...
    def bar(__self__, *,
            baz_required: codeinfra.Input['_nested.BazArgs'],
            bool_value_required: codeinfra.Input[bool],
            name_required: codeinfra.Input['codeinfra_random.RandomPet'],
            string_value_required: codeinfra.Input[str],
            baz: Optional[codeinfra.Input['_nested.BazArgs']] = None,
            baz_plain: Optional['_nested.BazArgs'] = None,
            bool_value: Optional[codeinfra.Input[bool]] = None,
            bool_value_plain: Optional[bool] = None,
            name: Optional[codeinfra.Input['codeinfra_random.RandomPet']] = None,
            name_plain: Optional['codeinfra_random.RandomPet'] = None,
            string_value: Optional[codeinfra.Input[str]] = None,
            string_value_plain: Optional[str] = None) -> codeinfra.Output['Foo.BarResult']:
        """
        ...
        return codeinfra.runtime.call('example::Foo/bar', __args__, res=__self__, typ=Foo.BarResult)

    def baz(__self__) -> None:
        __args__ = dict()
        __args__['__self__'] = __self__
        codeinfra.runtime.call('example::Foo/baz', __args__, res=__self__)
    ...
    def generate_kubeconfig(__self__, *,
                            bool_value: bool) -> codeinfra.Output['Foo.GenerateKubeconfigResult']:
        """
        ...
        __args__['__self__'] = __self__
        __args__['boolValue'] = bool_value
        return codeinfra.runtime.call('example::Foo/generateKubeconfig', __args__, res=__self__, typ=Foo.GenerateKubeconfigResult)
