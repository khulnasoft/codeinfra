...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">RubberTree</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">RubberTreeArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/codeinfra/codeinfra/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewRubberTree</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">RubberTreeArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">RubberTree</span>, error)</span></code></pre></div>
</div></codeinfra-choosable>
</div>

<div>
<codeinfra-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">RubberTree</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RubberTreeArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Codeinfra/Codeinfra.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></codeinfra-choosable>
</div>
...
<dl class="resources-properties"><dt
    ...
    <dd>The arguments to resource properties.</dd><dt
        ...
        <span>opts</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/codeinfra/codeinfra/#CustomResourceOptions">CustomResourceOptions</a></span>
    </dt>
...
<dl class="resources-properties"><dt
    ...
    <dd>The arguments to resource properties.</dd><dt
        ...
        <span>opts</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Codeinfra/Codeinfra.CustomResourceOptions.html">CustomResourceOptions</a></span>
    </dt>
    <dd>Bag of options to control resource&#39;s behavior.</dd></dl>
...
var rubberTreeResource = new Plant.Tree.V1.RubberTree("rubberTreeResource", new()
{
    ...
    Farm = Plant.Tree.V1.Farm.Codeinfra_Planters_Inc_,
...
example, err := tree.NewRubberTree(ctx, "rubberTreeResource", &tree.RubberTreeArgs{
	...
	Container: &plant.ContainerArgs{
		...
		Color:      codeinfra.String(plant.ContainerColorRed),
		Material:   codeinfra.String("string"),
	},
	Farm: codeinfra.String(tree.Farm_Codeinfra_Planters_Inc_),
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#diameter_csharp" style="color: inherit; text-decoration: inherit;">Diameter</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diameter">Codeinfra.<wbr>Other.<wbr>Tree.<wbr>V1.<wbr>Diameter</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rubbertreevariety">Codeinfra.<wbr>Plant.<wbr>Tree.<wbr>V1.<wbr>Rubber<wbr>Tree<wbr>Variety</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#container_csharp" style="color: inherit; text-decoration: inherit;">Container</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#container">Codeinfra.<wbr>Plant.<wbr>Inputs.<wbr>Container</a></span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
        <span id="farm_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#farm_csharp" style="color: inherit; text-decoration: inherit;">Farm</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#farm">Codeinfra.<wbr>Plant.<wbr>Tree.<wbr>V1.<wbr>Farm</a> | string</span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
        <span id="size_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#size_csharp" style="color: inherit; text-decoration: inherit;">Size</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#treesize">Codeinfra.<wbr>Plant.<wbr>Tree.<wbr>V1.<wbr>Tree<wbr>Size</a></span>
    </dt>
    <dd></dd></dl>
</codeinfra-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#farm_yaml" style="color: inherit; text-decoration: inherit;">farm</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#farm">&#34;Codeinfra Planters Inc.&#34; | &#34;Plants&#39;R&#39;Us&#34;</a> | String</span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
        <span id="size_yaml">
...
<div>
<codeinfra-choosable type="language" values="javascript,typescript">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">public static </span><span class="nf">get</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/codeinfra/codeinfra/#ID">Input&lt;ID&gt;</a></span><span class="p">,</span> <span class="nx">state</span><span class="p">?:</span> <span class="nx">RubberTreeState</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/codeinfra/codeinfra/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">): </span><span class="nx">RubberTree</span></code></pre></div>
</div></codeinfra-choosable>
</div>
...
<div>
<codeinfra-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetRubberTree<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">RubberTreeState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">RubberTree</span>, error)</span></code></pre></div>
</div></codeinfra-choosable>
</div>

<div>
<codeinfra-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static </span><span class="nx">RubberTree</span><span class="nf"> Get</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Codeinfra/Codeinfra.Input-1.html">Input&lt;string&gt;</a></span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">RubberTreeState</span><span class="p">? </span><span class="nx">state<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Codeinfra/Codeinfra.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></codeinfra-choosable>
</div>
...
<div>
<codeinfra-choosable type="language" values="typescript,javascript,python,go,csharp,java">
...
<h4 id="container">
Container<codeinfra-choosable type="language" values="python,go" class="inline">, Container<wbr>Args</codeinfra-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#size_csharp" style="color: inherit; text-decoration: inherit;">Size</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containersize">Codeinfra.<wbr>Plant.<wbr>Container<wbr>Size</a></span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#brightness_csharp" style="color: inherit; text-decoration: inherit;">Brightness</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containerbrightness">Codeinfra.<wbr>Plant.<wbr>Container<wbr>Brightness</a></span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#color_csharp" style="color: inherit; text-decoration: inherit;">Color</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containercolor">Codeinfra.<wbr>Plant.<wbr>Container<wbr>Color</a> | string</span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
...
Container<wbr>Brightness<codeinfra-choosable type="language" values="python,go" class="inline">, Container<wbr>Brightness<wbr>Args</codeinfra-choosable>
</h4>
...
Container<wbr>Color<codeinfra-choosable type="language" values="python,go" class="inline">, Container<wbr>Color<wbr>Args</codeinfra-choosable>
</h4>
...
<h4 id="containersize">
Container<wbr>Size<codeinfra-choosable type="language" values="python,go" class="inline">, Container<wbr>Size<wbr>Args</codeinfra-choosable>
</h4>
...
<h4 id="diameter">
Diameter<codeinfra-choosable type="language" values="python,go" class="inline">, Diameter<wbr>Args</codeinfra-choosable>
</h4>
...
<h4 id="farm">
Farm<codeinfra-choosable type="language" values="python,go" class="inline">, Farm<wbr>Args</codeinfra-choosable>
</h4>

<div>
<codeinfra-choosable type="language" values="csharp">
<dl class="tabular"><dt>Codeinfra_Planters_Inc_</dt>
    <dd>Codeinfra Planters Inc.</dd><dt>Plants_R_Us</dt>
...
<div>
<codeinfra-choosable type="language" values="go">
<dl class="tabular"><dt>Farm_Codeinfra_Planters_Inc_</dt>
    <dd>Codeinfra Planters Inc.</dd><dt>Farm_Plants_R_Us</dt>
    <dd>Plants'R'Us</dd></dl>
</codeinfra-choosable>
</div>
...
<div>
<codeinfra-choosable type="language" values="yaml">
<dl class="tabular"><dt>"Codeinfra Planters Inc."</dt>
    <dd>Codeinfra Planters Inc.</dd><dt>"Plants'R'Us"</dt>
    <dd>Plants'R'Us</dd></dl>
</codeinfra-choosable>
</div>

<h4 id="rubbertreevariety">
Rubber<wbr>Tree<wbr>Variety<codeinfra-choosable type="language" values="python,go" class="inline">, Rubber<wbr>Tree<wbr>Variety<wbr>Args</codeinfra-choosable>
</h4>
...
<h4 id="treesize">
Tree<wbr>Size<codeinfra-choosable type="language" values="python,go" class="inline">, Tree<wbr>Size<wbr>Args</codeinfra-choosable>
</h4>
