...
{
    public class ExampleComponentArgs : global::Codeinfra.ResourceArgs
    {
        public class DeploymentZonesArgs : global::Codeinfra.ResourceArgs
        {
            [Input("zone")]
            public Input<string>? Zone { get; set; }
        }

        public class GithubAppArgs : global::Codeinfra.ResourceArgs
        {
            [Input("id")]
        ...
        public class ServersArgs : global::Codeinfra.ResourceArgs
        {
            [Input("name")]
    ...
    public class ExampleComponent : global::Codeinfra.ComponentResource
    {
        [Output("result")]
