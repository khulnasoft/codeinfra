...
class ExampleComponent(codeinfra.ComponentResource):
    def __init__(self, name: str, args: ExampleComponentArgs, opts:Optional[codeinfra.ResourceOptions] = None):
        ...
        simple_component = SimpleComponent(f"{name}-simpleComponent", opts = codeinfra.ResourceOptions(parent=self))
