...
func (i *BasicResourceV2) ToBasicResourceV2OutputWithContext(ctx context.Context) BasicResourceV2Output {
	return codeinfra.ToOutputWithContext(ctx, i).(BasicResourceV2Output)
}

func (i *BasicResourceV2) ToOutput(ctx context.Context) codeinfrax.Output[*BasicResourceV2] {
...
func (o BasicResourceV2Output) Bar() codeinfra.StringOutput {
	return o.ApplyT(func(v *BasicResourceV2) codeinfra.StringOutput { return v.Bar }).(codeinfra.StringOutput)
}

func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*BasicResourceV2Input)(nil)).Elem(), &BasicResourceV2{})
