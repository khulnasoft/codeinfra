...
func (i *BasicResourceV3) ToBasicResourceV3OutputWithContext(ctx context.Context) BasicResourceV3Output {
	return codeinfra.ToOutputWithContext(ctx, i).(BasicResourceV3Output)
}

func (i *BasicResourceV3) ToOutput(ctx context.Context) codeinfrax.Output[*BasicResourceV3] {
...
func (o BasicResourceV3Output) Bar() codeinfra.StringOutput {
	return o.ApplyT(func(v *BasicResourceV3) codeinfra.StringOutput { return v.Bar }).(codeinfra.StringOutput)
}

func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*BasicResourceV3Input)(nil)).Elem(), &BasicResourceV3{})
