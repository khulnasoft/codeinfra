...
func (o BasicResourceOutput) Bar() codeinfrax.Output[string] {
	value := codeinfrax.Apply[BasicResource](o, func(v BasicResource) codeinfrax.Output[string] { return v.Bar })
