...
export class BasicResourceV2 extends codeinfra.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: codeinfra.Input<codeinfra.ID>, opts?: codeinfra.CustomResourceOptions): BasicResourceV2 {
        return new BasicResourceV2(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __codeinfraType = 'example:index:BasicResourceV2';
    ...
    public static isInstance(obj: any): obj is BasicResourceV2 {
        ...
        return obj['__codeinfraType'] === BasicResourceV2.__codeinfraType;
    }
     ...
     */
    constructor(name: string, args: BasicResourceV2Args, opts?: codeinfra.CustomResourceOptions) {
        ...
        super(BasicResourceV2.__codeinfraType, name, resourceInputs, opts);
    }
}
