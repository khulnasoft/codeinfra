...
namespace Codeinfra.Credentials
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Codeinfra.Credentials.version.txt");
    ...
    internal sealed class CredentialsResourceTypeAttribute : global::Codeinfra.ResourceTypeAttribute
    {
        public CredentialsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
