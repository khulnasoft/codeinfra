...
namespace Codeinfra.Credentials
{
    public static class Config
    {
        ...
        private static readonly global::Codeinfra.Config __config = new global::Codeinfra.Config("credentials");

        private static readonly __Value<Codeinfra.Credentials.HashKind?> _hash = new __Value<Codeinfra.Credentials.HashKind?>(() => __config.GetObject<Codeinfra.Credentials.HashKind>("hash"));
        /// <summary>
        /// The (entirely uncryptographic) hash function used to encode the "password".
        /// </summary>
        public static Codeinfra.Credentials.HashKind? Hash
        {
            get => _hash.Get();
            set => _hash.Set(value);
        }
