...
func (e HashKind) ToHashKindOutput() HashKindOutput {
	return codeinfra.ToOutput(e).(HashKindOutput)
}

func (e HashKind) ToHashKindOutputWithContext(ctx context.Context) HashKindOutput {
	return codeinfra.ToOutputWithContext(ctx, e).(HashKindOutput)
}
...
func (e HashKind) ToStringOutput() codeinfra.StringOutput {
	return codeinfra.ToOutput(codeinfra.String(e)).(codeinfra.StringOutput)
}

func (e HashKind) ToStringOutputWithContext(ctx context.Context) codeinfra.StringOutput {
	return codeinfra.ToOutputWithContext(ctx, codeinfra.String(e)).(codeinfra.StringOutput)
}

func (e HashKind) ToStringPtrOutput() codeinfra.StringPtrOutput {
	return codeinfra.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e HashKind) ToStringPtrOutputWithContext(ctx context.Context) codeinfra.StringPtrOutput {
	return codeinfra.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type HashKindOutput struct{ *codeinfra.OutputState }
...
func (o HashKindOutput) ToStringOutput() codeinfra.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o HashKindOutput) ToStringOutputWithContext(ctx context.Context) codeinfra.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e HashKind) string {
		return string(e)
	}).(codeinfra.StringOutput)
}

func (o HashKindOutput) ToStringPtrOutput() codeinfra.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o HashKindOutput) ToStringPtrOutputWithContext(ctx context.Context) codeinfra.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e HashKind) *string {
		v := string(e)
		return &v
...
type HashKindPtrOutput struct{ *codeinfra.OutputState }
...
func (o HashKindPtrOutput) ToStringPtrOutput() codeinfra.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o HashKindPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) codeinfra.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *HashKind) *string {
		if e == nil {
			return nil
		}
...
func (in *hashKindPtr) ToHashKindPtrOutput() HashKindPtrOutput {
	return codeinfra.ToOutput(in).(HashKindPtrOutput)
}

func (in *hashKindPtr) ToHashKindPtrOutputWithContext(ctx context.Context) HashKindPtrOutput {
	return codeinfra.ToOutputWithContext(ctx, in).(HashKindPtrOutput)
}

func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*HashKindInput)(nil)).Elem(), HashKind("Adler32"))
	codeinfra.RegisterInputType(reflect.TypeOf((*HashKindPtrInput)(nil)).Elem(), HashKind("Adler32"))
	codeinfra.RegisterOutputType(HashKindOutput{})
	codeinfra.RegisterOutputType(HashKindPtrOutput{})
}
