...
type Rec struct {
	...
	Rec RecOutput `codeinfra:"rec"`
}

// NewRec registers a new resource with the given unique name, arguments, and options.
func NewRec(ctx *codeinfra.Context,
	name string, args *RecArgs, opts ...codeinfra.ResourceOption) (*Rec, error) {
	if args == nil {
		args = &RecArgs{}
	}
...
func GetRec(ctx *codeinfra.Context,
	name string, id codeinfra.IDInput, state *RecState, opts ...codeinfra.ResourceOption) (*Rec, error) {
	var resource Rec
...
func (i RecArray) ToRecArrayOutputWithContext(ctx context.Context) RecArrayOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(RecArrayOutput)
}
...
func (i RecMap) ToRecMapOutputWithContext(ctx context.Context) RecMapOutput {
	return codeinfra.ToOutputWithContext(ctx, i).(RecMapOutput)
}
...
type RecArrayOutput struct{ *codeinfra.OutputState }
...
func (o RecArrayOutput) Index(i codeinfra.IntInput) RecOutput {
	return codeinfra.All(o, i).ApplyT(func(vs []interface{}) *Rec {
		return vs[0].([]*Rec)[vs[1].(int)]
	}).(RecOutput)
}

type RecMapOutput struct{ *codeinfra.OutputState }
...
func (o RecMapOutput) MapIndex(k codeinfra.StringInput) RecOutput {
	return codeinfra.All(o, k).ApplyT(func(vs []interface{}) *Rec {
		return vs[0].(map[string]*Rec)[vs[1].(string)]
	}).(RecOutput)
}

func init() {
	codeinfra.RegisterInputType(reflect.TypeOf((*RecInput)(nil)).Elem(), &Rec{})
	codeinfra.RegisterInputType(reflect.TypeOf((*RecArrayInput)(nil)).Elem(), RecArray{})
	codeinfra.RegisterInputType(reflect.TypeOf((*RecMapInput)(nil)).Elem(), RecMap{})
	codeinfra.RegisterOutputType(RecOutput{})
	codeinfra.RegisterOutputType(RecArrayOutput{})
	codeinfra.RegisterOutputType(RecMapOutput{})
}
