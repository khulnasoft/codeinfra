import codeinfra
import codeinfra_azure_native as azure_native
...
blob_access_token = codeinfra.Output.secret(codeinfra.Output.all(
    saName=sa.name,
...
blob = azure_native.storage.Blob("blob",
    ...
    source=codeinfra.FileArchive("./www"))
...
,
        ...
        "connection_strings": [{
            ...
            "connection_string": codeinfra.Output.all(
...
codeinfra.export("endpoint", app.default_host_name)
