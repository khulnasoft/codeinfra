...
class Sub extends dynamic.Resource {
    public readonly difference: codeinfra.Output<number>;
...
class Div extends dynamic.Resource {
    public readonly quotient: codeinfra.Output<number>;
    public readonly remainder: codeinfra.Output<number>;
...
let config = new codeinfra.Config("simple");
...
export let outputSum: codeinfra.Output<number> = result.sum;
