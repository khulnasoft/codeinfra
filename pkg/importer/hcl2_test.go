...
func TestGenerateHCL2DefinitionsWithDependantResources(t *testing.T) {
	...
	resources := []apitype.ResourceV3{
		{
			URN:    "urn:codeinfra:stack::project::aws:s3/bucket:Bucket::exampleBucket",
			ID:     "provider-generated-bucket-id-abc123",
			Custom: true,
			Type:   "aws:s3/bucket:Bucket",
		},
		{
			URN:    "urn:codeinfra:stack::project::aws:s3/bucketObject:BucketObject::exampleBucketObject",
...
func TestGenerateHCL2DefinitionsWithDependantResourcesUsingNameOrArnProperty(t *testing.T) {
	...
	resources := []apitype.ResourceV3{
		...
		{
			URN:    "urn:codeinfra:stack::project::aws:s3/bucketObject:BucketObject::exampleBucketObjectUsingArn",
			ID:     "provider-generated-bucket-object-id-abc123",
			Custom: true,
			Type:   "aws:s3/bucketObject:BucketObject",
			Inputs: map[string]interface{}{
...
func TestGenerateHCL2DefinitionsWithAmbiguousReferencesMaintainsLiteralValue(t *testing.T) {
	...
	resources := []apitype.ResourceV3{
		{
			URN:    "urn:codeinfra:stack::project::aws:s3/bucket:Bucket::firstBucket",
			ID:     "provider-generated-bucket-id-abc123",
			Custom: true,
			Type:   "aws:s3/bucket:Bucket",
		},
		{
			URN:    "urn:codeinfra:stack::project::aws:s3/bucket:Bucket::secondBucket",
			ID:     "provider-generated-bucket-id-abc123",
			Custom: true,
			Type:   "aws:s3/bucket:Bucket",
		},
