...
func TestClientInterceptorCatchesErrors(t *testing.T) {
	...
	err = uci(ctx, "/codeinfrarpc.ResourceProvider/Configure",
		&codeinfrarpc.ConfigureRequest{
			Variables: map[string]string{"x": "y"},
		},
		&codeinfrarpc.ConfigureResponse{}, nil, inner)
	...
	assert.JSONEq(t, `{
		"method": "/codeinfrarpc.ResourceProvider/Configure",
