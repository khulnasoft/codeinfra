...
// autonamingSectionJSON represents the root configuration object for Codeinfra autonaming
// Example of a configuration that it encodes (config will convert it to JSON before autonaming receives it):
//
// codeinfra:autonaming:
//
//	mode: default
//	providers:
//	  aws:
...
type namingConfigJSON struct {
	// Mode specifies the autonaming mode: default (standard Codeinfra behavior),
