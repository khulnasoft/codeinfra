...
import (
	...
	"github.com/khulnasoft/codeinfra/sdk/v3/go/codeinfra/provider"
...
func MainWithOptions(opts Options) error {
	return Main(opts.Name, func(host *HostClient) (codeinfrarpc.ResourceProviderServer, error) {
...
func ComponentMain(name, version string, schema []byte, construct provider.ConstructFunc) error {
	return Main(name, func(host *HostClient) (codeinfrarpc.ResourceProviderServer, error) {
		return &componentProvider{
			host:      host,
			name:      name,
			version:   version,
...
func (p *componentProvider) GetPluginInfo(context.Context, *emptypb.Empty) (*codeinfrarpc.PluginInfo, error) {
...
func (p *componentProvider) GetSchema(ctx context.Context,
	...
	return &codeinfrarpc.GetSchemaResponse{Schema: schema}, nil
}
...
func (p *componentProvider) GetMapping(ctx context.Context,
	...
	return &codeinfrarpc.GetMappingResponse{Provider: "", Data: nil}, nil
}
