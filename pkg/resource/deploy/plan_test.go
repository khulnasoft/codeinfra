			...
			t.Run("invalid provider reference", func(t *testing.T) {
				...
				t.Run("resource plan", func(t *testing.T) {
					...
					err := rp.checkGoal(
						...
						resource.PropertyMap{},
						&resource.Goal{
							Provider: "urn:codeinfra:dev::random::codeinfra:providers:random::default_4_13_2::provider-foo",
						})
				...
				t.Run("goal", func(t *testing.T) {
					...
					rp := &ResourcePlan{
						Goal: &GoalPlan{
							Provider: "urn:codeinfra:dev::random::codeinfra:providers:random::default_4_13_2::provider-bar",
						},
					}
					err := rp.checkGoal(
						resource.PropertyMap{},
