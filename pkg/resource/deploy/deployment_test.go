...
func TestGlobUrn(t *testing.T) {
	...
	globs := []struct {
	...
	}{
		{
			input: "**",
			expected: []resource.URN{
				"urn:codeinfra:stack::test::typ$aws:resource::aname",
				"urn:codeinfra:stack::test::typ$aws:resource::bar",
				"urn:codeinfra:stack::test::typ$azure:resource::bar",
			},
		},
		{
			input: "urn:codeinfra:stack::test::typ*:resource::bar",
			expected: []resource.URN{
				"urn:codeinfra:stack::test::typ$aws:resource::bar",
				"urn:codeinfra:stack::test::typ$azure:resource::bar",
			},
			unexpected: []resource.URN{
				"urn:codeinfra:stack::test::ty:resource::bar",
				"urn:codeinfra:stack::test::type:resource::foobar",
			},
		},
		{
			input:      "**:aname",
			expected:   []resource.URN{"urn:codeinfra:stack::test::typ$aws:resource::aname"},
			unexpected: []resource.URN{"urn:codeinfra:stack::test::typ$aws:resource::somename"},
		},
		{
			...
			unexpected: []resource.URN{
				"urn:codeinfra:stack::test::typ$azure:resource::aname",
			},
		},
		{
