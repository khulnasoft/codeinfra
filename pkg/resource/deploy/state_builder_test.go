...
func TestStateBuilder(t *testing.T) {
	...
	t.Run("Update parent, no-op", func(t *testing.T) {
		...
		s0 := &resource.State{
			...
			Provider: "urn:codeinfra:providers::pkgA::prov::v1",
			Dependencies: []resource.URN{
				"urn:codeinfra:stack::project::type:name::depA",
				"urn:codeinfra:stack::project::type:name::depB",
			},
			PropertyDependencies: map[resource.PropertyKey][]resource.URN{
				"propA": {
					"urn:codeinfra:stack::project::type:name::propDepA",
					"urn:codeinfra:stack::project::type:name::propDepB",
				},
			},
			DeletedWith: "urn:codeinfra:stack::project::type:name::deletedWith",
		}
	...
	t.Run("Update parent, identity", func(t *testing.T) {
		...
		s0 := &resource.State{
			URN:      "urn:codeinfra:stack::project::type:name",
			Provider: "urn:codeinfra:providers::pkgA::prov::v1",
			Parent:   "urn:codeinfra:stack::project::type:name::parent",
			Dependencies: []resource.URN{
				"urn:codeinfra:stack::project::type:name::depA",
				"urn:codeinfra:stack::project::type:name::depB",
			},
