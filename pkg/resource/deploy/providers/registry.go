...
const (
	// These are all internal settings that we use to store information about the provider in the Codeinfra state, but
	...
	// versionKey is the key used to store the version of the provider in the Codeinfra state. This is _not_ treated as an
...
//
// In order to fit neatly in to the existing infrastructure for managing resources using Codeinfra, a provider regidstry
