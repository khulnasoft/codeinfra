...
func TestParseReferenceInvalidModule(t *testing.T) {
	...
	str = string(resource.NewURN("test", "test", "", "codeinfra:invalid:type", "test")) + "::id"
	ref, err = ParseReference(str)
	assert.Error(t, err)
	assert.Equal(t, Reference{}, ref)
...
func TestParseReference(t *testing.T) {
	...
	urn, id := resource.NewURN("test", "test", "", "codeinfra:providers:type", "test"), resource.ID("id")
...
func TestRoundTripReference(t *testing.T) {
	...
	str := string(resource.NewURN("test", "test", "", "codeinfra:providers:type", "test")) + "::id"
	ref, err := ParseReference(str)
	assert.NoError(t, err)
