...
func TestEngineDiff(t *testing.T) {
	...
	urn := resource.URN("urn:codeinfra:dev::website-and-lambda::aws:s3/bucket:Bucket::my-bucket")
...
func TestGenerateAliases(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			expected: []resource.URN{
				"urn:codeinfra:stack::project::test:resource:child2::myres-child",
			},
		},
		{
			...
			expected: []resource.URN{
				"urn:codeinfra:stack::project::test:resource:original$test:resource:child2::myres-child",
			},
		},
		{
			...
			expected: []resource.URN{
				...
				"urn:codeinfra:stack::project::test:resource:type2$test:resource:child::myres-child",
				"urn:codeinfra:stack::project::test:resource:type2$test:resource:child::myres-child2",
			},
		},
		{
	...
	t.Run("providerChanged", func(t *testing.T) {
		...
		t.Run("invalid old ProviderReference", func(t *testing.T) {
			...
			_, err := sg.providerChanged("",
				...
				&resource.State{
					Provider: "urn:codeinfra:stack::project::codeinfra:providers:provider::name::uuid",
				},
			)
		...
		t.Run("error getting new default provider", func(t *testing.T) {
			...
			_, err := sg.providerChanged("",
				&resource.State{
					Provider: "urn:codeinfra:stack::project::codeinfra:providers:provider::default_name::uuid",
				},
				&resource.State{
					Provider: "urn:codeinfra:stack::project::codeinfra:providers:provider::default_new::uuid",
				},
			)
