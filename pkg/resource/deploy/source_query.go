...
// newQueryResourceMonitor creates a new resource monitor RPC server intended to be used in Codeinfra's
// "query mode".
func newQueryResourceMonitor(
	...
	handle, err := rpcutil.ServeWithOptions(rpcutil.ServeOptions{
		...
		Init: func(srv *grpc.Server) error {
			codeinfrarpc.RegisterResourceMonitorServer(srv, queryResmon)
			return nil
		},
...
// queryResmon is a codeinfrarpc.ResourceMonitor that is meant to run in Codeinfra's "query mode". It
...
type queryResmon struct {
	codeinfrarpc.UnimplementedResourceMonitorServer
...
func (rm *queryResmon) Invoke(
	ctx context.Context, req *codeinfrarpc.ResourceInvokeRequest,
...
func (rm *queryResmon) Call(ctx context.Context, req *codeinfrarpc.ResourceCallRequest) (*codeinfrarpc.CallResponse, error) {
	tok := tokens.ModuleMember(req.GetTok())
