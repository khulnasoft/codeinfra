...
func TestHostEngine(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		...
		t.Run("Log", func(t *testing.T) {
			...
			tests := []struct {
				name           string
				req            *codeinfrarpc.LogRequest
				expectedError  error
				expectedOutput *emptypb.Empty
			}{
				{
					name:           "DebugSeverity",
					req:            &codeinfrarpc.LogRequest{Severity: codeinfrarpc.LogSeverity_DEBUG},
					expectedOutput: &emptypb.Empty{},
				},
				{
					name:           "InfoSeverity",
					req:            &codeinfrarpc.LogRequest{Severity: codeinfrarpc.LogSeverity_INFO},
					expectedOutput: &emptypb.Empty{},
				},
				{
				...
				},
				{
					...
					req:           &codeinfrarpc.LogRequest{Severity: 99999},
