...
func (acts *updateActions) OnResourceStepPost(
	...
	if err != nil {
		...
		// the Codeinfra program, as component resources only report outputs via calls to RegisterResourceOutputs.
	...
	// See codeinfra/codeinfra#2011 for details. Terraform always returns the existing state with the diff applied to it in
