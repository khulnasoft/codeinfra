...
import (
	...
	bdisplay "github.com/khulnasoft/codeinfra/pkg/v3/backend/display"
	...
	"github.com/khulnasoft/codeinfra/pkg/v3/util/cancel"
...
func (op TestOp) runWithContext(
	...
	// https://github.com/khulnasoft/codeinfra/issues/14588 for what happens if you try to use callerCtx here.
...
func AssertDisplay(t TB, events []engine.Event, path string) {
	...
	accept := cmdutil.IsTruthy(os.Getenv("CODEINFRA_ACCEPT"))
	if !accept {
		var err error
