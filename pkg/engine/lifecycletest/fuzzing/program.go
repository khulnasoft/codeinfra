...
// A ProgramSpec specifies a Codeinfra program whose execution will be mocked in a lifecycle test in order to register
// resources.
...
func (ps *ProgramSpec) AsLanguageRuntimeF(t require.TestingT) deploytest.LanguageRuntimeFactory {
	return deploytest.NewLanguageRuntimeF(func(_ plugin.RunInfo, monitor *deploytest.ResourceMonitor) error {
		...
		//    Name: "res2",
		//    Parent: "urn:codeinfra:stack::project::pkgA:modA:typeA::res1",
		//    AliasURNs: []resource.URN{"urn:codeinfra:stack::project::pkgA:modA:typeA::res2"},
		//  }
		//
		// res2 has been updated to add a parent, res1, which previously it did not have. Its new URN,
		// urn:codeinfra:stack::project::pkgA:modA:typeA$pkgA:modA:typeA::res2, will include res1's type. Its old URN,
		// urn:codeinfra:stack::project::pkgA:modA:typeA::res2, with just res2's type, has been added as an alias. When we
