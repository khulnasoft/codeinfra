...
func TestInitErrorsStep(t *testing.T) {
	...
	lt.NewTestBuilder(t, &deploy.Snapshot{
		Resources: []*resource.State{
			{
				Type:   "codeinfra:providers:pkgA",
				URN:    "urn:codeinfra:test::test::codeinfra:providers:pkgA::default",
				Custom: true,
				Delete: false,
			...
			},
			{
				...
				Custom:   true,
				ID:       "my-resource-id",
				Provider: "urn:codeinfra:test::test::codeinfra:providers:pkgA::default::935b2216-aec5-4810-96fd-5f6eae57ac88",
				InitErrors: []string{
