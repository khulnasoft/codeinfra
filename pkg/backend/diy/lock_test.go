...
func TestLockURLForError(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			lockPath: "/.codeinfra/locks/organization/proj/stack/18262c43-124d-4f19-b90f-24db3c0a22a3.json",
			expected: "file:///Users/user/.codeinfra/locks/organization/proj/stack/" +
		...
		},
		{
			...
			lockPath: "/.codeinfra/locks/organization/proj/stack/18262c43-124d-4f19-b90f-24db3c0a22a3.json",
			expected: "s3://mybucket/testfile/.codeinfra/locks/organization/proj/stack/" +
				"18262c43-124d-4f19-b90f-24db3c0a22a3.json",
		},
		{
		...
		},
		{
			...
			baseURL:  "/Users/user",
			lockPath: "/.codeinfra/locks/organization/proj/stack/18262c43-124d-4f19-b90f-24db3c0a22a3.json",
			expected: "/Users/user/.codeinfra/locks/organization/proj/stack/18262c43-124d-4f19-b90f-24db3c0a22a3.json",
		},
		{
