...
func (b *diyBackend) saveCheckpoint(
	...
	// .json file to know the stack currently exists (see https://github.com/khulnasoft/codeinfra/issues/9033 for
	// context).
...
// backupStack copies the current Checkpoint file to ~/.codeinfra/backups.
