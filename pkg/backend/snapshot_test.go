...
func TestWriteCheckpointOnceUnsafe(t *testing.T) {
	...
	provider := NewResource("urn:codeinfra:foo::bar::codeinfra:providers:pkgUnsafe::provider")
	provider.Custom, provider.Type, provider.ID = true, "codeinfra:providers:pkgUnsafe", "id"
...
func TestSamesWithOtherMeaningfulChanges(t *testing.T) {
	...
	provider := NewResource("urn:codeinfra:foo::bar::codeinfra:providers:pkgA::provider")
	provider.Custom, provider.Type, provider.ID = true, "codeinfra:providers:pkgA", "id"
	...
	changes[0].Custom, changes[0].Provider = true, "urn:codeinfra:foo::bar::codeinfra:providers:pkgA::provider::id"
	...
	provider2 := NewResource("urn:codeinfra:foo::bar::codeinfra:providers:pkgA::provider2")
	provider2.Custom, provider2.Type, provider2.ID = true, "codeinfra:providers:pkgA", "id2"

	resourceA.Custom = true
	resourceA.ID = "id"
	resourceA.Provider = "urn:codeinfra:foo::bar::codeinfra:providers:pkgA::provider::id"
	...
	changes[0].Custom, changes[0].Provider = true, "urn:codeinfra:foo::bar::codeinfra:providers:pkgA::provider2::id2"
