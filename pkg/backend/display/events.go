...
// ConvertEngineEvent converts a raw engine.Event into an apitype.EngineEvent used in the Codeinfra
...
// ConvertJSONEvent converts an apitype.EngineEvent from the Codeinfra REST API into a raw engine.Event
