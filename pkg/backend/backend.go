...
// method to turn a string like "my-great-stack" or "codeinfra/my-great-stack" into a stack reference that can be used to
...
type StackReference interface {
	...
	fmt.Stringer
	// Name is the name that will be passed to the Codeinfra engine when preforming operations on this stack. This
...
type SpecificDeploymentExporter interface {
	...
	// version is backend-specific. For the Codeinfra Console, it is the numeric version. (The first update
...
type CreateStackOptions struct {
	...
	// which support teams (i.e. the Codeinfra Service).
	//
