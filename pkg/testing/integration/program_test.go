...
func TestSanitizedPkg(t *testing.T) {
	...
	v2 := getSanitizedModulePath("github.com/khulnasoft/codeinfra-docker/sdk/v2")
	assert.Equal(t, "github.com/khulnasoft/codeinfra-docker/sdk", v2)

	v3 := getSanitizedModulePath("github.com/khulnasoft/codeinfra-aws/sdk/v3")
	assert.Equal(t, "github.com/khulnasoft/codeinfra-aws/sdk", v3)

	nonVersion := getSanitizedModulePath("github.com/khulnasoft/codeinfra-auth/sdk")
	assert.Equal(t, "github.com/khulnasoft/codeinfra-auth/sdk", nonVersion)
}
...
func TestDepRootCalc(t *testing.T) {
	...
	dep = getRewritePath("github.com/khulnasoft/codeinfra-docker/sdk/v2", "/gopath", "")
	assert.Equal(t, "/gopath/src/github.com/khulnasoft/codeinfra-docker/sdk", filepath.ToSlash(dep))

	dep = getRewritePath("github.com/khulnasoft/codeinfra-gcp/sdk/v3", "/gopath", "/my-go-src")
	assert.Equal(t, "/my-go-src/codeinfra-gcp/sdk", filepath.ToSlash(dep))
	...
	dep = getRewritePath("github.com/khulnasoft/codeinfra-auth0/sdk", "gopath", "/my-go-src")
	assert.Equal(t, "/my-go-src/codeinfra-auth0/sdk", filepath.ToSlash(dep))
}
...
`), 0o600)
	...
	tests := []struct {
	...
	}{
		{
			name:          "valid-path",
			dep:           "../../../sdk",
			expectedValue: "github.com/khulnasoft/codeinfra/sdk/v3=" + filepath.Join(cwd, "../../../sdk"),
		},
		{
		...
		},
		{
			...
			dep:           "github.com/khulnasoft/codeinfra/sdk/v3",
			expectedValue: "github.com/khulnasoft/codeinfra/sdk/v3=" + filepath.Join(cwd, "../../../sdk"),
		},
		{
			name:          "valid-module-name-version-skew",
			dep:           "github.com/khulnasoft/codeinfra/sdk",
			expectedValue: "github.com/khulnasoft/codeinfra/sdk=" + filepath.Join(cwd, "../../../sdk"),
		},
		{
			name:          "valid-rel-path",
			dep:           "github.com/khulnasoft/codeinfra/sdk/v3=../../../sdk",
			expectedValue: "github.com/khulnasoft/codeinfra/sdk/v3=" + filepath.Join(cwd, "../../../sdk"),
		},
		{
			name:          "valid-rel-path-version-skew",
			dep:           "github.com/khulnasoft/codeinfra/sdk=../../../sdk",
			expectedValue: "github.com/khulnasoft/codeinfra/sdk=" + filepath.Join(cwd, "../../../sdk"),
		},
		{
			name:          "invalid-rel-path",
			dep:           "github.com/khulnasoft/codeinfra/pkg=../../../sdk",
			expectedError: "found module path with prefix github.com/khulnasoft/codeinfra/sdk, expected github.com/khulnasoft/codeinfra/pkg",
		},
	}
