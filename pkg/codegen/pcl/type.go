...
var (
	// ArchiveType represents the set of Codeinfra Archive values.
	ArchiveType model.Type = model.NewOpaqueType("Archive")
	// AssetType represents the set of Codeinfra Asset values.
	...
	// AssetOrArchiveType represents the set of Codeinfra Archive values.
