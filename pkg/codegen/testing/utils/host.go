...
// enables running tests offline. If this host is used to load a plugin, that is, to run a Codeinfra
...
func NewHostWithProviders(schemaDirectoryPath string, providers ...SchemaProvider) plugin.Host {
	...
	// For the codeinfra/codeinfra repository, this must be kept in sync with the makefile and/or committed
