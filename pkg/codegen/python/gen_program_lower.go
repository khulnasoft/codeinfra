...
//
// Each of these patterns matches an apply that can be handled by `codeinfra.Output`'s `__getitem__` or `__getattr__`
...
//
// These forms will use `codeinfra.Output`'s `__getitem__` and `__getattr__` instead of calling `apply`.
