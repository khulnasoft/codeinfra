...
func (t primitiveType) String() string {
	...
	case stringType:
		return "string"
	case archiveType:
		return "codeinfra:codeinfra:Archive"
	case assetType:
		return "codeinfra:codeinfra:Asset"
	case jsonType:
		fallthrough
	case anyResourceType:
		fallthrough
	case anyType:
		return "codeinfra:codeinfra:Any"
	default:
...
var (
	...
	// AnyResourceType represents any Codeinfra resource - custom or component
...
type EnumType struct {
	...
	// Token is the type's Codeinfra type token.
	Token string
	...
	// package rather than using the core Codeinfra codegen libraries.
	IsOverlay bool
}
...
type DefaultValue struct {
	// Value specifies a static default value, if any. This value must be representable in the Codeinfra schema type
...
// Alias describes an alias for a Codeinfra resource.
type Alias struct {
...
// Resource describes a Codeinfra resource.
type Resource struct {
	// PackageReference is the PackageReference that defines the resource.
	PackageReference PackageReference
	// Token is the resource's Codeinfra type token.
	Token string
...
// Function describes a Codeinfra function.
type Function struct {
	// PackageReference is the PackageReference that defines the function.
	PackageReference PackageReference
	// Token is the function's Codeinfra type token.
	Token string
...
func (fun *Function) NeedsOutputVersion() bool {
	...
	// functions in `codeinfra-azure-native` or `codeinfra-aws` so we
	// omit to simplify.
...
// Package describes a Codeinfra package.
type Package struct {
	...
	// package in the Codeinfra registry. `category/<name>` and `kind/<type>` are the only
...
// PackageInfoSpec is the serializable description of a Codeinfra package's metadata.
...
// BaseProviderSpec is the serializable description of a Codeinfra base provider.
...
// PackageSpec is the serializable description of a Codeinfra package.
...
// PartialPackageSpec is a serializable description of a Codeinfra package that defers the deserialization of most package
