...
func TestArgumentTypeName(t *testing.T) {
	...
	assert.Equal(t, "codeinfra.Int", inputIntType)
	...
	assert.Equal(t, "codeinfra.String", inputStringType)
	...
	assert.Equal(t, "codeinfra.Bool", inputBoolType)
	...
	assert.Equal(t, "codeinfra.Float64", inputNumberType)
	...
	assert.Equal(t, "codeinfra.Any", inputDynamicType)
	...
	assert.Equal(t, "codeinfra.Map", inputObjectType)
	...
	assert.Equal(t, "codeinfra.IntMap", inputUniformObjectType)
	...
	assert.Equal(t, "codeinfra.StringMap", inputMapType)
	...
	assert.Equal(t, "codeinfra.IntArray", inputIntListType)
	...
	assert.Equal(t, "codeinfra.Array", inputDynamicListType)
...
func TestGeneratingGoOptionalFunctions(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			generated: "codeinfra.StringRef(foo)",
		},
		{
			expr: &model.FunctionCallExpression{
				Name: "goOptionalInt",
			...
			generated: "codeinfra.IntRef(foo)",
		},
		{
			expr: &model.FunctionCallExpression{
				Name: "goOptionalBool",
			...
			generated: "codeinfra.BoolRef(foo)",
		},
		{
			expr: &model.FunctionCallExpression{
			...
			generated: "codeinfra.Float64Ref(foo)",
		},
	}
