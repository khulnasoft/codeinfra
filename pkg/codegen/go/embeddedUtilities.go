...
func ParseEnvStringArray(v string) interface{} {
	var result codeinfra.StringArray
	for _, item := range strings.Split(v, ";") {
		result = append(result, codeinfra.String(item))
	}
	return result
}
...
func CallPlain(
	...
	tok string,
	args codeinfra.Input,
	output codeinfra.Output,
	self codeinfra.Resource,
	property string,
	resultPtr reflect.Value,
	errorPtr *error,
	opts ...codeinfra.InvokeOption,
) {
