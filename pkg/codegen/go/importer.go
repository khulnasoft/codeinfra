...
type GoPackageInfo struct {
	...
	//
	//    github.com/khulnasoft/codeinfra-kubernetes/sdk/go/kubernetes
	...
	//
	//    { "github.com/khulnasoft/codeinfra-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1": "flowcontrolv1alpha1" }
	//
	...
	// The version of the Codeinfra SDK used with this provider, e.g. 3.
	// Used to generate doc links for codeinfra builtin types. If omitted, the latest SDK version is used.
	CodeinfraSDKVersion int `json:"codeinfraSDKVersion,omitempty"`
	...
	// Feature flag to disable generating Codeinfra object default functions. This is a
	// space saving measure.
