...
func (d DocLanguageHelper) GetDocLinkForCodeinfraType(pkg *schema.Package, typeName string) string {
	...
	return "/docs/reference/pkg/nodejs/codeinfra/codeinfra/#" + typeName
}
...
func (d DocLanguageHelper) GetDocLinkForResourceType(pkg *schema.Package, modName, typeName string) string {
	...
	typeName = strings.ReplaceAll(typeName, "?", "")
	return fmt.Sprintf("/docs/reference/pkg/nodejs/codeinfra/%s/#%s", path, typeName)
}
...
func (d DocLanguageHelper) GetDocLinkForResourceInputOrOutputType(pkg *schema.Package, modName, typeName string, input bool) string {
	...
	if input {
		return fmt.Sprintf("/docs/reference/pkg/nodejs/codeinfra/%s/types/input/#%s", pkg.Name, typeName)
	}
	return fmt.Sprintf("/docs/reference/pkg/nodejs/codeinfra/%s/types/output/#%s", pkg.Name, typeName)
}
...
func (d DocLanguageHelper) GetModuleDocLink(pkg *schema.Package, modName string) (string, string) {
	...
	var link string
	if modName == "" {
		displayName = "@codeinfra/" + pkg.Name
	} else {
		displayName = fmt.Sprintf("@codeinfra/%s/%s", pkg.Name, strings.ToLower(modName))
	}
