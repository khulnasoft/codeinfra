...
var genPkgBatchSize = len(test.CodeinfraCodeinfraSDKTests) / 3

func TestGeneratePackageOne(t *testing.T) {
	t.Parallel()

	testGeneratePackageBatch(t, test.CodeinfraCodeinfraSDKTests[0:genPkgBatchSize])
}

func TestGeneratePackageTwo(t *testing.T) {
	t.Parallel()

	testGeneratePackageBatch(t, test.CodeinfraCodeinfraSDKTests[genPkgBatchSize:2*genPkgBatchSize])
}

func TestGeneratePackageThree(t *testing.T) {
	t.Parallel()

	testGeneratePackageBatch(t, test.CodeinfraCodeinfraSDKTests[2*genPkgBatchSize:])
}
