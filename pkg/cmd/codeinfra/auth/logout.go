...
func NewLogoutCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "logout <url>",
		Short: "Log out of the Codeinfra Cloud",
		Long: "Log out of the Codeinfra Cloud.\n" +
			"\n" +
		...
		Run: cmd.RunCmdFunc(func(cmd *cobra.Command, args []string) error {
			...
			if all {
				...
				if cloudURL == "" {
					...
					// Default to the default cloud URL. This means a `codeinfra logout` will delete the
					// credentials for codeinfra.com if there's no "current" user set in the credentials file.
