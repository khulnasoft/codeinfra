...
func NewDeploymentCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Hidden: true,
		Use:    "deployment",
		Short:  "Manage stack deployments on Codeinfra Cloud",
		Long: "Manage stack deployments on Codeinfra Cloud.\n" +
			"\n" +
	...
	cmd.PersistentFlags().StringVar(
		...
		"Override the file name where the deployment settings are specified. Default is Codeinfra.[stack].deploy.yaml")
