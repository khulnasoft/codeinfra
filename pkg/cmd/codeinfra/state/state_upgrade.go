...
// stateUpgradeCmd implements the 'codeinfra state upgrade' command.
...
func (cmd *stateUpgradeCmd) Run(ctx context.Context) error {
	...
	prompt := "This will upgrade the current backend to the latest supported version.\n" +
		"Older versions of Codeinfra will not be able to read the new format.\n" +
...
//
// It is used by the 'codeinfra state upgrade' command
