...
by its Codeinfra URN and the new name of the resource.

Make sure that URNs are single-quoted to avoid having characters unexpectedly interpreted by the shell.

To see the list of URNs in a stack, use ` + "`codeinfra stack --show-urns`" + `.
`,
		Example: "codeinfra state rename 'urn:codeinfra:stage::demo::eks:index:Cluster$codeinfra:providers:kubernetes::eks-provider' new-name-here",
