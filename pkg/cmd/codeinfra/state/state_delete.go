...
by its Codeinfra URN. If the URN is omitted, this command will prompt for it.
...
`,
		Example: "codeinfra state delete 'urn:codeinfra:stage::demo::eks:index:Cluster$codeinfra:providers:kubernetes::eks-provider'",
