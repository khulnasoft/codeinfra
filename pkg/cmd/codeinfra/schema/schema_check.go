...
func newSchemaCheckCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Check a Codeinfra package schema for errors",
		Long: "Check a Codeinfra package schema for errors.\n" +
			"\n" +
			"Ensure that a Codeinfra package schema meets the requirements imposed by the\n" +
