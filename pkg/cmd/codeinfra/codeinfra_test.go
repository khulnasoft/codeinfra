...
func TestCheckForUpdate(t *testing.T) {
	...
	// Cached version information is stored in CODEINFRA_HOME.
	codeinfraHome := t.TempDir()
	t.Setenv("CODEINFRA_HOME", codeinfraHome)
	...
	t.Cleanup(srv.Close)
	t.Setenv("CODEINFRA_API", srv.URL)
	...
	assert.Contains(t, msg.Message, "A new version of Codeinfra is available")
