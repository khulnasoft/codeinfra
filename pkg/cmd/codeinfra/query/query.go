...
func NewQueryCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: "[EXPERIMENTAL] Run query program against cloud resources.\n" +
			"\n" +
			"This command loads a Codeinfra query program and executes it. In \"query mode\", Codeinfra provides various\n" +
			"useful data sources for querying, such as the resource outputs for a stack. Query mode also disallows\n" +
			"all resource operations, so users cannot declare resource definitions as they would in normal Codeinfra\n" +
			"programs.\n" +
			"\n" +
...
issue at https://github.com/khulnasoft/codeinfra/issues/16964.
================================================================================`))
