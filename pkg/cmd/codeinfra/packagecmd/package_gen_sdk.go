...
If a folder either the plugin binary must match the folder name (e.g. 'aws' and 'codeinfra-resource-aws')` +
			` or it must have a CodeinfraPlugin.yaml file specifying the runtime to use.`,
