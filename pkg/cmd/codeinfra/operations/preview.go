...
import (
	...
	pkgPlan "github.com/khulnasoft/codeinfra/pkg/v3/cmd/codeinfra/plan"
...
func NewPreviewCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: "Show a preview of updates to a stack's resources.\n" +
			...
			"a Codeinfra program, and extracting all resource allocations from its resulting object graph.\n" +
			...
			default:
				if planFilePath != "" {
					...
					if !jsonDisplay {
						...
						ui.Fprintf(
							&buf,
							"\nRun `codeinfra up --plan='%s'` to constrain the update to the operations planned by this preview",
							planFilePath)
