...
func NewPluginCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: "Manage language and resource provider plugins.\n" +
			"\n" +
			"Codeinfra uses dynamically loaded plugins as an extensibility mechanism for\n" +
			...
			"\n" +
			"For a list of available resource plugins, please see https://www.codeinfra.com/registry/.",
		Args: cmdutil.NoArgs,
	}
