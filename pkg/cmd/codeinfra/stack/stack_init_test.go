...
// To keep the codebase DRY, we pass along team names as-is to the Codeinfra Cloud,
// with the exception of trimming whitespace, and allow the Codeinfra Cloud to
// validate them.
