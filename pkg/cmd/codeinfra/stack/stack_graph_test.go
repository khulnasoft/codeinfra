...
// Tests the output of 'codeinfra stack graph'
...
`, dotOutput)
	...
	t.Run("graph with parent and child", func(t *testing.T) {
		...
		child := resource.URN("urn:codeinfra:dev::pets::random:index/randomPet:RandomPet::child")
