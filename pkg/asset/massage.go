...
//
// TODO(https://github.com/khulnasoft/codeinfra/issues/592) this is baking in a lot of knowledge about
// codeinfra serialized functions.  We should try to move to an alternative mode that isn't so brittle.
// Options include:
