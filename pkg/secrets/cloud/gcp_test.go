...
func createGCPKey(ctx context.Context, t *testing.T) string {
	...
	parent := "projects/codeinfra-development/locations/global/keyRings/codeinfra-testing"
...
func TestGCPExistingKey(t *testing.T) {
	...
	url := "gcpkms://projects/codeinfra-development/locations/global/keyRings/codeinfra-testing/cryptoKeys/codeinfra-ci-test-key"
