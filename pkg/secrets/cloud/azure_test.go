...
func createAzureKey(ctx context.Context, t *testing.T, credentials *azidentity.DefaultAzureCredential) string {
	url := "codeinfra-testing.vault.azure.net"
...
// https://github.com/khulnasoft/codeinfra/issues/11982.  The issue only
...
func TestAzureKeyVaultExistingKey(t *testing.T) {
	ctx := context.Background()
	keyName := "codeinfra-testing.vault.azure.net/keys/test-key"
	url := "azurekeyvault://" + keyName
...
func TestAzureKeyVaultExistingState(t *testing.T) {
	...
	cloudState := `{
                    "url": "azurekeyvault://codeinfra-testing.vault.azure.net/keys/test-key",
...
// Regression test for https://github.com/khulnasoft/codeinfra/issues/15329
//
//nolint:paralleltest // mutates environment variables
...
// Test to auto-fix the regressions from https://github.com/khulnasoft/codeinfra/issues/15329
//
//nolint:paralleltest // mutates environment variables
func TestAzureKeyVaultAutoFix15329(t *testing.T) {
	ctx := context.Background()
	// https://github.com/khulnasoft/codeinfra/issues/15329 result in keys like the following being written to state. We can auto-detect these because they aren't valid base64.
	//nolint:lll // this includes a base64 encoded key
