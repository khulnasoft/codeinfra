...
// Package service implements support for the Codeinfra Service secret manager.
package service
...
// serviceCrypter is an encrypter/decrypter that uses the Codeinfra servce to encrypt/decrypt a stack's secrets.
...
// NewServiceSecretsManagerFromState returns a Codeinfra service-based secrets manager based on the
// existing state.
