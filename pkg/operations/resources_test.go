...
func getCodeinfraResources(t *testing.T, path string) *Resource {
...
func TestTodo(t *testing.T) {
	...
	components := getCodeinfraResources(t, "testdata/todo.json")
...
func TestCrawler(t *testing.T) {
	...
	components := getCodeinfraResources(t, "testdata/crawler.json")
